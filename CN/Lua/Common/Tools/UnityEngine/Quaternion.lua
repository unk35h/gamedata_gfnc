...
Quaternion._commonTemp = (Quaternion.New)()
Quaternion.TempEuler = function(x, y, z)
  -- function num : 0_37 , upvalues : Quaternion
  return (Quaternion._commonTemp):SetEuler(x, y, z)
end

Quaternion.unity_quaternion = (CS.UnityEngine).Quaternion
-- DECOMPILER ERROR at PC125: Confused about usage of register: R35 in 'UnsetPending'
