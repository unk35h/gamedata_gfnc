...
local walksort = function(tb, sort_func, walk_func)
  ...
  (table.sort)(keys, function(lkey, rkey)
    -- function num : 0_14_0 , upvalues : sort_func
...
local circulator = function(array)
  ...
  local i = 1
  local iter = function()
    -- function num : 0_17_0 , upvalues : i, array
...
local dump = function(tb, dump_metatable, max_level)
  ...
  local _dump = function(tb, level)
    -- function num : 0_18_0 , upvalues : rep, _ENV, lookup_table, max_level, _dump, dump_metatable
    local str = "\n" .. rep("\t", level) .. "{\n"
    for k,v in pairs(tb) do
...
local deepCopy = function(object)
  ...
  local _copy = function(object)
    -- function num : 0_20_0 , upvalues : _ENV, lookup_table, _copy
...
local GetDefaulValueTable = function(defaultValue)
  ...
  return setmetatable({}, {__index = function(tab, key)
    -- function num : 0_22_0 , upvalues : defaultValue
    return defaultValue
  end
})
end

local IsDicValueSame = function(tabA, tabB)
...
local IsEmptyTable = function(table)
...
local Table2String = function(obj)
  -- function num : 0_25 , upvalues : _ENV, Table2String
  local lua = ""
  local t = type(obj)
  if t == "number" then
    lua = lua .. obj
...
-- DECOMPILER ERROR at PC29: Confused about usage of register: R26 in 'UnsetPending'

table.count = count
-- DECOMPILER ERROR at PC31: Confused about usage of register: R26 in 'UnsetPending'

table.length = length
-- DECOMPILER ERROR at PC33: Confused about usage of register: R26 in 'UnsetPending'

table.setlen = setlen
-- DECOMPILER ERROR at PC35: Confused about usage of register: R26 in 'UnsetPending'

table.keys = keys
-- DECOMPILER ERROR at PC37: Confused about usage of register: R26 in 'UnsetPending'

table.values = values
-- DECOMPILER ERROR at PC39: Confused about usage of register: R26 in 'UnsetPending'

table.merge = merge
-- DECOMPILER ERROR at PC41: Confused about usage of register: R26 in 'UnsetPending'

table.insertto = insertto
-- DECOMPILER ERROR at PC43: Confused about usage of register: R26 in 'UnsetPending'

table.indexof = indexof
-- DECOMPILER ERROR at PC45: Confused about usage of register: R26 in 'UnsetPending'

table.keyof = keyof
-- DECOMPILER ERROR at PC47: Confused about usage of register: R26 in 'UnsetPending'

table.map = map
-- DECOMPILER ERROR at PC49: Confused about usage of register: R26 in 'UnsetPending'

table.walk = walk
-- DECOMPILER ERROR at PC51: Confused about usage of register: R26 in 'UnsetPending'

table.walksort = walksort
-- DECOMPILER ERROR at PC53: Confused about usage of register: R26 in 'UnsetPending'

table.filter = filter
-- DECOMPILER ERROR at PC55: Confused about usage of register: R26 in 'UnsetPending'

table.choose = choose
-- DECOMPILER ERROR at PC57: Confused about usage of register: R26 in 'UnsetPending'

table.circulator = circulator
-- DECOMPILER ERROR at PC59: Confused about usage of register: R26 in 'UnsetPending'

table.dump = dump
-- DECOMPILER ERROR at PC61: Confused about usage of register: R26 in 'UnsetPending'

table.contain = contain
-- DECOMPILER ERROR at PC64: Confused about usage of register: R26 in 'UnsetPending'

table.removebyvalue = removebyvalue
-- DECOMPILER ERROR at PC66: Confused about usage of register: R26 in 'UnsetPending'

table.removeall = removeall
-- DECOMPILER ERROR at PC68: Confused about usage of register: R26 in 'UnsetPending'

table.clearmap = clearmap
-- DECOMPILER ERROR at PC76: Confused about usage of register: R26 in 'UnsetPending'
...
-- DECOMPILER ERROR at PC78: Confused about usage of register: R26 in 'UnsetPending'

table.deepCopy = deepCopy
-- DECOMPILER ERROR at PC80: Confused about usage of register: R26 in 'UnsetPending'
...
-- DECOMPILER ERROR at PC84: Confused about usage of register: R26 in 'UnsetPending'

table.IsDicValueSame = IsDicValueSame
-- DECOMPILER ERROR at PC86: Confused about usage of register: R26 in 'UnsetPending'

table.IsEmptyTable = IsEmptyTable
-- DECOMPILER ERROR at PC88: Confused about usage of register: R26 in 'UnsetPending'
