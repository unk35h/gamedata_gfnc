...
local __rt_1 = {1, 20, -1}
local __rt_2 = {1, 2, 3, -1}
local __rt_3 = {50, 200, 200}
...
local __default_values = {discard_level = __rt_2, discard_scaleId = 1, 
discard_scaleValues = {1000, 1000, 1000, 1000}
, id = 1, upgrade_level = __rt_1, upgrade_scaleId = 1, upgrade_scaleValues = __rt_3}
