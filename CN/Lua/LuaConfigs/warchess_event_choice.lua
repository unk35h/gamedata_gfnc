...
local __rt_13 = {cat = 16, 
pms = {1, 1208, 1}
}
local __rt_14 = {cat = 13, 
pms = {2, 1000}
}
local __rt_15 = {cat = 35, 
pms = {2, 3000}
}
local __rt_16 = {cat = 36, 
pms = {3000}
}
local __rt_17 = {cat = 10, 
pms = {22}
}
local __rt_18 = {cat = 10, 
pms = {25}
}
local __rt_19 = {cat = 16, 
pms = {1, 1215, 1}
}
...
, 
{choice_color = 2, choice_describe_txt = 261096, icon = "event_icon_func", id = 2, 
triggerActions = {
{cat = 12, 
pms = {1, 20}
}
...
, 
{choice_color = 1, choice_describe_txt = 78086, icon = "event_icon_func", id = 3}
, 
{choice_color = 2, icon = "event_icon_func", id = 4}
; 
[9] = {choice_condition = 1, choice_describe_txt = 309334, icon = "event_icon_func", id = 9, 
triggerActions = {__rt_1, __rt_4}
}
, 
[10] = {choice_condition = 1, choice_describe_txt = 218078, icon = "event_icon_func", id = 10, 
triggerActions = {
{cat = 16, 
pms = {1, 13, 60}
}
...
, 
[101] = {choice_condition = 1, choice_describe_txt = 290259, icon = "event_icon_func", id = 101, 
triggerActions = {
{cat = 3, 
pms = {8, 0, 3, 3}
}
...
, 
[102] = {choice_describe_txt = 402737, icon = "event_icon_func", id = 102, triggerActions = __rt_6}
, 
[103] = {choice_condition = 1, choice_describe_txt = 366664, icon = "event_icon_func", id = 103, 
triggerActions = {__rt_7}
}
, 
[104] = {choice_describe_txt = 304789, icon = "event_icon_func", id = 104, 
triggerActions = {
{cat = 16, 
pms = {2, 13, 40}
}
...
, 
[105] = {choice_condition = 1, choice_describe_txt = 368788, icon = "event_icon_func", id = 105, 
triggerActions = {
{cat = 16, 
pms = {1, 13, 40}
}
...
, 
[106] = {choice_describe_txt = 123132, icon = "event_icon_func", id = 106, 
triggerActions = {
{cat = 13, 
pms = {1, 6000}
}
...
, 
[107] = {choice_describe_txt = 69543, icon = "event_icon_func", id = 107, 
triggerActions = {
{cat = 16, 
pms = {2, 12, 1}
}
...
, 
[108] = {choice_describe_txt = 291107, icon = "event_icon_func", id = 108, triggerActions = __rt_8}
, 
[109] = {choice_condition = 1, choice_describe_txt = 342629, icon = "event_icon_func", id = 109, 
triggerActions = {
{cat = 16, 
pms = {1, 12, 3}
}
...
, 
[110] = {choice_condition = 1, choice_describe_txt = 164143, icon = "event_icon_func", id = 110, 
triggerActions = {
{cat = 16, 
pms = {1, 12, 2}
}
...
, 
[111] = {choice_describe_txt = 400789, icon = "event_icon_func", id = 111, 
triggerActions = {
{cat = 5, 
pms = {1, 2, 3}
}
...
, 
[112] = {choice_describe_txt = 73981, icon = "event_icon_func", id = 112, 
triggerActions = {
{cat = 5, 
pms = {1, 2, 2}
}
...
, 
[113] = {choice_condition = 1, choice_describe_txt = 312664, icon = "event_icon_func", id = 113, 
triggerActions = {
{cat = 14, pms = __rt_3}
}
}
, 
[114] = {choice_describe_txt = 359369, icon = "event_icon_func", id = 114, 
triggerActions = {
{cat = 13, 
pms = {2, 5000}
}
...
, 
[115] = {choice_condition = 1, choice_describe_txt = 21730, icon = "event_icon_func", id = 115, triggerActions = __rt_12}
, 
[116] = {choice_describe_txt = 483874, icon = "event_icon_func", id = 116, triggerActions = __rt_8}
, 
[117] = {choice_describe_txt = 197021, icon = "event_icon_func", id = 117, triggerActions = __rt_6}
, 
[118] = {choice_condition = 1, choice_describe_txt = 236163, icon = "event_icon_func", id = 118, triggerActions = __rt_12}
, 
[119] = {choice_condition = 1, choice_describe_txt = 479942, icon = "event_icon_func", id = 119, 
triggerActions = {__rt_13, __rt_14}
}
, 
[120] = {choice_condition = 1, choice_describe_txt = 172627, icon = "event_icon_func", id = 120, 
triggerActions = {__rt_13, __rt_15}
}
, 
[121] = {choice_condition = 1, choice_describe_txt = 432821, icon = "event_icon_func", id = 121, 
triggerActions = {
{cat = 16, 
pms = {1, 1208, 5}
}
...
, 
[122] = {choice_color = 2, icon = "event_icon_func", id = 122}
, 
[123] = {choice_describe_txt = 429373, icon = "event_icon_func", id = 123, 
triggerActions = {__rt_17}
}
, 
[124] = {choice_color = 2, icon = "event_icon_func", id = 124, 
triggerActions = {__rt_18}
}
, 
[125] = {choice_condition = 1, choice_describe_txt = 257169, icon = "event_icon_func", id = 125, 
triggerActions = {__rt_19, __rt_14}
}
, 
[126] = {choice_condition = 1, choice_describe_txt = 498708, icon = "event_icon_func", id = 126, 
triggerActions = {__rt_19, __rt_15}
}
, 
[127] = {choice_condition = 1, choice_describe_txt = 384638, icon = "event_icon_func", id = 127, 
triggerActions = {
{cat = 16, 
pms = {1, 1215, 5}
}
...
, 
[128] = {choice_color = 2, icon = "event_icon_func", id = 128}
, 
[129] = {choice_condition = 1, choice_describe_txt = 304761, icon = "event_icon_func", id = 129, 
triggerActions = {__rt_20, __rt_14}
}
, 
[130] = {choice_condition = 1, choice_describe_txt = 503500, icon = "event_icon_func", id = 130, 
...
, 
[207] = {choice_describe_txt = 14037, icon = "event_icon_func", id = 207}
, 
[208] = {choice_describe_txt = 14609, icon = "event_icon_func", id = 208}
, 
[209] = {choice_describe_txt = 267220, icon = "event_icon_func", id = 209}
, 
[210] = {choice_describe_txt = 45989, icon = "event_icon_func", id = 210}
, 
[211] = {choice_describe_txt = 453828, icon = "event_icon_func", id = 211}
, 
[212] = {choice_describe_txt = 273619, icon = "event_icon_func", id = 212}
, 
[213] = {choice_describe_txt = 308222, icon = "event_icon_func", id = 213}
, 
[214] = {choice_describe_txt = 32137, icon = "event_icon_func", id = 214}
, 
...
, 
[329] = {choice_describe_txt = 478510, icon = "event_icon_limit", id = 329, 
triggerActions = {__rt_18, 
{cat = 10, 
pms = {30}
}
...
, 
[340] = {choice_describe_txt = 394952, id = 340, 
triggerActions = {
{cat = 10, 
pms = {29}
}
...
, 
[372] = {choice_describe_txt = 234063, id = 372, 
triggerActions = {
{cat = 3, 
pms = {11, 2}
}
...
, 
[373] = {choice_describe_txt = 441691, id = 373, 
triggerActions = {
{cat = 3, 
pms = {11, 3}
}
...
, 
[374] = {choice_describe_txt = 17230, id = 374, 
triggerActions = {
{cat = 3, 
pms = {11, 4}
}
...
, 
[375] = {choice_describe_txt = 15825, id = 375, 
triggerActions = {
{cat = 3, 
pms = {11, 5}
}
...
, 
[376] = {choice_color = 2, choice_describe_txt = 91076, icon = "event_icon_func", id = 376}
, 
[390] = {choice_describe_txt = 395818, id = 390, 
triggerActions = {
{cat = 22, 
pms = {5000000}
}
...
, 
[391] = {choice_describe_txt = "personal~", id = 391, 
triggerActions = {
{cat = 22, 
pms = {5000001}
}
...
for k,v in (_ENV.pairs)(warchess_event_choice) do
  (_ENV.setmetatable)(v, base)
end
local __rawdata = {__basemetatable = base}
;
(_ENV.setmetatable)(warchess_event_choice, {__index = __rawdata})
