...
, 
{id = 12, name = "open_little_man"}
, 
{id = 13, name = "open_weather"}
}
...
name_index = {anti_aliasing = 5, dyn_shadow = 4, effect_quality = 6, frame_rate = 3, mode = 10, model_quality = 7, mumu_frame_rate = 11, open_little_man = 12, open_weather = 13, outline = 8, post_effect = 9, resolution = 1, texture_limit = 2}
}
