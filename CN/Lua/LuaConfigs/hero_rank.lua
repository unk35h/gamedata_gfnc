...
local __rt_4 = {300}
local hero_rank = {
{rare = 1, repeat_extra_trans_num = __rt_2, repeat_frag_trans = 1}
, 
{rank = 2, rare = 1, repeat_extra_trans_num = __rt_2, repeat_frag_trans = 1, star = 2, 
upgrade_star_extra_cost = {
{itemId = 1003, num = 1000}
}
, upgrade_star_frag_cost = 5}
, 
{rank = 3, rare = 1, repeat_extra_trans_num = __rt_3, repeat_frag_trans = 5, star = 3, 
upgrade_star_extra_cost = {
{itemId = 1003, num = 2000}
}
, upgrade_star_frag_cost = 10}
, 
{rank = 4, rare = 2, repeat_extra_trans_num = __rt_3, repeat_frag_trans = 5, star = 4, 
upgrade_star_extra_cost = {
...
local __default_values = {rank = 1, rare = 3, repeat_extra_trans_id = __rt_1, repeat_extra_trans_num = __rt_4, repeat_frag_trans = 50, skill_level_max = 10, star = 1, ultimateskill_level = 1, 
upgrade_star_extra_cost = {
{itemId = 1003, num = 0}
}
