...
, 
{icon = "warehouse_page_7", id = 7, name = 159487}
; 
[99] = {icon = "warehouse_page_99", id = 99, name = 141609, order_id = 1}
}
local __default_values = {icon = "warehouse_page_1", id = 1, name = 117342, order_id = 2}
