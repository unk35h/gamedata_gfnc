...
, 
{describe = 431188, icon = "notice_ResDungeonRefresh", id = 26, is_reddot = true, put_in_homeside = true, switch_name = 453937, switch_type = 6, title = 504645}
, 
{describe = 37427, icon = "notice_Unlock", id = 27, title = 268004, type = 2}
, 
{describe = 67240, icon = "notice_Unlock", id = 28, is_reddot = true, put_in_homeside = true, title = 143955, type = 3}
; 
[100] = {describe = 192918, icon = "", id = 100, switch_name = 116633, switch_type = 100, title = 192918, unlock_for_setting = 2803}
}
local __default_values = {describe = 321024, icon = "notice_Factory", id = 1, info_type = 1, is_merge = false, is_reddot = false, put_in_homeside = false, switch_name = "", switch_type = 0, title = 512101, type = 0, unlock_for_setting = 0}
