...
{}
, 
{bird_id = 2, firstAwards = __rt_5, join_rewards = "", join_rewards_score = 0, progress_award_data = __rt_5, progress_precent = __rt_5, progress_precent_review = ""}
, 
{bird_id = 3}
, 
{bird_id = 4, 
firstAwards = {__rt_6, __rt_7, 
...
local __default_values = {bird_id = 1, firstAwards = __rt_2, join_rewards_score = 10, progress_award_data = __rt_3, progress_precent = __rt_4}
