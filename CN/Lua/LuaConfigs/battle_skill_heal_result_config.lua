...
local __default_values = {baseheal_formula = 3021, correct_formula = 9990, crit_formula = 0, crithur_ratio = 0, heal_number = 0, id = 1}
...
formulaTypes = {"baseheal_formula", "correct_formula", "crit_formula", "crithur_ratio", "heal_number"}
}
