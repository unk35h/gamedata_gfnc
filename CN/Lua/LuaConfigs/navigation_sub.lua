...
pre_para1 = {801}
, red_dot_path = "Main.Warehouse", red_dot_show = 1}
}
local __default_values = {force_lock = false, id = 1, img = "ICON_activity", jump_arg = __rt_1, jump_is_cover = false, jump_target = 0, marker = 0, name = 104709, pre_condition = __rt_2, pre_para1 = __rt_1, pre_para2 = __rt_1, red_dot_path = "Main.ActivityInHome", red_dot_show = 0, special = __rt_1}
