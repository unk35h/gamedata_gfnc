...
local __rt_4 = {0.902, 0.4824, 0.3059}
local __rt_5 = {0.7922, 0.902, 0.3059}
local exploration_roomtype = {
{
color = {0.9137, 0.5569, 0.0431}
, icon = "ICON_Room_boss", id = 1, priority = 2, progress_show_Icon = true, real_logic = 1, title = 399082}
, 
...
, icon = "ICON_Room_elite", id = 6, priority = 6, progress_show_Icon = true, real_logic = 1, title = 155560}
, 
{
color = {0.6078, 0.2196, 0.8902}
, icon = "ICON_Room_challenge", id = 7, priority = 7, real_logic = 1, title = 4301}
, 
{color = __rt_4, icon = "ICON_Room_event", id = 8, title = 276001}
, 
{color = __rt_5, icon = "ICON_Room_recoveIry", id = 9, priority = 3, progress_show_Icon = true}
, 
{
...
, 
{color = __rt_5, icon = "ICON_Room_recoveIry", id = 13, priority = 3, progress_show_Icon = true}
, 
{color = __rt_4, icon = "ICON_Room_story", id = 14, priority = 10, real_logic = 6, title = 236566}
, 
{
color = {0.502, 0.2314, 0.6902}
, icon = "ICON_Room_construction", id = 15, title = 781}
, 
{
color = {0.2353, 0.6314, 1}
, icon = "ICON_Room_GreenAssist", id = 16, title = 144797}
; 
...
local __default_values = {color = __rt_2, icon = "ICON_Room_empty", id = 0, priority = 5, progress_show_Icon = false, real_logic = 5, title = 482816}
