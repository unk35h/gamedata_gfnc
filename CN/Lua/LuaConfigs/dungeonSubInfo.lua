...
, 
{icon = "matDg_ath", stage_type = 7, text = 413024}
, 
{icon = "matDg_ath", img_bottom_idx = 1, stage_type = 8, text = 292691}
, 
{stage_type = 9}
, 
{icon = "matDg_ath", img_bottom_idx = 2, stage_type = 10, text = 373722}
, 
{icon = "matDg_ath", img_bottom_idx = 3, stage_type = 11, text = 290389}
}
local __default_values = {icon = "", img_bottom_idx = 0, name_en = "TEST", stage_type = 1, text = 147141}
