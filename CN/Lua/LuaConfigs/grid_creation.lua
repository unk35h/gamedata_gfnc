...
, 
{id = 24, src_name = "FX/TD/TD_WaterGround/FXP_TD_WaterGround"}
, 
{id = 25, src_name = "FX/Obstacle/Fence_obstacles/fence_obstacles"}
, 
{id = 26, src_name = "FX/TD/TD_NotPut/FXP_TD_NotPut"}
, 
{id = 27}
, 
{id = 28, src_name = "FX/Common/FX_Common_Xiajihuodong/FXP_xjhd_chushi"}
, 
{id = 29, src_name = "FX/Common/FX_Common_Xiajihuodong/FXP_xjhd_baozha"}
, 
{id = 30, src_name = "FX/Common/FX_Common_Xiajihuodong/FXP_xjhd_boss"}
, 
{id = 31, src_name = "FX/TD/TD_WaterGround/FXP_TD_WaterGround"}
, 
{id = 32, src_name = "FX/LatticeEffect/Jilewutai/FXP_Jilewutai_caise"}
; 
...
, 
[1100] = {id = 1100, src_name = "FX/LatticeEffect/xiajihuodongGrid/FXP_TD_jianqian"}
, 
[1101] = {id = 1101, src_name = "FX/LatticeEffect/xiajihuodongGrid/FXP_TD_jianxue"}
, 
[1102] = {id = 1102, src_name = "FX/LatticeEffect/xiajihuodongGrid/FXP_TD_jiaxue"}
, 
[1103] = {id = 1103, src_name = "FX/LatticeEffect/xiajihuodongGrid/FXP_TD_jiansu"}
, 
[1108] = {id = 1108, src_name = "FX/LatticeEffect/wangyouGrid/FXP_fence_wangyoucao"}
, 
[1109] = {id = 1109, src_name = "FX/LatticeEffect/xiajihuodongGrid/FXP_fence_jianqian"}
, 
[1110] = {id = 1110, src_name = "FX/LatticeEffect/xiajihuodongGrid/FXP_fence_jianxue"}
, 
[1111] = {id = 1111, src_name = "FX/LatticeEffect/xiajihuodongGrid/FXP_fence_jiaxue"}
, 
[1112] = {id = 1112, src_name = "FX/LatticeEffect/xiajihuodongGrid/FXP_fence_jiansu"}
, 
[1113] = {id = 1113, src_name = "Res/Character/demiurge_a/Skill/FXP_TD_WaterGround-demiurge"}
, 
[1114] = {id = 1114, src_name = "Res/Character/weapon4_coregreen/model_weapon4_coregreen"}
, 
[1115] = {id = 1115, src_name = "Res/Character/weapon4_corered/model_weapon4_corered"}
, 
[1116] = {id = 1116, src_name = "Res/Character/weapon1/model_weapon1"}
, 
[1117] = {id = 1117, src_name = "Res/Character/weapon2/model_weapon2"}
, 
[1118] = {id = 1118, src_name = "Res/Character/weapon3/model_weapon3"}
, 
[1119] = {id = 1119, src_name = "FX/LatticeEffect/ChocoGrid/FXP_ChocoGrid_white"}
, 
[1120] = {id = 1120, src_name = "FX/LatticeEffect/ChocoGrid/FXP_ChocoGrid_black"}
, 
[1121] = {id = 1121, src_name = "FX/LatticeEffect/YurenjieGrid/FXP_yurenjieGrid"}
, 
[1122] = {id = 1122, src_name = "FX/LatticeEffect/Moxiangjiguan/FXP_Moxiangjiguan_caise"}
, 
[1123] = {id = 1123, src_name = "FX/Monster/BigBoss_odette_N/FXP_BigBoss_odette_skill2_loop_dm"}
, 
[1124] = {id = 1124, src_name = "FX/Monster/BigBoss_ptolomaea/FXP_ptolomaea_skill02_dg"}
}
local __default_values = {id = 1, src_name = "FX/Common/FX_UI/FXP_LatticeEffect/FXP_Suichuan"}
