...
UINHomeBannerLoopList.__OnPointerEnter = function(self)
  -- function num : 0_5
  self.__onPointerStaty = true
  self.__isAutoPlay = false
end

UINHomeBannerLoopList.__OnPointerExit = function(self)
...
UINHomeBannerLoopList.SetPointerExitSucChecker = function(self, condiotnCall)
  -- function num : 0_7
...
UINHomeBannerLoopList.__OnAdvItemClick = function(self)
  -- function num : 0_15
...
UINHomeBannerLoopList.OnHide = function(self)
  -- function num : 0_18 , upvalues : CS_EventTriggerListener, _ENV
  local eventTrigger = (CS_EventTriggerListener.Get)(self.gameObject)
  eventTrigger:onBeginDrag("-", BindCallback(self, self.__OnBeginDrag))
  eventTrigger:onEndDrag("-", BindCallback(self, self.__OnEndDrag))
...
UINHomeBannerLoopList.OnDelete = function(self)
  -- function num : 0_19 , upvalues : _ENV, HomeBannerManager, base
  TimerManager:StopTimer(self.__pointerExitDelayCheckTimerId)
