...
DormCharacterAI.__StartFntInterPoint = function(self, actions, interPoint, setPos, normal)
  -- function num : 0_12 , upvalues : _ENV, DormAIStateConfig
...
DormCharacterAI.RandToRoomOnePoint = function(self)
  -- function num : 0_15 , upvalues : DormAIStateConfig
