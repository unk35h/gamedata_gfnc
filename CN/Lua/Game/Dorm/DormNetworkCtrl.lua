...
DormNetworkCtrl.CS_DORM_DormPurchase = function(self, houseId, callBack)
...
DormNetworkCtrl.SC_DORM_DormPurchase = function(self, msg)
  ...
  do
    ...
    if houseCfg then
      NoticeManager:AddNotice((NoticeData.CreateNoticeData)(PlayerDataCenter.timestamp, (NoticeManager.eNoticeType).DormHouseUnlock, nil, {(LanguageUtil.GetLocaleText)(houseCfg.name)}, nil))
