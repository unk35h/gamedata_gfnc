...
DormEditRoomData.ResetStorateFntData = function(self, isInit)
...
DormEditRoomData._AddStorageFnt = function(self, storageFnt)
  -- function num : 0_1
...
DormEditRoomData.IsHasAnyDmtThemeFnt = function(self)
  -- function num : 0_2 , upvalues : _ENV
  if not self._hasThemeFntInstallable then
    return (PlayerDataCenter.dormBriefData):IsHasAnyDmtThemeFntInstalled()
  end
end

DormEditRoomData.GetDmStorageFntData = function(self, id)
  -- function num : 0_3
...
DormEditRoomData.NewDmStorateFnt = function(self, id, count)
  -- function num : 0_10
...
DormEditRoomData.GetFntWarehouseCatgList = function(self)
  -- function num : 0_13 , upvalues : DormEnum, _ENV, DefaultWallData, DefaultFloorData
  local fntCatgList = {}
  local fntList = {}
