...
DormHouseCtrl.EnterDormHouse = function(self, id, showUnlockFx)
...
DormHouseCtrl.__InitHouseEntity = function(self, houseHexRange, showUnlockFx)
...
DormHouseCtrl.TryPlayDmAllRoomUnlockFx = function(self)
...
DormHouseCtrl.AddNewRoom = function(self, x, y, spos, roomData, showUnlockFx)
  -- function num : 0_6 , upvalues : DormRoomEntity, CS_DormCameraCtrl
...
DormHouseCtrl.UnlockDmRoom = function(self, newUnlockDic)
...
DormHouseCtrl._UnlockRoom = function(self, dormRoomMsg, spos, houseId)
  -- function num : 0_8 , upvalues : _ENV, DormRoomData, CS_DormCameraCtrl
...
DormHouseCtrl._SetRoomCamRotaton2DoorWall = function(self, roomEntity)
  -- function num : 0_9 , upvalues : CS_DormCameraCtrl
...
DormHouseCtrl.OnHouseClicked = function(self, roomEntity, auto2Edit)
  -- function num : 0_10 , upvalues : _ENV, cs_MessageCommon, DormEnum, CS_DormCameraCtrl
  ...
  do
    ...
    -- function num : 0_10_1 , upvalues : self, roomEntity
    if win == nil then
      return 
    end
    win:InitSceneChangesMask(function()
      -- function num : 0_10_1_0 , upvalues : self, roomEntity
...
, function()
      -- function num : 0_10_1_1 , upvalues : self
...
DormHouseCtrl.CancelHouseEdit = function(self)
  -- function num : 0_25 , upvalues : _ENV, CS_DormCameraCtrl
  self.editHouseData = nil
  self.curEditSelectRoom = nil
...
DormHouseCtrl.OnD2HTimelineComplete = function(self, pd)
  -- function num : 0_28 , upvalues : _ENV, DormEnum
...
DormHouseCtrl.OnH2DTimelineComplete = function(self, pd)
  -- function num : 0_30 , upvalues : _ENV, CS_DormCameraCtrl
  self._houseRoomCo = nil
  ;
  ((self.dormCtrl).dormWindow):ShowDmStateNode(true)
  UIManager:HideWindow(UIWindowTypeID.ClickContinue)
...
DormHouseCtrl.RandEnterNextDormRoom = function(self)
  -- function num : 0_31 , upvalues : _ENV, CS_DormCameraCtrl
...
DormHouseCtrl.__GetUnlockRoomData = function(self)
  -- function num : 0_33 , upvalues : _ENV, DormUtil
  self._lockRoomDic = {}
    ...
    for dy = (math.max)(-n, -dx - n), (math.min)(n, -dx + n) do
      ...
      if roomData == nil then
        ...
        if roomEntity ~= nil then
          ...
          local lockStr = (unlockCfg.unlock_logic > 0 and UnlockCenter:GetUnlockElemDes(unlockCfg.unlock_logic, unlockCfg.unlock_para1))
