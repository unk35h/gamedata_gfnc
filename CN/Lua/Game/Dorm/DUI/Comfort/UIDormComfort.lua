...
UIDormComfort.ReqComfortRewardPick = function(self, comfortLevelCfg, comfortItem)
  -- function num : 0_5 , upvalues : _ENV, CommonRewardData
  ...
  dormNetwork:CS_DORM_PickConfortRewards(comfortLevelCfg.level, function()
    -- function num : 0_5_0 , upvalues : comfortItem, _ENV, CommonRewardData, comfortLevelCfg
    comfortItem:RefreshDormComfortItem(PlayerDataCenter.dormBriefData)
    UIManager:ShowWindowAsync(UIWindowTypeID.CommonReward, function(window)
      -- function num : 0_5_0_0 , upvalues : CommonRewardData, comfortLevelCfg
      if window == nil then
        return 
      end
