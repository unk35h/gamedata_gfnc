...
DailyDungeonLevelCtrl.ReqEnterDailyDungeon = function(self, dailyDgDyncData)
  -- function num : 0_3 , upvalues : _ENV, DungeonInterfaceData
...
DailyDungeonLevelCtrl._ExitBattleFunc = function(self, isBatlleWin)
  -- function num : 0_4 , upvalues : _ENV, cs_MessageCommon, CS_GSceneManager_Ins
  ControllerManager:DeleteController(ControllerTypeId.Formation)
  local loadMatUIFunc = function()
    -- function num : 0_4_0 , upvalues : _ENV, cs_MessageCommon, isBatlleWin
    ...
    if battleDyncElem:IsDgDyncComplete() and not PlayerDataCenter:IsDungeonModuleOpenQuick(battleDyncElem.moduleId) then
      (NetworkManager:GetNetwork(NetworkTypeID.BattleDungeon)):CS_DUNGEON_STATIC_Detail(function()
      -- function num : 0_4_0_0 , upvalues : dailyDgCtrl, _ENV, cs_MessageCommon, isBatlleWin
      dailyDgCtrl:ShowDailyDungeonMain(function()
        -- function num : 0_4_0_0_0 , upvalues : _ENV, cs_MessageCommon
        local moudleId = ((PlayerDataCenter.dungeonDyncData):GetDailyDungeonDyncData()).moduleId
        if PlayerDataCenter:IsDungeonModuleOpenQuick(moudleId) then
          local cfg = (ConfigData.material_dungeon)[moudleId]
          ;
          (cs_MessageCommon.ShowMessageTips)(ConfigData:GetTipContent(9306, (LanguageUtil.GetLocaleText)(cfg.name)))
        end
      end
, function(tohome)
        -- function num : 0_4_0_0_1 , upvalues : _ENV
...
, true, isBatlleWin)
      ...
      -- function num : 0_4_0_1 , upvalues : _ENV
      local sectorCtrl = ControllerManager:GetController(ControllerTypeId.SectorController, true)
      sectorCtrl:ResetToNormalState(tohome)
    end
, true, isBatlleWin)
