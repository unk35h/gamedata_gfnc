...
UINSelectChipSuitList.SetLockedSuitDataList = function(self, lockedChipPoolList, lockedChipPoolUnlockInfoList)
  -- function num : 0_2
...
UINSelectChipSuitList.__OnNewItem = function(self, go)
  -- function num : 0_5 , upvalues : UINSelectChipSuitListItem
