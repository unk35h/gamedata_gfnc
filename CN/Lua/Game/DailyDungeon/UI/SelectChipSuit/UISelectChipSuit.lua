...
UISelectChipSuit.InitSelectChipSuit = function(self, dInterfaceData)
  -- function num : 0_1
...
UISelectChipSuit._InitData = function(self, dInterfaceData)
  ...
  if chipPool ~= nil then
    for k,chipTagId in ipairs(chipPool) do
      ...
      local seChipSuitData = {dynChipSuitData = dynChipSuitData, selectNumMax = dInterfaceData:GetChipSuitNumById(chipTagId), selectNumCur = dInterfaceData:GetChipSuitSelectedCount(chipTagId), chipQuality = dInterfaceData:GetChipSuitSelectQuality(chipTagId), notShowCouldUseTime = dInterfaceData:GetIsNotShowCouldUseTime()}
      ;
...
UISelectChipSuit.OnShow = function(self)
