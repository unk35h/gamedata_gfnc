...
AllBattlePassData.OnBattlePassEnd = function(self, id)
  -- function num : 0_5
...
AllBattlePassData.UpdatePlayerLevel = function(self, level)
  -- function num : 0_7 , upvalues : _ENV, BattlePassEnum, NoticeData
...
AllBattlePassData.GetBattlePass = function(self, id)
  -- function num : 0_8
