...
UIAVGSystem.TryAvgContinuePlay = function(self)
  -- function num : 0_10 , upvalues : eAvgContentType
...
UIAVGSystem.AvgShowTextSplitPause = function(self, pause)
  -- function num : 0_11
  self._inContentSplitPuase = pause
end

UIAVGSystem.SetCurActContentSplitIdx = function(self, idx)
  -- function num : 0_12
  self._curActContentSplitIdx = idx
end

UIAVGSystem.GetCurActContentSplitIdx = function(self, idx)
  -- function num : 0_13
...
UIAVGSystem.NewImgItem = function(self, imgCfg)
  -- function num : 0_25 , upvalues : eAvgImgType, UINAvgHeroPic, _ENV, imgMaxCount
...
UIAVGSystem.SortAvtImgItem = function(self)
  -- function num : 0_28 , upvalues : _ENV, eAvgImgType
...
UIAVGSystem.EndAllAvgTween = function(self)
  -- function num : 0_34 , upvalues : _ENV, eAvgContentType
  if self.hasPPVTween then
...
UIAVGSystem.RefreshAutoPlay = function(self, autoPlay, delayRatio)
  -- function num : 0_40 , upvalues : CS_DoTween
...
UIAVGSystem.OnClickSkip = function(self)
  ...
  if SkipTextId ~= nil then
    ...
    -- function num : 0_41_0 , upvalues : skipStr, storyAvgId
    if window == nil then
      return 
    end
    ...
    -- function num : 0_41_1 , upvalues : self
...
UIAVGSystem._OnClickBackground = function(self, withoutSound)
  -- function num : 0_42 , upvalues : _ENV, eAvgContentType
...
UIAVGSystem.OnFirstExcute = function(self)
  -- function num : 0_43 , upvalues : _ENV, LongPressSpeed
...
UIAVGSystem.GetChildIndex = function(self, TimeSpeed)
  -- function num : 0_49 , upvalues : LongPressSpeed, _ENV
...
UIAVGSystem.SetTImeScale = function(self)
  -- function num : 0_50 , upvalues : LongPressSpeed, _ENV
...
UIAVGSystem.GetHeroCommItem = function(self)
  -- function num : 0_51 , upvalues : _ENV, UINAvgHeroCommItem
...
UIAVGSystem.ReturnHeroCommItem = function(self, item, mat)
...
UIAVGSystem.GetAvgRippleMat = function(self)
  -- function num : 0_53 , upvalues : _ENV, CS_Material
...
UIAVGSystem.ReturnAvgRippleMat = function(self, mat)
...
UIAVGSystem.OnClickAvgTextLink = function(self, herfStr, linkStr)
  ...
  if arg[1] == "Des" then
    ...
    -- function num : 0_55_0 , upvalues : desId
...
UIAVGSystem.GetAvgHeroDissolveMat = function(self)
  -- function num : 0_57 , upvalues : _ENV, CS_Material
...
UIAVGSystem._HomeBackFromOtherCoverWin = function(self)
