...
UINAvgImgItem._GetImgPath = function(self)
  ...
  do
    ...
    do return imgPath end
    -- DECOMPILER ERROR: 3 unprocessed JMP targets
  end
end

UINAvgImgItem.LoadTexture = function(self)
  -- function num : 0_4 , upvalues : CS_ResLoader, _ENV, eAvgImgType, AvgImgTweenUntil
  ...
  (self.resloader):LoadABAssetAsync(path, function(texture)
    -- function num : 0_4_0 , upvalues : self, eAvgImgType, _ENV, AvgImgTweenUntil
...
UINAvgImgItem.LoadMovie = function(self)
  -- function num : 0_5 , upvalues : CS_MovieManager_ins, _ENV, AvgImgTweenUntil
...
UINAvgImgItem.AvgImgTweenDoEnd = function(self)
  -- function num : 0_15
  if self.sequence ~= nil and (self.sequence):IsPlaying() then
    (self.sequence):Kill()
  end
...
UINAvgImgItem.OnRecycleAvgImg = function(self)
  -- function num : 0_18 , upvalues : CS_MovieManager_ins
