...
AvgPlayController.IsAvgUnlockInfo = function(self, avgId)
...
AvgPlayController.GetPreUnlockSectorStage = function(self, avgId)
...
AvgPlayController.IsPlayedAllMainAvg = function(self, sectorId, difficulty, checkAvgId, isCheckPreSector, isNeedAvgUnlock)
  -- function num : 0_17 , upvalues : _ENV
  local SectorAvgCompleteCheckFunc = function(id, diff, checkId)
    -- function num : 0_17_0 , upvalues : _ENV, isNeedAvgUnlock, self
    ...
    for _,avgId in ipairs(avgList) do
      if (not isNeedAvgUnlock or self:IsAvgUnlock(avgId)) and avgId ~= checkId then
        do
