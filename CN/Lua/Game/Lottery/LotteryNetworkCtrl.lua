...
LotteryNetworkCtrl.CS_LOTTERY_CustomisedQtt = function(self, poolId, num, callBack)
...
LotteryNetworkCtrl.SC_LOTTERY_CustomisedQtt = function(self, msg)
...
LotteryNetworkCtrl.CS_LOTTERY_SelectPool = function(self, poolGroupId, poolId, callBack)
...
LotteryNetworkCtrl.SC_LOTTERY_SelectPool = function(self, msg)
