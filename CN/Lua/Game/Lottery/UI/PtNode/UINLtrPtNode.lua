...
UINLtrPtNode.OnInit = function(self)
  -- function num : 0_0 , upvalues : _ENV, UINLtrPtRrewardItem, UINHeroHeadItem, cs_ResLoader
...
UINLtrPtNode.InitLtrPtNode = function(self, ltrPoolData, ltrCtrl)
...
UINLtrPtNode.BackAction = function(self)
  -- function num : 0_8
  self:Hide()
...
UINLtrPtNode._InitSwithTween = function(self)
  -- function num : 0_10 , upvalues : cs_DoTween, cs_Ease
  self:_KillTween()
