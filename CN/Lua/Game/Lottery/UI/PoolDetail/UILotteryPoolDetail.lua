...
UILotteryPoolDetail.OnInit = function(self)
  -- function num : 0_0 , upvalues : UINLtrPoolBaseRule, UINLtrPoolDetailRate, UINLtrPoolUpRate, UINLtrPoolRecord, UINLtrPoolUpRule, _ENV, UINLtrPoolDetailTog, cs_ResLoader
...
UILotteryPoolDetail.InitLtrPoolDetail = function(self, ltrPoolData, poolGrouData, exitAction)
  ...
  do
    ...
    ;
    ((((self.ui).typeTogList)[5]).gameObject):SetActive(ltrPoolData:ShowLtrUpIntro())
...
UILotteryPoolDetail.ShowLtrDetailUpRule = function(self)
  -- function num : 0_6
