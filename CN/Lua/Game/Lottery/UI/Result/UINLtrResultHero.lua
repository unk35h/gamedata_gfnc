...
UINLtrResultHero.GetRepeatExtraFragList = function(self)
...
UINLtrResultHero.GetLtrResultHeroUIRoot = function(self)
  -- function num : 0_10
  return (self.ui).root
end

UINLtrResultHero.SetLtrRsultHeroQulityItemHolderParent = function(self, parentTransfrom)
  -- function num : 0_11
