...
UILogin.OnInit = function(self)
  ...
  if ((Consts.GameChannelType).IsPnSdk)() then
    local showCustomerService = not CS_ClientConsts.IsAudit
  end
  ;
...
UILogin._InitBg = function(self)
  -- function num : 0_1 , upvalues : CS_LanguageGlobal, _ENV
...
UILogin._OnClickCustomerService = function(self)
  -- function num : 0_4 , upvalues : CS_MicaSDKManager_Ins
  CS_MicaSDKManager_Ins:EnterCustomService()
end

UILogin.OnClickLogin = function(self)
  -- function num : 0_5 , upvalues : CS_PlayerPrefs, PlayerPrefsConsts, CS_PlayerPrefsExtension, isUseSDK, _ENV, CS_MicaSDKManager_Ins, CS_HotUpdateController
  ...
  if not isUseSDK then
    ...
    -- function num : 0_5_0 , upvalues : CS_HotUpdateController, self
    (CS_HotUpdateController.TryCheckNewResVersion)(function(hasNewVersion)
...
UILogin._TryCustomConnect = function(self)
  -- function num : 0_7 , upvalues : CS_ClientConsts, _ENV
...
UILogin.StartConnectFromSDK = function(self)
  -- function num : 0_8 , upvalues : _ENV, CS_MicaSDKManager_Ins, isUseSDK
  ...
  CS_MicaSDKManager_Ins:GetGateInfo(function(success)
    -- function num : 0_8_0 , upvalues : _ENV, self, CS_MicaSDKManager_Ins, isUseSDK
...
UILogin.OnConnectComplete = function(self)
  -- function num : 0_10 , upvalues : CS_ClientConsts, _ENV, isUseSDK, CS_MicaSDKManager_Ins
...
UILogin.GetGameResUrls = function(self)
  -- function num : 0_11 , upvalues : CS_MicaSDKManager_Ins, _ENV
...
UILogin._StartConectIpPort = function(self, ip, port)
...
UILogin.OnDelete = function(self)
  -- function num : 0_21 , upvalues : _ENV, CS_NetworkManager, CS_Resources, base
