...
UISkillInput.OnInit = function(self)
  ...
  self._MonStageShowStartFunc = function()
    -- function num : 0_0_2 , upvalues : self
    self:UpdateInputStateUI(true)
  end

  self._MonStageShowEndFunc = function()
...
UISkillInput.__ClearSkillInputCtrlData = function(self)
...
UISkillInput.UpdateInputStateUI = function(self, isInInput)
  ...
  local windowActiveCtrlAct = function(windowId)
    -- function num : 0_11_1 , upvalues : _ENV, isInInput
    local win = UIManager:GetWindow(windowId)
    if win == nil then
      return 
    end
