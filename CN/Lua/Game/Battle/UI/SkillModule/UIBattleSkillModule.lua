...
UIBattleSkillModule.ShowHeroReturnCD = function(self, heroId, returnCD)
  -- function num : 0_7
...
UIBattleSkillModule.AddHeroItemWithoutUltSkill = function(self, heroId, heroData)
  -- function num : 0_17
  (self.ultSkillNode):AddHeroItem(heroId, heroData)
end

UIBattleSkillModule.RemoveHeroItemWithoutUltSkill = function(self, heroId)
  -- function num : 0_18
  (self.ultSkillNode):RemoveHeroItem(heroId)
end

UIBattleSkillModule.IsHaveHeroHeadInUlt = function(self, heroId)
  -- function num : 0_19
...
UIBattleSkillModule.__JoinHideTween = function(self, sequence, uiLayer)
  -- function num : 0_27 , upvalues : _ENV, CS_CanvasGroup
...
UIBattleSkillModule.BattleHideAllUITween = function(self, hide)
  -- function num : 0_28 , upvalues : CS_DOTween, _ENV
  do
...
UIBattleSkillModule.Show = function(self, withTween)
  -- function num : 0_29 , upvalues : base, _ENV
  if self.active then
    return 
  end
  ;
...
UIBattleSkillModule.OnPlayHeroUltrSkillAction = function(self, caster)
  ...
  UIManager:ShowWindowAsync(UIWindowTypeID.UltimateSkillShow, function(win)
    -- function num : 0_34_0 , upvalues : caster
    if win == nil then
      return 
    end
...
UIBattleSkillModule.OnRefreshSideHeadHpUI = function(self, hero2hpDic)
  -- function num : 0_36 , upvalues : _ENV
  local table = Dictionary2Table(hero2hpDic)
  ;
  (self.ultSkillNode):ShowSideHeadHpBar(table)
end
