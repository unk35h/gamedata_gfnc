...
DynMonster.ctor = function(self, monsterData)
  ...
  if not (monsterData.stc).uid then
    ...
    self.modelSpecSign = (monsterData.dyc).model and (ResConsts.ModelSignType).GrayMode or 0
    ...
    self.breakId = (self.monsterCfg).break_id
    self.baseAttr = {}
    self.ratioAttr = {}
    self.extraAttr = {}
    self.originAttr = {}
...
DynMonster.SetDynMonTargetDeployPos = function(self, x, y)
  -- function num : 0_2
...
DynMonster.GetDynMonsterStageGroup = function(self)
  -- function num : 0_15
  return (self.monsterCfg).group
end

DynMonster.IsStageMonster = function(self)
  -- function num : 0_16
  do return self.stage > 0 end
  -- DECOMPILER ERROR: 1 unprocessed JMP targets
end

DynMonster.SetMonsterHasMoreStage = function(self, maxStage)
  -- function num : 0_17
  self._maxStage = maxStage
end

DynMonster.MonsterHasMoreStage = function(self)
  -- function num : 0_18
  do return self.parentUid > 0 end
  -- DECOMPILER ERROR: 1 unprocessed JMP targets
end

DynMonster.GetMonsterMaxStage = function(self)
  -- function num : 0_19
