...
ExplorationMapCtrl.OnBuffChange = function(self)
...
ExplorationMapCtrl.RefreshMapShowState = function(self, opDetail, curRoomData, withTween, tweenCallback)
  -- function num : 0_10 , upvalues : _ENV, ExplorationEnum, BossRoomScale
          ...
          if trackItem ~= nil then
            ...
            do
              ...
              do
                ...
                do
                  -- DECOMPILER ERROR at PC277: Confused about usage of register: R10 in 'UnsetPending'
...
ExplorationMapCtrl.__UpdateViewRangeLine = function(self, roomEntity)
  -- function num : 0_32 , upvalues : ExplorationEnum, _ENV
  if not self.hasViewRange then
    return 
  end
...
ExplorationMapCtrl.__InitExplorationCameraEffect = function(self)
  -- function num : 0_42 , upvalues : _ENV, CameraEffectUtil
...
ExplorationMapCtrl.OnAVGPlay = function(self)
  -- function num : 0_43 , upvalues : _ENV
  print("OnAVGPlay")
  self:__CloseExplorationCameraEffect()
end

ExplorationMapCtrl.OnAVGPlayend = function(self)
  -- function num : 0_44 , upvalues : _ENV
  print("OnAVGPlayend")
  self:__InitExplorationCameraEffect()
end

ExplorationMapCtrl.__CloseExplorationCameraEffect = function(self)
  -- function num : 0_45 , upvalues : CameraEffectUtil
