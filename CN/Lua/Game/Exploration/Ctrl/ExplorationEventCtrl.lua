...
ExplorationEventCtrl.OnEventRoomOpen = function(self, roomData, isFirstOpen)
  ...
  if #(self.eventData).assistHeroes > 0 then
    ...
    do
      if (self.eventData).astCareer ~= nil then
...
ExplorationEventCtrl.OnChoiceItemSelectSuccess = function(self, msg)
  -- function num : 0_9 , upvalues : _ENV, ExplorationEnum, DynBuff
  local completeFunc = function()
    -- function num : 0_9_0 , upvalues : msg, self, _ENV, ExplorationEnum, DynBuff
    do
      ...
      -- function num : 0_9_0_0 , upvalues : self, playerPowerAfter, needExit, _ENV, ExplorationEnum
      if win ~= nil then
        win:InitHeroPowerUpSuccess(self.__playerPowerBefore, playerPowerAfter)
        if needExit then
          win:SetBackClickAction(function()
        -- function num : 0_9_0_0_0 , upvalues : _ENV, ExplorationEnum
        MsgCenter:Broadcast(eMsgEventId.OnExitRoomComplete, (ExplorationEnum.eExitRoomCompleteType).EventRoom)
            ...
            if needExit then
              local broadcastCompleteFunc = function()
      -- function num : 0_9_0_1 , upvalues : _ENV, ExplorationEnum
      MsgCenter:Broadcast(eMsgEventId.OnExitRoomComplete, (ExplorationEnum.eExitRoomCompleteType).EventRoom)
    end
              ...
              if #buffIdList > 0 and not ((self.epCtrl).autoCtrl):IsAutoModeRunning() then
                local epBuffList = {}
      ...
      -- function num : 0_9_0_2 , upvalues : _ENV, epBuffList, broadcastCompleteFunc
      UIManager:ShowWindowAsync(UIWindowTypeID.EpBuffDesc, function(win)
        -- function num : 0_9_0_2_0 , upvalues : epBuffList, broadcastCompleteFunc
        if win == nil then
          return 
        end
        win:InitGetEpBuffShow(epBuffList, broadcastCompleteFunc)
                  ...
                  UIManager:ShowWindowAsync(UIWindowTypeID.EpBuffDesc, function(win)
      -- function num : 0_9_0_3 , upvalues : epBuffList, broadcastCompleteFunc
      if win == nil then
        return 
      end
      win:InitGetEpBuffShow(epBuffList, broadcastCompleteFunc)
