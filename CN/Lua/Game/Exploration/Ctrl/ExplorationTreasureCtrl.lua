...
ExplorationTreasureCtrl.GetTreasureRoomRefreshPrice = function(self)
  -- function num : 0_3 , upvalues : EpStoreRoomUtil
...
ExplorationTreasureCtrl.SendItemSelect = function(self, idx, action)
  ...
  (self.netWork):CS_EXPLORATION_ITEM_Select(self.currPosition, idx, function()
    -- function num : 0_5_0 , upvalues : action, self, _ENV, ExplorationEnum
    if action ~= nil then
      action()
    end
...
ExplorationTreasureCtrl.SendItemLockOrUnlock = function(self, chipItem)
  -- function num : 0_8 , upvalues : MAX_TREASURE_LOCK_NUM, cs_MessageCommon, _ENV
