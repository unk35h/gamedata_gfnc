...
ExplorationEnum.eRoomType = {deploy = -1, start = 0, boss = 1, empty = 2, enemy = 3, item = 4, store = 5, elite = 6, challenge = 7, eventroom = 8, recovery = 9, chip = 10, story = 11, aidroom = 12, partfusion = 15, canNotSee = 100}
ExplorationEnum.eRoomLogicType = {none = 0, battle = 1, chip = 2, store = 3, treasure = 4, event = 5, excustom = 6, canNotSee = 100}
ExplorationEnum.eMapLogic = {Default = 1, TowerDefence = 3, Light = 4, Guard = 5, Brotato = 6}
...
ExplorationEnum.eEventRoomChoiceType = {Normal = 1, Random = 2, Upgrade = 3, Jump = 4, Assist = 5, AssistEx = 6}
...
ExplorationEnum.eExitRoomCompleteType = {EventRoom = 1, BattleToEp = 2, StoreRoom = 3, TreasureRoom = 4, OutsideSelectChip = 5, DiscardChip = 6, ResetRoom = 7, JumpRoomComplete = 8, SupportRoom = 9, TaskSelect = 10, SelectDebuff = 11, ExRoom = 12}
ExplorationEnum.eAutoEpSwitchType = {None = 0, EpWindow = 1, Battle = 2}
ExplorationEnum.eAutoEventChoiceType = {AllRoleHpLess = 1, OneRoleHpLess = 2, HasItemCount = 3, RoleAvgHpLess = 4, RoleAvgHpGreate = 5}
ExplorationEnum.eAutoTitleType = {Normal = 0, SelectRoom = 1, ExitRoom = 2, UpgradeChip = 3, DiscardChip = 4, BuyChip = 5, GiveupChip = 6, SelectChip = 7, UpgradeChipLimit = 8, EventSupport = 9}
ExplorationEnum.EnemyRoleType = {monster = 1, neutral = 2, player = 3, towerSumMonster = 4, templateMonster = 5}
...
ExplorationEnum.eResidentStoreType = {none = 0, weeklychallenge = 1, towerDefine = 2}
ExplorationEnum.eSkillAdapterType = {None = 0, Ban = 1, Replace = 2}
ExplorationEnum.SpecGameTypeAdapter = {None = 0, TD = 1, Recommend = 2, OfficialSupport = 3}
