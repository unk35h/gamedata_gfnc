  ...
  if (self.epCfg).view_range > 0 then
    ...
    do
      ...
      for i = x, (math.min)(self.maxMapColNumber, x + (self.epCfg).view_range) do
        -- DECOMPILER ERROR at PC341: Confused about usage of register: R16 in 'UnsetPending'
...
DynEpMapData.IsEpChallengeMode = function(self)
  -- function num : 0_27
  return self.isChallengeMode
end

DynEpMapData.EnableEpFloorRestart = function(self)
  -- function num : 0_28
  return self._snapshot
end

DynEpMapData.GetEpFloorRestartTimes = function(self)
  -- function num : 0_29
