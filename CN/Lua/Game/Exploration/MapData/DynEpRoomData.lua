...
DynEpRoomData.InitStoreRoomData = function(self, storeGroup)
  -- function num : 0_10 , upvalues : _ENV, ChipEnum, DynBuff, ChipData
...
DynEpRoomData.InitEventAndRecoveryRoomData = function(self, eventGroup, jumpCat)
  -- function num : 0_11 , upvalues : _ENV, ChoiceData
...
DynEpRoomData.InitEpExRoomData = function(self, epExRoom)
...
DynEpRoomData.GetNextRoom = function(self)
  ...
  if couldSelectAnyNextRoom and not self:GetNextAllRoom() then
    do return {} end
...
DynEpRoomData.GetNextParallelRoom = function(self)
  -- function num : 0_20 , upvalues : ExplorationEnum
  local colTrackType = (self.mapData):GetMapColTrackType(self.x)
...
DynEpRoomData.IsBattleRoom = function(self, epOp)
...
DynEpRoomData.GetRoomType = function(self, isJustDefaultType)
  -- function num : 0_38
...
DynEpRoomData.IsInTDBattle = function(self)
  -- function num : 0_47 , upvalues : ExplorationEnum
  do return (self.mapData).epMapLogic == (ExplorationEnum.eMapLogic).TowerDefence end
  -- DECOMPILER ERROR: 1 unprocessed JMP targets
end

DynEpRoomData.IsGuardTDBattle = function(self)
  -- function num : 0_48 , upvalues : ExplorationEnum
  do return (self.mapData).epMapLogic == (ExplorationEnum.eMapLogic).Guard end
  -- DECOMPILER ERROR: 1 unprocessed JMP targets
end

DynEpRoomData.IsBrotatoBattle = function(self)
  -- function num : 0_49 , upvalues : ExplorationEnum
  do return (self.mapData).epMapLogic == (ExplorationEnum.eMapLogic).Brotato end
  -- DECOMPILER ERROR: 1 unprocessed JMP targets
end
