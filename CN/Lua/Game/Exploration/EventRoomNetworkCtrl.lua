...
EventRoomNetworkCtrl.CS_EXPLORATION_EVENT_AssistEX = function(self, roomPos, quitHeroUidDic, enterIdDic, callback)
...
EventRoomNetworkCtrl.SC_EXPLORATION_EVENT_AssistEX = function(self, msg)
