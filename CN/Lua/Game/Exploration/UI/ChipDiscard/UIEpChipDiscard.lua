...
UIEpChipDiscard.InitEpChipDiscard = function(self, dynPlayer, closeCallback, needConsumeSkill)
...
UIEpChipDiscard.RegisterWinCallbacks = function(self, discardCb, closeCb, setUICb)
  -- function num : 0_4
...
UIEpChipDiscard.m_OnNewItem = function(self, go)
  -- function num : 0_10 , upvalues : UINEpChipDiscardItem
...
UIEpChipDiscard.CloseEpDiscard = function(self)
  -- function num : 0_21 , upvalues : _ENV, ExplorationEnum
  ...
  (self.explorationNetworkCtrl):CS_EXPLORATION_AlgUpperLimit_Exit(self.position, function()
    -- function num : 0_21_0 , upvalues : _ENV, ExplorationEnum, self
...
UIEpChipDiscard.OnWinClose = function(self)
  -- function num : 0_23
