...
UINMonsterLevelPreview.InitMonsterLevelPreview = function(self, curLevel, onCloseCallback, justOpen)
  ...
  for level = 1, maxLevel do
    ...
    if isCurLevel then
      ...
      -- DECOMPILER ERROR at PC137: Confused about usage of register: R16 in 'UnsetPending'
...
UINMonsterLevelPreview.BackAction = function(self)
  -- function num : 0_4
  self:Hide()
