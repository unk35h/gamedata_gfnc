...
ExplorationNetworkCtrl.CS_EXPLORATION_Start = function(self, dungeonId, formId, moduleId, ezMode, callBack, support, challengeMode, challengeTaskIdList, starting, substitute)
  -- function num : 0_2 , upvalues : _ENV, cs_WaitNetworkResponse
  -- DECOMPILER ERROR at PC1: Confused about usage of register: R11 in 'UnsetPending'

  (self.epSendStartData).dungeonId = dungeonId
  -- DECOMPILER ERROR at PC4: Confused about usage of register: R11 in 'UnsetPending'

  ;
  ((self.epSendStartData).formInfo).formationId = formId
  -- DECOMPILER ERROR at PC7: Confused about usage of register: R11 in 'UnsetPending'
...
ExplorationNetworkCtrl.CS_WEEKLYCHALLENGE_Start = function(self, id, buffIds, heroPos, treeId, skills, starting, substitute)
  ...
  for i,v in ipairs(buffIds) do
    -- DECOMPILER ERROR at PC11: Confused about usage of register: R13 in 'UnsetPending'
...
ExplorationNetworkCtrl.CS_EXPLORATION_SnapshotRollback = function(self, callBack)
...
ExplorationNetworkCtrl.SC_EXPLORATION_SnapshotRollback = function(self, msg)
...
ExplorationNetworkCtrl.CS_EXPLORATION_Detail = function(self, actLongId)
...
ExplorationNetworkCtrl.SC_EXPLORATION_RewardsShow = function(self, msg)
  -- function num : 0_61 , upvalues : _ENV, cs_WaitNetworkResponse
  NetworkManager:HandleDiff(msg.syncUpdateDiff)
  do
    if msg.ret ~= proto_csmsg_ErrorCode.None then
...
ExplorationNetworkCtrl.SC_EXPLORATION_BATTLE_GiveUpAlg = function(self, msg)
  -- function num : 0_67 , upvalues : _ENV, cs_WaitNetworkResponse
  NetworkManager:HandleDiff(msg.syncUpdateDiff)
  if msg.ret ~= proto_csmsg_ErrorCode.None then
...
ExplorationNetworkCtrl.SC_EXPLORATION_OVERCLOCK_BUY = function(self, msg)
  -- function num : 0_69 , upvalues : _ENV, cs_WaitNetworkResponse, cs_MessageCommon
  NetworkManager:HandleDiff(msg.syncUpdateDiff)
  if msg.ret ~= proto_csmsg_ErrorCode.None then
...
ExplorationNetworkCtrl.CS_WEEKLYCHALLENGE_ScorePreview = function(self, valid, tdHpPerDic, callback)
...
ExplorationNetworkCtrl.SC_WEEKLYCHALLENGE_ScorePreview = function(self, msg)
...
ExplorationNetworkCtrl.CS_EXPLORATION_BATTLE_RefreshCommandSkillTree = function(self, treeId, skills, callback)
  -- function num : 0_82 , upvalues : _ENV, cs_WaitNetworkResponse
  if not self:__CheckCmdTimeliness() then
    return 
  end
...
ExplorationNetworkCtrl.__CheckCmdTimeliness = function(self)
  -- function num : 0_84 , upvalues : _ENV, EpActCheckCmdTimelinessFunc
...
ExplorationNetworkCtrl.CS_EXPLORATION_EX_OVER = function(self, callback)
...
ExplorationNetworkCtrl.SC_EXPLORATION_EX_OVER = function(self, msg)
...
ExplorationNetworkCtrl.CS_EXPLORATION_OpeninBuffSelect = function(self, buffId, callback)
...
ExplorationNetworkCtrl.SC_EXPLORATION_OpeninBuffSelect = function(self, msg)
