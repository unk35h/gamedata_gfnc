...
TimePassController.RemoveEventTimer = function(self, eventId)
...
TimePassController.OnTimeUp = function(self)
  -- function num : 0_10 , upvalues : _ENV, TimePassOrder, TimePassFunc
  local curTimestamp = self:GetNextRefreshTimePoint()
...
TimePassController.InitTimePassData = function(self, callback)
  ...
  (NetworkManager:GetNetwork(NetworkTypeID.Object)):CS_COUNTER_Detail(function(args)
    -- function num : 0_11_0 , upvalues : _ENV, TimePassController, self, TimePassPostprocessFunc, callback
...
TimePassController.OnUpdateTimePassData = function(self, msg)
  -- function num : 0_12 , upvalues : _ENV, TimePassController, TimePassPostprocessFunc
...
TimePassController.GetDungeonPeriodDropTimes = function(self, dungeonType)
...
TimePassController.GetLogicWeekNum = function(self, timeStamp)
  ...
  if not timeStamp then
    local nowTm = (math.floor)(PlayerDataCenter.timestamp)
  end
...
TimePassController.GetLogicTodayPassTimeStamp = function(self)
