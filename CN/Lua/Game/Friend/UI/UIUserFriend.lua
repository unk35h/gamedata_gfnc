...
UIUserFriend.SetUserFriendCallback = function(self, callback)
  -- function num : 0_1
...
UIUserFriend.RefreshFriendList = function(self, list, selectUID)
  -- function num : 0_5 , upvalues : _ENV, eFriendUIState
...
UIUserFriend.OnClickFriendItem = function(self, item)
  ...
  PlayerDataCenter:GetUserInfoByUID((item.friendData):GetUserUID(), function(userInfoData)
    -- function num : 0_6_0 , upvalues : item, self
...
UIUserFriend.OnClickSearch = function(self, searchUID)
  -- function num : 0_7 , upvalues : _ENV, cs_MessageCommon, eFriendUIState
  if not searchUID then
    ...
    -- function num : 0_7_0 , upvalues : self, inputUID, cs_MessageCommon, _ENV, eFriendUIState
...
UIUserFriend.OnFriendListRefresh = function(self)
  -- function num : 0_9 , upvalues : eFriendUIState
  if self.eFriendUIState == eFriendUIState.friendList then
...
UIUserFriend.OnBlackListRefresh = function(self)
  -- function num : 0_12 , upvalues : eFriendUIState, _ENV
  if self.eFriendUIState == eFriendUIState.blacklist then
    error("目前没有黑名单的UI呢")
  end
end

UIUserFriend._OnSelfNameChange = function(self)
  -- function num : 0_13 , upvalues : eFriendUIState, _ENV
