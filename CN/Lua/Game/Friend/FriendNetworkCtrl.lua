...
FriendNetworkCtrl.CS_FRIEND_ApplyFriend = function(self, uid, way, callback)
...
FriendNetworkCtrl.CS_FRIEND_RefreshFriend = function(self, callback)
...
FriendNetworkCtrl.CS_FRIEND_Alias = function(self, uid, alias, callback)
...
FriendNetworkCtrl.SC_FRIEND_Alias = function(self, msg)
