...
UIGuide.OnInit = function(self)
  -- function num : 0_0 , upvalues : GuideEnum, _ENV
...
UIGuide.ShowGuideAniInfo = function(self, info, info_type, info_pos, isFirst, step_type, arrow_offset)
  ...
  if step_type == (GuideEnum.StepType).Operate then
    local pos = position
    if arrow_offset ~= nil and #arrow_offset >= 2 then
...
UIGuide._LoadHeroSprite = function(self, info_type, img)
...
UIGuide.ShowGuideHeroSmallTalk = function(self, info, info_type, info_pos, nextAction)
  -- function num : 0_12 , upvalues : _ENV, GuideEnum
  if (string.IsNullOrEmpty)(info) then
    info = ""
  end
...
UIGuide.__ShowBigHeroPic = function(self, info_type, info_pos)
  ...
  if info_type > 0 then
    ...
    -- function num : 0_13_0 , upvalues : self, info_type, _ENV, info_pos
    if self.__lastBigImgHeroId ~= info_type then
      return 
    end
    DestroyUnityObject(self.bigImgGameObject)
...
UIGuide.OnBtnContinueClicked = function(self)
  -- function num : 0_15 , upvalues : GuideEnum
...
UIGuide.CloseGuide = function(self, step_type)
  -- function num : 0_19 , upvalues : GuideEnum
...
UIGuide.PlaySlideGuide = function(self, startUIPos, endUIPos)
  -- function num : 0_20 , upvalues : GuideEnum, _ENV
...
UIGuide.EndSlideGuide = function(self)
  -- function num : 0_21 , upvalues : GuideEnum, _ENV
...
UIGuide.PlayHandClickGuide = function(self, startUIPos)
  -- function num : 0_22 , upvalues : GuideEnum, _ENV
...
UIGuide.EndHandClickGuide = function(self)
  -- function num : 0_23 , upvalues : GuideEnum, _ENV
...
UIGuide.AddSpeicalGuideShowRefresh = function(self, refreshEvent)
  -- function num : 0_24
  self.__specRefreshEvent = refreshEvent
end

UIGuide.__OnScreenSizeChanged = function(self)
