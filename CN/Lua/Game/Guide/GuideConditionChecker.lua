...
, [eGuideCondition.InHome] = function(condition_arg)
  ...
  if #condition_arg == 1 then
    ...
    if arg1 == 1 and not hasHasUncompletedEp then
      return false
    end
  end
  do
    if arg1 == 2 and hasHasUncompletedEp then
      return false
    end
    return true
  end
...
GuideConditionChecker.CheckGuideCondition = function(condition_type, condition_arg)
  -- function num : 0_37 , upvalues : guideCheckFunc
...
, [(GuideEnum.TriggerGuideCondition).ActivityExist] = function(condition_arg)
  ...
  local actCatId = 0
  actCatId = condition_arg == nil or condition_arg[1] or 0
...
GuideConditionChecker.CheckTriggerGuideCondition = function(condition_type, condition_arg)
  -- function num : 0_45 , upvalues : _ENV, guideTriggerCheckFunc
