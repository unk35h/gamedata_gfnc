...
GuideType_Normal.__RefreshOperatorGuidePos = function(self, isRectTrasform, isFirst)
  -- function num : 0_14 , upvalues : _ENV, GuideEnum, CS_RenderManager
  local success = false
  if IsNull(self.curTargetTransform) then
    return false
  end
...
GuideType_Normal.__OnScreenSizeChanged = function(self)
...
GuideType_Normal.OnCurStepFinish = function(self)
  -- function num : 0_16 , upvalues : GuideEnum
...
GuideType_Normal.ClearOperatorGuide = function(self)
  -- function num : 0_20 , upvalues : _ENV, GuideEnum, CS_EventTriggerListener
