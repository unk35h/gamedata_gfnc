...
GuideUtil.__OnBattleDeployGuideStart = function(deployState, startX, startY, endX, endY)
  ...
  UIManager:ShowWindowAsync(UIWindowTypeID.Guide, function(window)
    ...
    window:AddSpeicalGuideShowRefresh(function()
      -- function num : 0_10_0_0 , upvalues : _ENV, deployState, startX, startY, endX, endY, window
      local battleMgr = (CS.BattleManager).Instance
      if not battleMgr.IsInBattle then
        return 
      end
...
GuideUtil.StartBattleDeployClickGuide = function(endX, endY)
  ...
  (UIManager:GetWindow(UIWindowTypeID.Battle)):SetBattleCanvasRaycast(false)
  UIManager:ShowWindowAsync(UIWindowTypeID.Guide, function(window)
    -- function num : 0_12_0 , upvalues : deployState, endX, endY, _ENV, battleMgr
    if window == nil then
      return window
    end
    ...
    window:AddSpeicalGuideShowRefresh(function()
      -- function num : 0_12_0_0 , upvalues : battleMgr, deployState, endX, endY, _ENV, window
      if not battleMgr.IsInBattle then
        return 
      end
      local startPos = ((deployState.battleController).battleFieldData):GetGridUnityPos(endX, endY)
...
, true)
      ...
      local selectDescribeModeFunc = function()
        -- function num : 0_15_0_0_1 , upvalues : _ENV, continueFunc
        UIManager:ShowWindowAsync(UIWindowTypeID.SettingDescribe, function(win)
          -- function num : 0_15_0_0_1_0 , upvalues : continueFunc
          if win == nil then
            continueFunc()
            return 
          end
      ...
      if FunctionUnlockMgr:ValidateUnlock(proto_csmsg_SystemFunctionID.SystemFunctionID_ChangeName) and (ConfigData.game_config).changeNameItemNum <= PlayerDataCenter:GetItemCount((ConfigData.game_config).changeNameItemId) and PlayerDataCenter.renameCount == 0 and not CloseCustomBename then
        UIManager:ShowWindowAsync(UIWindowTypeID.UserNameCreate, function(window)
        -- function num : 0_15_0_0_2 , upvalues : selectDescribeModeFunc
...
GuideUtil.StartFormationGuide = function(heroId, posId)
  ...
  (cs_coroutine.start)(function()
    ...
    do
      ...
      -- function num : 0_23_0_0 , upvalues : _ENV, heroTransfrom, destTransfrom, guideWindow
...
GuideUtil.StartManualSkillSelectCoord = function(x, y)
  ...
  UIManager:ShowWindowAsync(UIWindowTypeID.Guide, function(window)
    -- function num : 0_27_0 , upvalues : battleCtrl, x, y, _ENV, battleMgr
    if window == nil then
      return window
    end
    ...
    window:PlayHandClickGuide(startUIPos)
    window:AddSpeicalGuideShowRefresh(function()
      -- function num : 0_27_0_0 , upvalues : battleMgr, battleCtrl, x, y, _ENV, window
      if not battleMgr.IsInBattle then
        return 
      end
      local startPos = (battleCtrl.battleFieldData):GetGridUnityPos(x, y)
...
GuideUtil.StartWarChessDeploy = function(tIndex, x, y)
  -- function num : 0_32 , upvalues : _ENV, cs_coroutine, cs_WaitForSeconds
  local eWarChessEnum = require("Game.WarChess.eWarChessEnum")
  ;
  (cs_coroutine.start)(function()
    -- function num : 0_32_0 , upvalues : _ENV, eWarChessEnum, cs_WaitForSeconds, tIndex, x, y
    local guideWindow = UIManager:GetWindow(UIWindowTypeID.Guide)
    ;
    (UIManager:GetWindow(UIWindowTypeID.WarChessMain))
    local wcMain = nil
    local deployNode = nil
    if wcMain ~= nil then
    ...
    guideWindow:PlaySlideGuide(startUIPos, endUIPos)
    guideWindow:AddSpeicalGuideShowRefresh(function()
      -- function num : 0_32_0_0 , upvalues : _ENV, teamItem, gridData, guideWindow
...
GuideUtil.StartWCGridClickGuide = function(endX, endY)
  -- function num : 0_33 , upvalues : _ENV, GuideUtil
  local eWarChessEnum = require("Game.WarChess.eWarChessEnum")
  ...
  UIManager:ShowWindowAsync(UIWindowTypeID.Guide, function(window)
    -- function num : 0_33_0 , upvalues : warchessCtrl, endX, endY, _ENV
    if window == nil then
      return window
    end
    ...
    window:PlayHandClickGuide(startUIPos)
    window:AddSpeicalGuideShowRefresh(function()
      -- function num : 0_33_0_0 , upvalues : _ENV, gridData, window
      if not WarChessManager:GetIsInWarChess() then
        return 
      end
      local pos = gridData:GetGridShowPos()
...
GuideUtil.__OnWCGridClickGuideEnd = function()
...
GuideUtil.WCCameraFocus = function(x, y, time)
  -- function num : 0_35 , upvalues : _ENV, GuideUtil
  local eWarChessEnum = require("Game.WarChess.eWarChessEnum")
  if not WarChessManager:GetIsInWarChess() then
    GuideManager:SkipGuide()
    return 
  ...
  if time <= 0 then
    ...
    -- function num : 0_35_0 , upvalues : _ENV, GuideUtil
...
GuideUtil.SetHomeHandBookState = function(active)
...
GuideUtil.ActLobbyWaitPopInteractUI = function(intrctEntityId)
  -- function num : 0_37 , upvalues : _ENV, GuideUtil
  local fallbackTime = 20
  local waittime = Time.realtimeSinceStartup
  ;
  (UIUtil.AddOneCover)("GuideUtil")
  local Finish = function()
    -- function num : 0_37_0 , upvalues : _ENV, GuideUtil
  ...
  GuideUtil._stepTimer = TimerManager:StartTimer(0.2, function()
    -- function num : 0_37_1 , upvalues : _ENV, waittime, fallbackTime, intrctEntityId, Finish
      ...
      do
        do
          if targetWindow ~= nil then
            local targetTrans = (targetWindow.transform):Find("InteractNode/interactItem_" .. tostring(intrctEntityId))
...
GuideUtil.ClearData = function(self)
  -- function num : 0_38 , upvalues : GuideUtil
  GuideUtil.__tlUnlockOasis = nil
end

GuideUtil.ClearOnNetReset = function()
  -- function num : 0_39 , upvalues : GuideUtil, _ENV
