...
UIUserInfo.OnInit = function(self)
  -- function num : 0_0 , upvalues : cs_ResLoader, _ENV, UINUserInfoNode, UINShareCommonBtn
...
UIUserInfo.InitUserInfo = function(self)
  -- function num : 0_1 , upvalues : _ENV, eShare
...
UIUserInfo._OnClickShare = function(self)
...
UIUserInfo._ShareShow = function(self, show)
