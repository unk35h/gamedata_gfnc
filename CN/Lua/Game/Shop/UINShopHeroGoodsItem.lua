...
UINShopHeroGoodsItem.InitItem = function(self, resloader, OnClickGoodItem)
  -- function num : 0_1
...
UINShopHeroGoodsItem.InitNormalGoodsItem = function(self, goodData, parentNode, purchaseRoot)
  ...
  do
    if ((self.goodData).shelfCfg).showdiscount or (self.goodData).shelfCfg == nil or 0 > 0 then
