...
DungeonData.IsHideDg = function(self)
  -- function num : 0_16
...
DungeonData.GetDungeonDropInfo = function(self)
...
DungeonData.IsDungeonHasDoubleReward = function(self)
  -- function num : 0_28 , upvalues : _ENV
  for _,dungeonStage in ipairs(self.dungeonStageList) do
    do return (PlayerDataCenter.playerBonus):IsDungeonHasMultReward(dungeonStage:GetDungeonSeverType()) end
  end
  return false
end

DungeonData.GetLeftActivityMultRewardNum = function(self)
  -- function num : 0_29 , upvalues : eDungeonEnum
...
DungeonData.GetIsDungeonHaveMultReward = function(self)
  -- function num : 0_32 , upvalues : _ENV, ActivityFrameEnum
    ...
    if weekNum == nil then
      ...
      do
        ...
        do
          ...
          do
            do
              do return (PlayerDataCenter.timestamp < self.__rewardRateCahangeExpiredTm or self.__rewardRateCahangeExpiredTm < 0) and self:GetLeftActivityMultRewardNum() > 0 end
              do return (PlayerDataCenter.timestamp < self.__rewardRateCahangeExpiredTm or self.__rewardRateCahangeExpiredTm < 0) and self:GetLeftActivityMultRewardNum() > 0 end
...
DungeonData.IsFrageDungeon = function(self)
  -- function num : 0_35
...
DungeonData.GetDungeonAutoBattleMaxLimit = function(self)
...
DungeonData.GetDungeonAutoBattleMaxStage = function(self)
