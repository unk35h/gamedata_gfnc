...
SectorNetworkCtrl.SC_SECTOR_SyncUpdateDiff = function(self, msg)
  -- function num : 0_10 , upvalues : _ENV, CheckerTypeId
...
SectorNetworkCtrl.CS_WEEKLYCHALLENGE_RankPage = function(self, isHistory, pageId, rankCat, callback)
  -- function num : 0_20 , upvalues : _ENV, cs_WaitNetworkResponse
  local msg = {history = isHistory or false, pageId = pageId or 1, rankCat = rankCat or 1}
