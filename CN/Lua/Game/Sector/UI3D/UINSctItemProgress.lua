...
UINSctItemProgress.SetSctChallengeProgress = function(self, isOpen, curNum, allNum)
  -- function num : 0_4 , upvalues : _ENV
  ((self.ui).obj_challenge):SetActive(isOpen)
  if not isOpen then
    return 
  end
  ;
  ((self.ui).tex_TotalChall):SetIndex(0, tostring(curNum), tostring(allNum))
end
