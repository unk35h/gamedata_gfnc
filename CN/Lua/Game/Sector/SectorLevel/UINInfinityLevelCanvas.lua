...
UINInfinityLevelCanvas.__OnChangeItem = function(self, go, index)
  ...
  if levelData.isPlaceHoleder then
    ...
    if self.lastSelectData ~= nil and self._startSelectedIndex ~= nil and self._startSelectedIndex < (levelData.cfg).index and (levelData.cfg).index <= ((self.lastSelectData).cfg).index then
      selected = true
    end
...
UINInfinityLevelCanvas.OnclickLevelItem = function(self, levelData, levelItem)
  -- function num : 0_10 , upvalues : _ENV, SectorEnum
  if levelData.isPlaceHoleder then
    return 
  end
...
UINInfinityLevelCanvas._SetLvItemSelected = function(self, selected)
  -- function num : 0_11
...
UINInfinityLevelCanvas.m_MoveOnItemSelect = function(self, levelItem, levelData)
...
UINInfinityLevelCanvas.ShowLevelDetailWindow = function(self, callback)
  ...
  UIManager:ShowWindowAsync(UIWindowTypeID.SectorLevelDetail, function(win)
    ...
    win:SetLevelDetaiHideStartEvent(function()
      -- function num : 0_14_0_0 , upvalues : self, width, duration
      (self.wheel):SetArrowActive(false)
...
UINInfinityLevelCanvas.Roll2TargetIndex = function(self, index)
  ...
  ((self.ui).loopScrollRect):SrollToCell(targetIndex, 8000, function()
    -- function num : 0_15_0 , upvalues : _ENV, index, self, targetIndex
