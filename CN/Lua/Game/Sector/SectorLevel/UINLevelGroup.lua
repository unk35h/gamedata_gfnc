...
UINLevelGroup.OnInit = function(self)
  -- function num : 0_0 , upvalues : _ENV, UINLevelItem, UINLevelAvgMain, UINLevelAvgSub, UINLevelLine, UINLevelDungeonItem, UINLevelDungeonLine, UICanvasBg
      ...
      do
        ...
        if not isLastGroup or not (self.ui).lastPadding then
          do
            ...
            -- DECOMPILER ERROR at PC168: Confused about usage of register: R19 in 'UnsetPending'

            ;
            ((self.ui).layoutElement).preferredHeight = height
            local sizeDelta = (Vector2.New)(width, height)
            -- DECOMPILER ERROR at PC175: Confused about usage of register: R20 in 'UnsetPending'

            ;
            (self.transform).sizeDelta = sizeDelta
            -- DECOMPILER ERROR at PC178: Confused about usage of register: R20 in 'UnsetPending'
            ...
            for k,v in ipairs(levelGroupData) do
              ...
              if v.stageCfg ~= nil then
                ...
                -- DECOMPILER ERROR at PC267: Confused about usage of register: R34 in 'UnsetPending'

                ;
                (self.__itemList)[k] = levelItem
                -- DECOMPILER ERROR at PC270: Confused about usage of register: R34 in 'UnsetPending'
              ...
              elseif v.avgCfg ~= nil then
                ...
                -- DECOMPILER ERROR at PC295: Confused about usage of register: R34 in 'UnsetPending'
              ...
              do
                ...
                -- DECOMPILER ERROR at PC451: Confused about usage of register: R37 in 'UnsetPending'
                ...
                do
                  ...
                  lineItem:InitLevelLine(lineType, startPos, angle)
                  lastPos = startPos
                  -- DECOMPILER ERROR at PC504: LeaveBlock: unexpected jumping out DO_STMT
...
UINLevelGroup.InsetDungeonInSectorGroup = function(self, dungeonStageMapping, dungeonDataDic, lineHolder, clickDungeonItemEvent, blueReddotFunc)
  ...
  (table.sort)(dungeonList, function(a, b)
    -- function num : 0_2_0 , upvalues : dungeonStageMapping
    do return (dungeonStageMapping.dungeon)[a] < (dungeonStageMapping.dungeon)[b] end
...
UINLevelGroup.SectorLevelTryTipsGuide = function(self, item, id, isAvg)
  ...
  if (self.sectorLevelTipsGuides)[isAvg] ~= nil then
    ...
    -- function num : 0_4_0 , upvalues : _ENV, item, show_dir, self
...
UINLevelGroup.__ShowLAvgSubItem = function(self, levelItem, isVertical)
  -- function num : 0_6 , upvalues : _ENV, eLevelLineType
...
UINLevelGroup.GetLevelDungeonItem = function(self, dungeonId)
  -- function num : 0_8
...
UINLevelGroup.RefreshLevelConnectLineState = function(self)
  -- function num : 0_13 , upvalues : _ENV, eLevelLineType
...
UINLevelGroup.__RefreshDungeonState = function(self)
