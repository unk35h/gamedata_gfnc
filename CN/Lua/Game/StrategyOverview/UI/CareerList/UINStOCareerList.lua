...
UINStOCareerList.RefreshAllStOListTech = function(self, buildingData)
  -- function num : 0_6 , upvalues : base
  (base.RefreshAllStOListTech)(self, buildingData)
  self:__RefreshCanLevelupItemDic()
end

UINStOCareerList.EnterStOList = function(self)
  -- function num : 0_7
...
UINStOCareerList.__RefreshCanLevelupItemDic = function(self)
...
UINStOCareerList.IsCanSelctNextLevelupItem = function(self)
  -- function num : 0_10
  if self._canLevelBuildItemCount == 0 then
    return false
  end
  do return self.lastSelectTech ~= nil and (self._canLevelBuildItemCount == 1 and not (self.lastSelectTech):IsTethCanLevelup()) end
  do return true end
  -- DECOMPILER ERROR: 3 unprocessed JMP targets
end

UINStOCareerList.SelectNextCanLevelUpItem = function(self)
  -- function num : 0_11 , upvalues : _ENV
  if not self:IsCanSelctNextLevelupItem() then
    return 
  end
  local selectBuildItem = nil
...
UINStOCareerList.GetCareerListSelectNextFunc = function(self)
  -- function num : 0_12
  return self.__IsCanSelctNextLevelupItem, self.__SelectNextCanLevelUpItem
end

UINStOCareerList.__SelectItemInTheMiddle = function(self)
  -- function num : 0_13
  ...
  if -itemY < height / 2 then
    ...
    if rectHeight + itemY < height / 2 then
