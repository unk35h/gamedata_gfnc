...
local MailParamKey = {keyNone = 0, keyLotteryPoolName = 1, keyGiftGroupName = 2, keyPayProductId = 3, keyTimestamp1 = 4, keyHeroId = 5}
      ...
      if temp.cat == MailParamKey.keyGiftGroupName then
        ...
        if temp.cat == MailParamKey.keyPayProductId then
          ...
          if temp.cat == MailParamKey.keyTimestamp1 then
            ...
            do
              do
                if temp.cat == MailParamKey.keyHeroId then
