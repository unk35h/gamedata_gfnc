...
OasisController.OnInit = function(self)
  -- function num : 0_1 , upvalues : _ENV, cs_ResLoader, cs_GameObject, CoordinateConvert, cs_SkyController, cs_CameraController, util, OasisEnum, OasisLittleManCtrl, OasisWeatherCtrl
...
OasisController.__GenerateLittleMan = function(self)
  -- function num : 0_64
  if self.oasisLittleManCtrl ~= nil then
...
OasisController.RemoveLittleMan = function(self, isClearCache)
  -- function num : 0_65
  if self.oasisLittleManCtrl ~= nil then
...
OasisController.OnExitOasis = function(self)
  -- function num : 0_70 , upvalues : JumpManager, OasisEnum, _ENV, cs_SkyController, cs_CameraController, cs_LeanTouch, InputMode
...
OasisController.OnDelete = function(self)
  -- function num : 0_71 , upvalues : _ENV, cs_SkyController, base
