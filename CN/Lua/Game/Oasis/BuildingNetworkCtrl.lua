...
BuildingNetworkCtrl.__GenSectorBuildableCount = function(self, sectorCfg)
  -- function num : 0_30 , upvalues : _ENV, BuildingBelong
...
BuildingNetworkCtrl.__GenCareerBuildableCount = function(self)
  -- function num : 0_31 , upvalues : _ENV, BuildingEnum
  local count = 0
...
BuildingNetworkCtrl.SendBuildingAccelerate = function(self, id, cost, callback)
  -- function num : 0_33 , upvalues : LastSendType, _ENV, cs_WaitNetworkResponse
