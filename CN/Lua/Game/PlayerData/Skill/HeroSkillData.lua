...
HeroSkillData.ctor = function(self, dataId, heroData, skillCfg)
...
HeroSkillData.GetSkillAdaptationSource = function(self)
  -- function num : 0_13
...
HeroSkillData.CanUpgrade = function(self)
  ...
  if consume.level_limit > (self.heroData).level then
    ...
    do return not rare or not star or not isHaveEnoughItem or notLimitLv, rare, star, isHaveEnoughItem, notLimitLv, needItemIds end
...
HeroSkillData.CopyHeroSkillNewId = function(self, skillId)
  -- function num : 0_30 , upvalues : HeroSkillData
