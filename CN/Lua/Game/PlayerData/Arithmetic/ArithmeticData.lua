...
ArithmeticData.GetAthMainAttrId = function(self, notMerge)
...
ArithmeticData.IsAthLock = function(self)
  -- function num : 0_10
...
local powerDic = {}
ArithmeticData.GetAthSubAttrQualityWeight = function(self)
  -- function num : 0_13 , upvalues : _ENV, powerDic
  local weight = 0
  for k,affix in ipairs(self.affixList) do
    if not powerDic[affix.quality] then
      local w = 10 ^ affix.quality
    end
...
ArithmeticData.CanAthOptimize = function(self)
  -- function num : 0_19 , upvalues : _ENV, affixQuality
  for index,attr in ipairs(self.affixList) do
...
ArithmeticData.GetAthDataUID = function(self)
  -- function num : 0_21
  return self.uid
end
...
ArithmeticData.GetAthDataSuitNum = function(self)
