...
AllAthData.ClearHeroAthStat = function(self)
  -- function num : 0_36
  self._heroAthStat = nil
end

AllAthData.GetHeroAthStat = function(self, heroId, callBack)
  -- function num : 0_37 , upvalues : _ENV
  self._getHeroAthStatcallBack = callBack
  if not self._heroAthStat then
    self._heroAthStat = {}
    ...
    if not self._OnReqHeroAthStatFunc then
      self._OnReqHeroAthStatFunc = BindCallback(self, self._OnReqHeroAthStat)
      ;
...
AllAthData._OnReqHeroAthStat = function(self, objList)
  -- function num : 0_38 , upvalues : _ENV
  if objList.Count ~= 1 then
    error("objList.Count error:" .. tostring(objList.Count))
    return 
  end
  local sortFunc = function(elemA, elemB)
    -- function num : 0_38_0
    do return elemB.ratio < elemA.ratio end
    -- DECOMPILER ERROR: 1 unprocessed JMP targets
  end
