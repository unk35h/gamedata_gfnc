...
PlayerDataCenter.InitData = function(self)
  -- function num : 0_0 , upvalues : _ENV, PlayerLevelData, AllBuildingData, SectorStageData, StaminaData, AllTaskData, TrainingSlotData, AchivLevelData, AllAthData, AllEffectorData, FriendshipData, AttributeBonus, DungeonDyncData, InfinityData, CacheSaveData, PeriodicChallengeData, AllWeeklyChallengeData, DailySignInData, PlayerBonus, AllBattlePassData, AllSkinData, AllActivityStarUpData, AllLtrPoolData, AllEventNoviceSignData, HeroAttrChecker, HomeChatDataCenter, FriendDataCenter, CheckerConditionRegister, SupportHeroData, AllTimingProduct, AllActivitySectorIData, SectorEntranceHandler, DungeonTowerDynData, AllHeroTalentData, AllAdjCustomData, FavorHeroData, AllSpecWeaponData, GameSettingData
  self.isOnline = false
  self.heroDic = {}
  self.heroCount = 0
  self.campHeroCount = {}
...
PlayerDataCenter.UpdateDungeonBattleTimes = function(self, msg)
  ...
  for i,v in ipairs(msg.quickChallengeModule) do
...
PlayerDataCenter.IsDungeonModuleOpenQuick = function(self, moduleId)
  -- function num : 0_2
...
PlayerDataCenter.SyncUserData = function(self, userData)
  -- function num : 0_8 , upvalues : _ENV, DynLimitTimeItemData, ItemData, UserInfoData, cs_MicaSDKManager, ActivityFrameEnum, FormationData
  self.isOnline = true
    ...
    do
      ...
      MsgCenter:Broadcast(eMsgEventId.ActivityShowChange)
              ...
              if (table.count)(self.formationDic) == 0 then
                ...
                -- DECOMPILER ERROR at PC470: Confused about usage of register: R5 in 'UnsetPending'
...
PlayerDataCenter.InitHeroData = function(self, heroGroup)
  -- function num : 0_11 , upvalues : _ENV, HeroData, CommanderSkillTreeData, FormationData
  if heroGroup ~= nil then
    ...
    local savingTreeDic = heroGroup.savingTree
    if savingTreeDic ~= nil then
      for k,v in pairs(savingTreeDic) do
        -- DECOMPILER ERROR at PC40: Confused about usage of register: R8 in 'UnsetPending'

        (self.cstDataDic)[k] = (CommanderSkillTreeData.CreateCstData)(k, v.skills)
      end
    end
    do
...
PlayerDataCenter.SyncItemUpdateDiff = function(self, resourceData)
  -- function num : 0_16 , upvalues : _ENV, DynLimitTimeItemData, ItemData
  local itemUpdate = {}
...
PlayerDataCenter.SyncHeroUpdateDiff = function(self, heroUpdateData)
  -- function num : 0_17 , upvalues : _ENV, HeroData, CheckerTypeId, PlayerDataCenter
  local hasNew = false
  local hasUpdateHero = false
  local heroUpdate = nil
  ...
  do
    if hasSkinUpdate then
      MsgCenter:Broadcast(eMsgEventId.UpdateHeroSkin)
    end
    if hasNew then
...
PlayerDataCenter.UpdateHeroBackOffData = function(self, datas)
  -- function num : 0_18 , upvalues : HeroBackOffData
  self.herobackoffData = (HeroBackOffData.New)(datas)
end

PlayerDataCenter.IsHeroBackOffEnable = function(self, heroId)
  -- function num : 0_19
...
PlayerDataCenter.GetItemOverflowNum = function(self, itemId, buyNum)
  -- function num : 0_21 , upvalues : _ENV, PlayerDataCenter
  ...
  if itemCfg.action_type == eItemActionType.HeroCardFrag then
    ...
    return (((needMaxNum >= 0 or not 0) and needMaxNum ~= 0) or not buyNum) and needMaxNum > 0 and needMaxNum < buyNum and needMaxNum > 0 and buyNum <= needMaxNum and 0
  else
    ...
    elseif not (self.skinData):IsHaveSkin(itemCfg.id) or not 1 then
      nowNum = nowNum + (itemCfg.type ~= eItemType.Skin or 0)
      if nowNum + buyNum > itemCfg.holdlimit or not 0 then
        do
          do return buyNum - (itemCfg.holdlimit - (nowNum)) end
          do return 0 end
...
PlayerDataCenter.GetItemCoutNoMerge = function(self, itemId, raw)
  -- function num : 0_22
...
PlayerDataCenter.GetDynLimtTimeItemStackInfo = function(self, itemId, index)
  -- function num : 0_24
  local itemData = (self.itemDic)[itemId]
...
PlayerDataCenter.CreateFormation = function(self, formationId)
  -- function num : 0_28 , upvalues : FormationData
...
PlayerDataCenter.UserLoginComplete = function(self, role, firstLogin)
  -- function num : 0_30 , upvalues : cs_playerData, _ENV
  ...
  if ((Consts.GameChannelType).IsInland)() then
    ...
    do
      if ((Consts.GameChannelType).IsPnSdk)(cs_MicaSDKManager.channelId) then
...
PlayerDataCenter.UpdateUserNameData = function(self, name)
  -- function num : 0_31 , upvalues : cs_playerData, _ENV
...
PlayerDataCenter.ContainsHeroData = function(self, heroId)
  -- function num : 0_33
  do return (self.heroDic)[heroId] ~= nil end
...
PlayerDataCenter.UnlockCommanderSkill = function(self)
  -- function num : 0_36 , upvalues : _ENV, FormationData
...
PlayerDataCenter.UpdateDormBriefData = function(self, dormBrief)
  -- function num : 0_40 , upvalues : DormBriefData
...
PlayerDataCenter.GetSelfName = function(self)
  -- function num : 0_42
  return self.playerName
end

PlayerDataCenter.GetSelfId = function(self)
  -- function num : 0_43
...
PlayerDataCenter.GetUserInfoByUID = function(self, uid, callback)
  -- function num : 0_45 , upvalues : _ENV, UserInfoData
  ...
  local netFunc = function()
    -- function num : 0_45_1 , upvalues : _ENV, uid, callback, next, userInfo, self, UserInfoData
    (NetworkManager:GetNetwork(NetworkTypeID.Object)):CS_AVATAR_Fetch(uid, function(args)
      -- function num : 0_45_1_0 , upvalues : callback, next, userInfo, self, uid, UserInfoData, _ENV
      local avatarMsg = nil
...
PlayerDataCenter.UpdCstData = function(self, treeId, skillIdList)
  -- function num : 0_48 , upvalues : PlayerDataCenter, CommanderSkillTreeData
  local cstData = (PlayerDataCenter.cstDataDic)[treeId]
  if cstData == nil then
    cstData = (CommanderSkillTreeData.New)(treeId)
    -- DECOMPILER ERROR at PC9: Confused about usage of register: R4 in 'UnsetPending'

    ;
    (PlayerDataCenter.cstDataDic)[treeId] = cstData
  end
  cstData:ApplySavingData(skillIdList)
  return cstData
end

PlayerDataCenter.CheckHaseLimitTimeItem = function(self)
  -- function num : 0_49 , upvalues : PlayerDataCenter, _ENV
  local isHasMin15 = false
  local isHas = false
  local checkDay = function(time)
    -- function num : 0_49_0 , upvalues : PlayerDataCenter, _ENV
  ...
  for k,v in pairs(self.itemDic) do
    if v:IsDynLimitTime() and v:GetWareHousePage() > 0 then
      for i = 1, v:GetStackCount() do
        isHasMin15 = checkDay(v:GetLimitTime(i))
      end
    else
      do
        -- DECOMPILER ERROR at PC41: Overwrote pending register: R2 in 'AssignReg'

        if isHasMin15 or not isHasMin15 then
          do
            if v:IsLimitTime() then
              isHasMin15 = checkDay(v:GetLimitTime())
            end
  ...
  if isHasMin15 or isHasMin15 ~= self.isHasMin15LimitTime then
...
PlayerDataCenter.GetIsHasLimitTime = function(self)
  -- function num : 0_50
...
PlayerDataCenter.GetIsHasMin15LimitTime = function(self)
  -- function num : 0_51
...
PlayerDataCenter.GetDynLimtTimeItemStackCount = function(self, itemId)
  -- function num : 0_52
  local itemData = (self.itemDic)[itemId]
  if itemData == nil or itemData:IsDynLimitTime() ~= true then
    return 1
...
PlayerDataCenter.IsItemOutTime = function(self, itemId, stacIndex)
  -- function num : 0_53 , upvalues : PlayerDataCenter
  local itemData = (self.itemDic)[itemId]
  if itemData == nil then
    return true
  end
  ...
  local time = 0
  if stacIndex ~= nil or not 0 then
    time = itemData:GetLimitTime(not itemData:IsDynLimitTime() or stacIndex)
...
PlayerDataCenter.IsItemLimitHold = function(self, itemId)
  ...
  do
    if itemCfg.type == eItemType.DormFurniture then
      ...
      return itemCfg.holdlimit <= self:GetItemCount(itemId) + count
    end
    if itemCfg.type == eItemType.Skin then
      return (self.skinData):IsHaveSkin(itemId)
    end
    do return itemCfg.holdlimit <= self:GetItemCount(itemId) end
    -- DECOMPILER ERROR: 4 unprocessed JMP targets
  end
end

PlayerDataCenter.CalCrItemTransDic = function(self, itemIds, itemNums)
  -- function num : 0_55 , upvalues : _ENV, PlayerDataCenter
  local dic = {}
