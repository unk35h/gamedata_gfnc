...
ChipBattleData.GetValidRoleList = function(self, dynBattleRoleList, belong, chipEffector)
  -- function num : 0_9 , upvalues : _ENV, EnemySelectorFunc
  local result = {}
...
ChipBattleData.SelValidRoleListPlayer = function(self, dynBattleRoleList)
  -- function num : 0_10 , upvalues : PlayerSelectorFunc
...
ChipBattleData.IsConsumeChipBattle = function(self)
  -- function num : 0_12 , upvalues : ChipEnum
...
ChipBattleData.IsForEnemyChipBattle = function(self)
  -- function num : 0_13 , upvalues : EnemySelectorFunc
  do return EnemySelectorFunc[self.influenceType] ~= nil end
  -- DECOMPILER ERROR: 1 unprocessed JMP targets
end

ChipBattleData.SetOnlyForOneHero = function(self, heroId)
  -- function num : 0_14 , upvalues : ChipEnum
  self.influenceType = (ChipEnum.eChipInfluenceType).HeroId
  self.influenceArg = heroId
end

ChipBattleData.IsForHeroIDChipBattle = function(self)
  -- function num : 0_15 , upvalues : ChipEnum
  do return self.influenceType == (ChipEnum.eChipInfluenceType).HeroId end
  -- DECOMPILER ERROR: 1 unprocessed JMP targets
end
