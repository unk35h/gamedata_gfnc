...
UINWarChessBuffItem.OnInit = function(self)
...
UINWarChessBuffItem.InitWarchessStoreBuffItem = function(self, storeData, MoneyIconId, clickFunc)
...
UINWarChessBuffItem.__ShowPrice = function(self, price, discount, MoneyIconId)
...
UINWarChessBuffItem.SetStoreBuffItemSelect = function(self, selected)
...
UINWarChessBuffItem.UpdateSellOutActive = function(self)
  -- function num : 0_4
  ((self.ui).img_SellOut):SetActive((self.epStoreItemData).saled)
end

UINWarChessBuffItem._OnClickRoot = function(self)
  -- function num : 0_5
...
UINWarChessBuffItem.OnDelete = function(self)
