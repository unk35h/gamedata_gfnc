...
UINWarChessEventLongNode.OnInit = function(self)
  -- function num : 0_0 , upvalues : base
  (base.OnInit)(self)
end

UINWarChessEventLongNode.RefreshEventText = function(self)
  -- function num : 0_1 , upvalues : _ENV, cs_LayoutRebuilder, cs_Tweening
...
UINWarChessEventLongNode.RefreshEntChoiceList = function(self)
  -- function num : 0_2 , upvalues : base, cs_LayoutRebuilder
