...
UINFormationChoiceItem.ctor = function(self, fmtCtrl, enterFmtData)
  -- function num : 0_0
...
UINFormationChoiceItem.OnInit = function(self)
  -- function num : 0_1 , upvalues : _ENV, UINHeroCardItem
...
UINFormationChoiceItem.SetShowInOtherFmt = function(self, bool)
  -- function num : 0_3
...
UINFormationChoiceItem.UpdFmtHeroChoiceItemHp = function(self, hpPer)
  -- function num : 0_10 , upvalues : UINFmtHeroHpBarItem, _ENV
...
UINFormationChoiceItem.RefreshSpecialGameHero = function(self)
