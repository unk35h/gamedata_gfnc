...
UINFormationChoiceSupportItem.InitAsUnavailable = function(self, clickAct)
  -- function num : 0_4
  self.clickAct = clickAct
  ;
  (self.heroCardItem):Hide()
...
UINFormationChoiceSupportItem.UpdFmtHeroChoiceItemHp = function(self, hpPer)
  -- function num : 0_12 , upvalues : UINFmtHeroHpBarItem, _ENV
...
UINFormationChoiceSupportItem.SetSpecialGameHeroActive = function(self, sepcShowType)
  -- function num : 0_13
