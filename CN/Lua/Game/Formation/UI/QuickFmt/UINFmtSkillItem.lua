...
UINFmtSkillItem.FmtShowSkillAdapter = function(self, adapterType)
  -- function num : 0_2 , upvalues : ExplorationEnum
  (((self.ui).img_SpecIcon).gameObject):SetActive(not self.unlock or adapterType > 0)
  ;
  (self.baseSkillItem):SetBanSkillActive(not self.unlock or adapterType == (ExplorationEnum.eSkillAdapterType).Ban)
