...
UIFormationQuick.InitQuickFmt = function(self, fmtData, fmtCtrl, selectHeroData, specialRuleGenerator)
  -- function num : 0_1 , upvalues : UINHeroSortList, UINHeroCardItem, _ENV, ExplorationEnum, UINSortButtonGroup, UINAthHeroInfo, HeroSortEnum
  ...
  if isTdGame then
    ...
    -- function num : 0_1_0 , upvalues : ExplorationEnum, self
...
UIFormationQuick.RefreshSelectedHero = function(self, heroData)
  -- function num : 0_6 , upvalues : _ENV, UINHeroAttributeNode, ExplorationEnum
  if heroData == nil then
...
UIFormationQuick.OnBtnDetailClick = function(self)
  ...
  if ((self.specialRuleGenerator).specialRuler).heroIds == nil then
    hasSpecialHero = self.specialRuleGenerator == nil
