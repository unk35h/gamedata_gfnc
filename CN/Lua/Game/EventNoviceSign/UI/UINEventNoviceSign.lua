...
UINEventNoviceSign.OnClickNoviceSignReceive = function(self)
  -- function num : 0_3 , upvalues : TaskEnum, _ENV, CommonRewardData
  if (self.data):GetReceiveState((self.awardCfg).day) == (TaskEnum.eTaskState).Completed then
    ...
    -- function num : 0_3_0 , upvalues : self, _ENV, CommonRewardData
    self:RefreshNoviceSignItem()
    ...
    UIManager:ShowWindowAsync(UIWindowTypeID.CommonReward, function(window)
      -- function num : 0_3_0_0 , upvalues : CommonRewardData, rewardIdList, rewardNumList
      if window ~= nil then
