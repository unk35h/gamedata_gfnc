...
UIBattleResult.OnInit = function(self)
  -- function num : 0_0 , upvalues : _ENV, cs_ResLoader, UIRewardItem, UICharacterItem
...
UIBattleResult.SkipSettlementTimeLine = function(self)
  ...
  if m_settlementDirector.time < skipLength then
    m_settlementDirector.time = skipLength
  end
end

UIBattleResult.BackAction = function(self)
  -- function num : 0_12
...
UIBattleResult.SetStartExpAnimation = function(self)
