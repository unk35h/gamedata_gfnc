...
ArithmeticNetwork.CS_ATH_ReconsitutionExec = function(self, uid, dogFoodUidList, totalTimes, callBack)
...
ArithmeticNetwork.CS_ATH_ReconsitutionSave = function(self, idx, callBack)
...
ArithmeticNetwork.CS_ATH_Stat = function(self, heroId, callBack)
  -- function num : 0_34 , upvalues : _ENV, cs_WaitNetworkResponse
  if not self.__statTab then
    self.__statTab = {}
    -- DECOMPILER ERROR at PC6: Confused about usage of register: R3 in 'UnsetPending'
...
ArithmeticNetwork.SC_ATH_Stat = function(self, msg)
