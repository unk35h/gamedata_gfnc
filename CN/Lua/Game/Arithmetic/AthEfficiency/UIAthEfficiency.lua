...
UIAthEfficiency.OnInit = function(self)
  -- function num : 0_0 , upvalues : _ENV, AthUtil, UINAthList, UINAthEfccQuickSelect
...
UIAthEfficiency._ShowAthDetailFloat = function(self, athData)
...
UIAthEfficiency.__OnClickUpgrade = function(self)
  ...
  local requestFunc = function()
    -- function num : 0_12_0 , upvalues : self, itemDic, athDic
...
UIAthEfficiency.__ShowHeroPowerUpSuccess = function(self, newPower)
  ...
  if newPower ~= self.oldHeroPower then
    ...
    -- function num : 0_14_0 , upvalues : self, newPower
    if win ~= nil then
...
UIAthEfficiency._OnAthLockPre = function(self, athUid)
