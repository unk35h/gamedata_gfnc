...
UIATHMain.OnInit = function(self)
  -- function num : 0_0 , upvalues : _ENV, AthUtil, CS_LeanTouch, UINAthList, UINAthAreaItem, UINAthMainAtrrItem, UINAthSuitMainItem, UINAthInfoTogItem, UINShareCommonBtn
  ...
  for i = 1, (ConfigData.game_config).athSlotCount do
    ...
    areaItem:InitAthAreaItem(R8_PC196, self, self.__OnDragStart)
    -- DECOMPILER ERROR at PC201: Confused about usage of register: R6 in 'UnsetPending'

    ;
    (areaItem.gameObject).name = tostring(R8_PC196)
  end
  ;
  ...
  for k,go in ipairs((self.ui).infoTogList) do
    ...
    -- DECOMPILER ERROR at PC236: Overwrote pending register: R8 in 'AssignReg'

    infoTogItem:Init(go)
    -- DECOMPILER ERROR at PC239: Overwrote pending register: R8 in 'AssignReg'

    infoTogItem:InitAthInfoTogItem(R9_PC242, self.__selectInfoTogFunc)
    -- DECOMPILER ERROR at PC245: Overwrote pending register: R8 in 'AssignReg'

    ;
    (table.insert)(R8_PC196, R9_PC242)
  end
...
UIATHMain.InitATHMain = function(self, heroData, heroResLoader, addAllTouchFunc, switchHeroFunc)
  -- function num : 0_1 , upvalues : CS_Input, cs_ResLoader, _ENV, AthUtil, cs_MessageCommon, eShare
  ...
  do
    ...
    -- function num : 0_1_0 , upvalues : cs_MessageCommon, _ENV
...
UIATHMain.RefreshAthAttr = function(self, athSlotList, curSlotId, changeSort)
  ...
  (table.sort)(suitIdList, function(a, b)
    -- function num : 0_7_1 , upvalues : suitDic
...
UIATHMain.__OnClickShowHeroAttr = function(self)
  -- function num : 0_25 , upvalues : UIAttrUtil
...
UIATHMain.__ShowAthList = function(self, areaId)
  -- function num : 0_30 , upvalues : _ENV, AthUtil
...
UIATHMain.SelectInfoTogItem = function(self, infoState)
  -- function num : 0_40 , upvalues : athInfoState
...
UIATHMain.RefillAth = function(self, athData, gridId, resortAthDic, athInstalledDic, refillOp)
  ...
  if gridId == nil then
    ...
    -- function num : 0_42_0 , upvalues : self, athData, resortAthDic, athInstalledDic, _ENV, curAreaId, gridId, refillOp
    ...
    -- function num : 0_42_1 , upvalues : self, athData, installFunc
    if window == nil then
      return 
    end
...
UIATHMain.OneKeyInstall = function(self)
  -- function num : 0_51 , upvalues : _ENV, AthAreaGridData, AthUtil
  local slots = {}
...
UIATHMain.OneKeyUninstall = function(self)
  -- function num : 0_53 , upvalues : _ENV, oneKeyUninstallSlotList
  local hasAth = false
...
UIATHMain._OnClickShare = function(self)
  ...
  UIManager:ShowWindowAsync(UIWindowTypeID.Share, function(win)
    ...
    ((win:SetShareBeforeCaptureFunc(function()
      -- function num : 0_57_0_0 , upvalues : self
...
UIATHMain._ShareShow = function(self, show)
...
UIATHMain.OnDelete = function(self)
  -- function num : 0_59 , upvalues : _ENV, CS_LeanTouch, CS_Input, base
