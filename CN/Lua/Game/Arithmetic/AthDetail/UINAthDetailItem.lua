...
UINAthDetailItem.SetAthDetailItemBrief = function(self, isBrief)
  -- function num : 0_1
...
UINAthDetailItem.InitAthDetailItem = function(self, detailRoot, athData, heroData, isAddPreview, isReplace, isOnlyInfo)
  -- function num : 0_2 , upvalues : ArthmeticEnum, _ENV
...
UINAthDetailItem._UpdSuit = function(self)
...
UINAthDetailItem.__showAttrIntro = function(self, attrId, iconSprite, itemTrans)
  -- function num : 0_7 , upvalues : UINAttrIntroItem
...
UINAthDetailItem.__OnClickOptimize = function(self)
  -- function num : 0_13 , upvalues : _ENV, cs_MessageCommon, ArthmeticEnum
  do
