...
UINAthRefactorDetail._UpdAthRfctDetailUsingRate = function(self)
  -- function num : 0_3 , upvalues : UINAthUsingRate, _ENV
...
UINAthRefactorDetail._ShowUsingRateWin = function(self)
...
UINAthRefactorDetail.RefreshRfctDetailSubAttr = function(self)
  -- function num : 0_7 , upvalues : _ENV, ArthmeticEnum
  local athData = self.athData
...
UINAthRefactorDetail.UpdAthRfctDetailConsumeItem = function(self, num)
...
UINAthRefactorDetail.RefreshCanRefactorBtn = function(self, costNum)
  -- function num : 0_13
