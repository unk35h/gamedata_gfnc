...
UIActivityStarUp.ActivityChange = function(self, taskCfg)
  ...
  if (self.activityInfo):ContainsTask(taskCfg.id) then
    ...
    -- function num : 0_7_0 , upvalues : CommonRewardData, taskCfg
    if window == nil then
      return 
    end
...
UIActivityStarUp.DealExtraParam = function(self)
  -- function num : 0_13 , upvalues : HeroCubismInteration, _ENV, ActivityStarUpEnum
...
UIActivityStarUp.LoadLive2D = function(self, path, params)
  -- function num : 0_14 , upvalues : _ENV, HeroCubismInteration
  ...
  (self.Live2DResloader):LoadABAssetAsync(path, function(l2dModelAsset)
    -- function num : 0_14_0 , upvalues : HeroCubismInteration, self, _ENV
    (HeroCubismInteration.DestroyInterationInstance)(self.l2dModelIns)
