...
UIPreviewSkin.ShowSkinPreview = function(self, skinId, heroStar, notSetBackFunc)
...
UIPreviewSkin.__LoadLive2D = function(self, path, skinCfg)
  ...
  (self.Live2DResloader):LoadABAssetAsync(path, function(l2dModelAsset)
    -- function num : 0_4_0 , upvalues : self, _ENV, HeroCubismInteration, skinCfg
...
UIPreviewSkin.GenCoverJumpReturnCallback = function(self)
  -- function num : 0_6 , upvalues : _ENV, waitRecorverNUM
  ...
  return function()
    -- function num : 0_6_0 , upvalues : self, _ENV, dataTable, waitRecorverNUM
    self.skinId = nil
    self.heroStar = nil
