...
TaskNetworkCtrl.OnRecvSyncUpdateDiff = function(self, msg)
  ...
  for taskId,deleteReason in pairs(msg.delete) do
    ...
    if taskData ~= nil then
      if (deleteReason == proto_object_QuestDeleteReason.QuestDeleteReasonCompleted or deleteReason == proto_object_QuestDeleteReason.QuestDeleteReasonCompletedShowOver) and (taskData.stcData).type == (TaskEnum.eTaskType).MainTask then
...
TaskNetworkCtrl.SC_QUEST_OneKeyPick = function(self, msg)
  ...
  if #rewardIds > 0 then
    ...
    -- function num : 0_16_1 , upvalues : _ENV, rewardIds, rewardNums, self
    if window == nil then
      return 
    end
    ...
    local CRData = ((((CommonRewardData.CreateCRDataUseList)(rewardIds, rewardNums)):SetCRHeroSnapshoot(self._heroIdSnapShoot, false)):SetCRNotHandledGreat(true)):SetCRShowOverFunc(function()
      -- function num : 0_16_1_0 , upvalues : _ENV
