...
UIGetHero.SetGetHeroConvertFrag = function(self, upHeroFragDic)
  -- function num : 0_3
...
UIGetHero.InitGetHeroList = function(self, heroIdList, useHeroData, withGetHeroSound, newHeroIndexDic, closeFunc, skipOldHero, newSkinIdDic)
  -- function num : 0_4 , upvalues : eSkipMode, _ENV
...
UIGetHero.ShowNext = function(self)
  -- function num : 0_6 , upvalues : _ENV, eSkipMode
  self:_StopHeroVoice()
  ;
...
UIGetHero._InitGetHero = function(self, heroId, isNew, newSkinId)
  -- function num : 0_7 , upvalues : _ENV, m_moviePlayer, cs_MovieManager, HeroIdTo4Hex, HeroCubismInteration, heroNameEffColor
  ...
  if isNew then
    ...
    ((self.ui).img_Camp).texture = texture
      ...
      -- DECOMPILER ERROR at PC280: Confused about usage of register: R13 in 'UnsetPending'
...
UIGetHero._ExtraHeroFrag = function(self, heroCfg)
  -- function num : 0_8 , upvalues : _ENV, UINBaseItem
...
UIGetHero._HeroConvert = function(self, heroCfg)
...
UIGetHero.__LoadLive2D = function(self, path, skinCfg)
  -- function num : 0_10 , upvalues : _ENV, HeroCubismInteration
  ...
  (self.Live2DResloader):LoadABAssetAsync(path, function(l2dModelAsset)
    -- function num : 0_10_0 , upvalues : HeroCubismInteration, self, _ENV, skinCfg
    (HeroCubismInteration.DestroyInterationInstance)(self.l2dModelIns)
...
UIGetHero.SetPlayEffectColor = function(self, qualityColor, nameEffColor)
  -- function num : 0_12 , upvalues : _ENV, cs_ParticleSystem
...
UIGetHero._OnConvertTween = function(self)
  ...
  for index,item in ipairs((self.cardConvertItemPool).listItem) do
    ...
    -- function num : 0_20_0 , upvalues : item, self
...
UIGetHero._OnStarVoice = function(self, starNum)
  ...
  if starNum <= self.starCount then
    ...
    -- function num : 0_21_0 , upvalues : self, starNum
...
UIGetHero.OnClickClose = function(self)
  -- function num : 0_25 , upvalues : m_moviePlayer, cs_PlayState
...
UIGetHero.OnClickSkip = function(self)
  -- function num : 0_26 , upvalues : eSkipMode
...
UIGetHero._ReturnMovie = function(self)
  -- function num : 0_28 , upvalues : _ENV, m_moviePlayer, cs_MovieManager
  -- DECOMPILER ERROR at PC9: Confused about usage of register: R1 in 'UnsetPending'
