...
UINHeroHeadItem.GetHeroHeadHeroData = function(self)
  -- function num : 0_6
  return self.heroData
end

UINHeroHeadItem.GetHeroHeadHeroId = function(self)
  -- function num : 0_7
  return self.heroId
end

UINHeroHeadItem.SetHpBarParent = function(self, hpCanvasTrans)
  -- function num : 0_8
...
UINHeroHeadItem.SetHpBarActive = function(self, activeSelf)
  -- function num : 0_9
  if (self.ui).HpBar ~= nil then
