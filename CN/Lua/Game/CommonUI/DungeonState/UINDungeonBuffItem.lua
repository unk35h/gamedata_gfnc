...
UINDungeonBuffItem.InitBuffOnlyWithCfg = function(self, buffCfg, longPressFunc, pressUpFunc)
...
UINDungeonBuffItem.InitWcDunBuff = function(self, wcBuffData, longPressFunc, pressUpFunc)
...
UINDungeonBuffItem.__OnSkillLongPress = function(self)
  -- function num : 0_4 , upvalues : OnPressScale
