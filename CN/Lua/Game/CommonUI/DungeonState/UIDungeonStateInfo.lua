...
UIDungeonStateInfo._InitChipListSeq = function(self)
  -- function num : 0_33
  self.__tweenChipListPop = self:__ChipListPop()
  self.__tweenChipListPush = self:__ChipListPush()
end

UIDungeonStateInfo.__ChipListPop = function(self, seq)
  -- function num : 0_34 , upvalues : CS_DOTween, _ENV, VAType
  if not seq then
...
)):Append((((self.ui).top_info).transform):DOLocalMove((Vector2.New)(localPos.x, localPos.y + 160), 0))):Append((((self.ui).top_info).transform):DOLocalMove((Vector2.New)(localPos.x, localPos.y), 0.5))):SetAutoKill(false)):SetUpdate(true)):Pause()):SetLink((self.ui).top_info)
  seq.onComplete = function()
    -- function num : 0_34_1 , upvalues : self, VAType
...
UIDungeonStateInfo.__ChipListPush = function(self, seq)
  -- function num : 0_35 , upvalues : CS_DOTween, _ENV, VAType
  if not seq then
    seq = CS_DOTween:Sequence()
  end
  local localPos = (((self.ui).top_info).transform).localPosition
...
)):Append((((self.ui).top_info).transform):DOLocalMove((Vector2.New)(localPos.x, localPos.y), 0))):Append((((self.ui).top_info).transform):DOLocalMove((Vector2.New)(localPos.x, localPos.y + 160), 0.5))):SetAutoKill(false)):SetUpdate(true)):Pause()):SetLink((self.ui).top_info)
  seq.onComplete = function()
    -- function num : 0_35_1 , upvalues : self, VAType
...
UIDungeonStateInfo.PlayPopChipList = function(self)
  -- function num : 0_36
...
UIDungeonStateInfo.PlayPushChipList = function(self)
  -- function num : 0_37
