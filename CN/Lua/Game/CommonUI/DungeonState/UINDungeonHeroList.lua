...
UINDungeonHeroList.OnHeroCoordChanged = function(self, entity)
...
UINDungeonHeroList.TowerPlacementChange = function(self, dataId, isOn)
  -- function num : 0_3 , upvalues : _ENV
  for _,Item in ipairs((self.itemPool).listItem) do
    if (Item.dynHeroData).dataId == dataId then
      if not isOn or not (self.ui).tran_main then
        do
          (Item.transform):SetParent((self.ui).tran_sub)
          ;
