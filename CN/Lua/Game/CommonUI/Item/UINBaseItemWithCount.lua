...
UINBaseItemWithCount.InitItemWithCount = function(self, itemCfg, count, clickEvent, wareHouseNum, clickExtrEvent, isHideLoopFx)
...
UINBaseItemWithCount.ShowLimtTimeDetail = function(self, outTime)
  -- function num : 0_2
...
UINBaseItemWithCount.BindAthItemUid = function(self, uid)
  -- function num : 0_5
  (self.baseItem):BindAthItemUid(uid)
end

UINBaseItemWithCount.BindClickCustomArg = function(self, arg)
  -- function num : 0_6
  (self.baseItem):BindClickCustomArg(arg)
end

UINBaseItemWithCount.BindBaseItemResloader = function(self, resloader)
  -- function num : 0_7
...
UINBaseItemWithCount.CloseQualityFx = function(self)
  -- function num : 0_15
  (self.baseItem):CloseQualityFx()
end

UINBaseItemWithCount.SetItemRecycyleTag = function(self, bool)
  -- function num : 0_16
