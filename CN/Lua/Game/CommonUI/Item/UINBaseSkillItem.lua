...
UINBaseSkillItem.__SetUnlockUI = function(self, active)
  -- function num : 0_6 , upvalues : _ENV, HeroSkillUpgradeEnum
  ...
  do
    if (self.ui).Img_SpecWeaponLine ~= nil then
      ...
      ;
      ((self.ui).Img_SpecWeaponLine):SetActive(skillSourceType == (HeroSkillUpgradeEnum.SkillAdaptation).SpecWeapon)
    end
    -- DECOMPILER ERROR: 2 unprocessed JMP targets
  end
end

UINBaseSkillItem.SetBanSkillActive = function(self, active)
  -- function num : 0_7
