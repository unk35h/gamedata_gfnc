...
UIFactory.CloseOrderNodesSafe = function(self)
  -- function num : 0_6
  if self.lastSelectRoomIndex ~= nil then
    self:_CloseOrderNodes()
  end
...
UIFactory._CloseOrderNodes = function(self)
...
UIFactory.OnClickProductDetial = function(self)
  -- function num : 0_14 , upvalues : _ENV, cs_MessageCommon, JumpManager, UINBuildLogicLvPreview, UINOasisBuildDetail
  if ((PlayerDataCenter.AllBuildingData).unbuilt)[eBuildingId.OasisFactory] ~= nil then
    ...
    -- function num : 0_14_0 , upvalues : JumpManager
...
, nil)
    ...
    -- function num : 0_14_1 , upvalues : cs_MessageCommon, _ENV, factoryBuildingData, self
    ...
    (NetworkManager:GetNetwork(NetworkTypeID.Building)):SendBuildingUpgrade(buildingData.id, function()
      -- function num : 0_14_1_0 , upvalues : factoryBuildingData, self
...
UIFactory.OnClickWarehouse = function(self)
  -- function num : 0_16 , upvalues : JumpManager, eWareHouseType
...
UIFactory.OnClickFactoryGetAll = function(self)
  -- function num : 0_19
  (self.factoryController):FactoryReqQuickPickAll()
end

UIFactory.OnClickQuickTimeProduct = function(self)
  -- function num : 0_20
