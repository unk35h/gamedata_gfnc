...
UINFactoryOrderNode.OnClickAdd = function(self)
  -- function num : 0_9 , upvalues : _ENV, FactoryEnum, cs_MessageCommon
...
UINFactoryOrderNode.OnProduceOver = function(self)
  -- function num : 0_27 , upvalues : _ENV, CommonRewardData
  UIManager:ShowWindowAsync(UIWindowTypeID.CommonReward, function(window)
    -- function num : 0_27_0 , upvalues : CommonRewardData, self
    if window == nil then
      return 
    end
