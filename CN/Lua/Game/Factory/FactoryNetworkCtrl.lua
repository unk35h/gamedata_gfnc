...
FactoryNetworkCtrl.CS_FACTORY_OneKeyCollect = function(self, callback)
...
FactoryNetworkCtrl.SC_FACTORY_OneKeyCollect = function(self, msg)
...
FactoryNetworkCtrl.CS_FACTORY_MultProduct = function(self, orders, callback)
...
FactoryNetworkCtrl.SC_FACTORY_MultProduct = function(self, msg)
