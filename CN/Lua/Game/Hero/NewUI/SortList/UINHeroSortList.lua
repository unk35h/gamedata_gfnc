...
UINHeroSortList.InitHeroSortList = function(self, resloader, customSelectHero, onItemClick, ableNoSelect, ableSelectSame, isShowSelected, autoSelect, specialRuleGenerator, showLockedHeros, alwaysShowCouldMergeHero)
...
UINHeroSortList.AddModifySortAndFilterFunc = function(self, callback)
  -- function num : 0_3
  if self.__ then
  end
end

UINHeroSortList.RefreshHeroSortList = function(self, funcSift, funcSort, flag, isRefreshCells)
  -- function num : 0_4 , upvalues : HeroListStateEnum, _ENV
  ...
  do return self.curHeroList end
...
UINHeroSortList.SetAllFavorHero = function(self)
...
UINHeroSortList.__LoadHeroItemList = function(self, showLockedHeros, alwaysShowCouldMergeHero)
  -- function num : 0_9 , upvalues : _ENV, SpecificHeroDataRuler, SpecialRuleGenerator
  self.originHeroDic = {}
  self.selectHero = nil
  local showHeroDic = {}
...
UINHeroSortList.__OnUpdateHeroEvent = function(self, heroList)
  ...
  local addNewHero = function(self, heroId)
    -- function num : 0_13_0 , upvalues : _ENV, have2RefrshWholeList
    local heroData = nil
    if self.specificHeroDataRuler ~= nil then
  ...
  local updateItem = function(self, heroId)
    -- function num : 0_13_1 , upvalues : _ENV, have2RefrshWholeList
    local heroItem = self:__GetHeroItemById(heroId)
    if heroItem ~= nil then
...
UINHeroSortList.__OnInstantiateItem = function(self, go)
  -- function num : 0_16 , upvalues : UINHeroCardItem
  local heroItem = nil
...
UINHeroSortList.OnTalentChange = function(self, heroId)
