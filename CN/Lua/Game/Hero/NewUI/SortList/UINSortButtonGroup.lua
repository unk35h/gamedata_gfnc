...
UINSortButtonGroup.InitSortButtonGroup = function(self, SortMannerDefine, itemClickAction, fid, assignSortTypeDic)
  -- function num : 0_1 , upvalues : HeroSortEnum, _ENV, UINSortButtonItem
  self.fid = fid
