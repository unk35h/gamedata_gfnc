...
UIHeroState.RefreshUnlockHeroInfo = function(self)
...
UIHeroState.LoadSkin = function(self)
  -- function num : 0_9 , upvalues : cs_ResLoader, _ENV, HeroCubismInteration
  ...
  if ((CS.ResManager).Instance):ContainsAsset(resPath) and showLive2d and not isLocked then
    ...
    -- function num : 0_9_0 , upvalues : self, _ENV, HeroCubismInteration
...
UIHeroState.UpdateLevel = function(self)
  -- function num : 0_18 , upvalues : _ENV, UIHeroUtil
...
UIHeroState.RefreshSpecWeaponState = function(self)
  -- function num : 0_20 , upvalues : _ENV
  ((self.ui).blueDot_Arma):SetActive(false)
  local unlock = (PlayerDataCenter.allSpecWeaponData):IsUnlockSpecWeaponSystem()
  if unlock then
    unlock = (PlayerDataCenter.allSpecWeaponData):ContainHeroSpecWeapon((self.heroData).dataId)
  end
  ;
  ...
  if unlock then
    ...
    ;
    (((self.ui).tex_Arma).gameObject):SetActive(step > 0)
    ;
    (((self.ui).obj_ArmaLvbg).gameObject):SetActive(step > 0)
    -- DECOMPILER ERROR at PC87: Confused about usage of register: R5 in 'UnsetPending'

    ;
    ((self.ui).tex_Arma).text = "LV." .. tostring(weaponData:GetSpecWeaponCurLevel())
    ...
    local isShowBlue = (weaponData:GetSpecWeaponCurLevel() == 0 and weaponData:IsSpecWeaponCouldUprage())
    if isShowBlue then
      isShowBlue = not (PersistentManager:GetDataModel((PersistentConfig.ePackage).UserData)):GetSpeacWeaponLooked(weaponId)
    end
    ;
...
UIHeroState.OnClickLimitUp = function(self)
  ...
  do
    ...
    window:SetHeroPotentialCloseEvent(function()
      -- function num : 0_21_0_0 , upvalues : parWin
      parWin:AddAllTouch()
    end
)
...
UIHeroState._RefreshQuickLvUp = function(self)
  ...
  if (self.heroData):IsReachLevelLimit() then
    ...
    if not FunctionUnlockMgr:ValidateUnlock(proto_csmsg_SystemFunctionID.SystemFunctionID_Potential) or not (self.heroData):AblePotential() or unableUp then
...
UIHeroState.OnPressQuickLvUp = function(self)
  -- function num : 0_26 , upvalues : _ENV, cs_MessageCommon, UIHeroUtil
  if not self:__CanClick() then
    return 
  end
...
UIHeroState._OpenUseExpPacket = function(self)
  ...
  if not ((ConfigData.item).fixedPacketMappingDic)[ConstGlobalItem.HeroExp] then
    ...
    -- function num : 0_28_1 , upvalues : _ENV, selectItemId
    if window == nil then
      return 
    end
...
UIHeroState.OnClickFriendship = function(self)
  ...
  UIManager:ShowWindowAsync(UIWindowTypeID.FriendShip, function(windows)
    ...
    windows:InitFriendshipSkillUpgrade(self.heroData, self.resloader, function()
      -- function num : 0_31_0_0 , upvalues : self, _ENV
      self:AddAllTouch()
      self:UpdateEfficiency()
      self:UpdateBlueDot()
...
UIHeroState.OnClickSillUpgrade = function(self)
  ...
  UIManager:ShowWindowAsync(UIWindowTypeID.HeroSkillUpgrade, function(windows)
    ...
    windows.closeEvent = BindCallback(self, function()
      -- function num : 0_32_0_0 , upvalues : self
      self:UpdateBlueDot()
      self:UpdateSkill()
      self:UpdateEfficiency()
    end
...
UIHeroState.OnClickSkin = function(self)
  -- function num : 0_34 , upvalues : ShopUtil
...
UIHeroState.ReqShopDetailLoop = function(self, index, idList)
  ...
  shopCtr:GetShopData(shopId, function(shopData)
    -- function num : 0_35_0 , upvalues : index, idList, self
    index = index + 1
...
UIHeroState.OpenHeroInformation = function(self, openCallback)
  -- function num : 0_39 , upvalues : _ENV
  UIManager:ShowWindowAsync(UIWindowTypeID.HeroInfomation, function(window)
    -- function num : 0_39_0 , upvalues : self, _ENV, openCallback
    if window ~= nil then
      self:RemoveAllTouch()
      window:InitHeroInformation(self.heroData, function()
      -- function num : 0_39_0_0 , upvalues : self, _ENV
      self:AddAllTouch()
      self:UpdateBlueDot()
      local win = UIManager:GetWindow(UIWindowTypeID.HeroState)
      if win ~= nil and not win.active then
...
UIHeroState.OnClickSpecWeapon = function(self)
  ...
  UIManager:ShowWindowAsync(UIWindowTypeID.SpecWeapon, function(win)
    -- function num : 0_40_0 , upvalues : weaponData, self, _ENV
    if win == nil then
      return 
    end
    win:InitUISpecWeapon(weaponData, self.heroData, function()
      -- function num : 0_40_0_0 , upvalues : _ENV
      local win = UIManager:GetWindow(UIWindowTypeID.HeroState)
      if win ~= nil and not win.active then
        win:UpdateSkill()
        win:Show()
...
UIHeroState.UpdateHeroShadow = function(self)
  -- function num : 0_46 , upvalues : _ENV, cs_Shadow, cs_DOTween
...
, function(x)
    -- function num : 0_46_1 , upvalues : self
...
UIHeroState.UpdateHeroAttri = function(self)
  -- function num : 0_48 , upvalues : UIAttrUtil
  local attrDataList = nil
  local attrOutLineWindow = self.attrOutLineWindow
  if attrOutLineWindow == nil then
    attrOutLineWindow = (UIAttrUtil.ShowAttrOutLineWindow)(self.heroData, (self.ui).logicPreviewNode)
...
UIHeroState.OnSpecWeaponChange = function(self)
  -- function num : 0_52
  self:RefreshSpecWeaponState()
  self:UpdateEfficiency()
  self:UpdateHeroAttri()
...
UIHeroState.RefreshHeroFixedInfo = function(self)
  ...
  (self.resloader):LoadABAssetAsync(PathConsts:GetCampPicPath(campIcon), function(texture)
    -- function num : 0_53_0 , upvalues : _ENV, self
...
UIHeroState.StartTouch = function(self, go, eventData)
  -- function num : 0_54 , upvalues : _ENV, CS_coroutine, CS_Screen
...
UIHeroState.ReturnBack = function(self)
  -- function num : 0_60 , upvalues : CS_coroutine, _ENV
  ...
  self.backCoroutine = (CS_coroutine.start)(function()
    -- function num : 0_60_0 , upvalues : _ENV, totalCostTime, updateCostTime, self, orgAlpha1, orgAlpha2, orgPos1, orgPos2
...
UIHeroState.ChangeHero = function(self)
  -- function num : 0_62 , upvalues : _ENV, CS_coroutine
  self.isAutoMoving = true
  ...
  self.chageCoroutine = (CS_coroutine.start)(function()
    -- function num : 0_62_0 , upvalues : _ENV, fadeTotalCostTime, fadeUpdateCostTime, self, orgAlpha1, orgAlpha2, newTotalCostTime, newUpdateCostTime, orgPos1, orgPos2
...
UIHeroState.ChangeHeroData = function(self, flag, shiftFunc)
...
UIHeroState.ChangeHeroByIndex = function(self, index, shiftFunc)
...
UIHeroState.SwitchHeroState = function(self, flag, shiftFunc)
  -- function num : 0_65
  self:ChangeHeroData(-flag, shiftFunc)
...
UIHeroState.OnShow = function(self)
  -- function num : 0_66 , upvalues : base, _ENV
  (base.OnShow)(self)
...
UIHeroState.Return = function(self)
  -- function num : 0_68 , upvalues : JumpManager
...
UIHeroState.__HideParent = function(self)
  -- function num : 0_70 , upvalues : _ENV
  TimerManager:StartTimer(1, function()
    -- function num : 0_70_0 , upvalues : _ENV
    local parWin = UIManager:GetWindow(UIWindowTypeID.HeroState)
    if parWin ~= nil then
      parWin:Hide()
    end
...
UIHeroState.__OnClickFavorBtn = function(self)
  -- function num : 0_71 , upvalues : _ENV, cs_MessageCommon
...
UIHeroState.RefreshFavorHero = function(self)
...
UIHeroState.Delete = function(self)
  -- function num : 0_73 , upvalues : _ENV, HeroCubismInteration, base
  do
...
UIHeroState.OnDelete = function(self)
  -- function num : 0_74 , upvalues : CS_coroutine, _ENV, base
