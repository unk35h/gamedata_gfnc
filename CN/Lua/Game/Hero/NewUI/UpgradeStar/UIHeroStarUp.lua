...
UIHeroStarUp.InitHeroStarUp = function(self, resloader, hideCallBack, switchHeroFunc, notSetBackFunc)
...
UIHeroStarUp.OnClickBack = function(self)
  -- function num : 0_9 , upvalues : _ENV, waitRecorverNUM
...
UIHeroStarUp.GenCoverJumpReturnCallback = function(self)
  -- function num : 0_17 , upvalues : _ENV, waitRecorverNUM
  if self.bigImgResloader ~= nil then
    (self.bigImgResloader):Put2Pool()
  ...
  return function()
    -- function num : 0_17_0 , upvalues : self, _ENV, dataTable, waitRecorverNUM
    self.resloader = nil
...
UIHeroStarUp.OnCloseTween = function(self)
