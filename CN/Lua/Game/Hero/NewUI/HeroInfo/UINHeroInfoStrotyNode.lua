...
UINHeroInfoStrotyNode.UnlockLockedItem = function(self, storyData)
  -- function num : 0_4 , upvalues : _ENV, eHeroInfoenum, CommonRewardData
  ...
  (NetworkManager:GetNetwork(NetworkTypeID.Hero)):CS_HERO_Record((self.heroData).dataId, (eHeroInfoenum.recordType).archives, (storyData.cfg).friendship_level, function()
    -- function num : 0_4_0 , upvalues : self, storyData, _ENV, eHeroInfoenum, CommonRewardData
    ...
    if storyData.cfg ~= nil and (storyData.cfg).awardIds ~= nil then
      ...
      -- function num : 0_4_0_0 , upvalues : CommonRewardData, storyData, _ENV
      if window == nil then
        return 
      end
      local CRData = ((CommonRewardData.CreateCRDataUseList)((storyData.cfg).awardIds, (storyData.cfg).awardNums)):SetCRHeroSnapshoot(PlayerDataCenter:GetHeroIdSnapShoot())
