...
UIFightMain.OnInit = function(self)
  -- function num : 0_0 , upvalues : cs_ResLoader, DormFightConst, _ENV, UIFightNamePlate, UIFightVitalityBar
...
UIFightMain.OnMaskBeginDrag = function(self, go, eventData)
  -- function num : 0_23
  self._lastDragPosition = eventData.position
end

UIFightMain.OnMaskDragging = function(self, go, eventData)
...
UIFightMain.OnMaskEndDrag = function(self, go, eventData)
  -- function num : 0_25
  self._lastDragPosition = nil
end

UIFightMain.SetDragListener = function(self, listener)
  -- function num : 0_26
