...
DormFightRuleCtrl.StopCountdown = function(self)
  -- function num : 0_3
  self.isPause = true
end

DormFightRuleCtrl.RecoveryCountdown = function(self)
  -- function num : 0_4
  self.isPause = false
end
...
DormFightRuleCtrl.OnFightTrueStart = function(self)
...
DormFightRuleCtrl.OnSomeoneLossHp = function(self, comp)
  -- function num : 0_11 , upvalues : DormFightConst
