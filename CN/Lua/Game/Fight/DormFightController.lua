...
DormFightController.OnInit = function(self)
  -- function num : 0_0 , upvalues : DormFightSceneCtrl, DormFightCharacterCtrl, DormFightSceneUiCtrl, DormFightRuleCtrl, DormFightCameraCtrl
  self.ctrls = {}
...
DormFightController.GetCameraCtrl = function(self)
  -- function num : 0_7
  return self._cameraCtrl
end

DormFightController.StartFight = function(self)
  -- function num : 0_8 , upvalues : DormFightConst, _ENV
...
DormFightController.DebugRestartSingleMode = function(self)
  -- function num : 0_11 , upvalues : DormFightConst, _ENV
  self:StopUpdate()
  self:OnChildCtrlEndFight()
  ;
  (self._characterCtrl):DestroyAllCharacter()
...
DormFightController.DeBugRule = function(self)
  -- function num : 0_17
...
DormFightController.OnChildCtrlTrueStartFight = function(self)
