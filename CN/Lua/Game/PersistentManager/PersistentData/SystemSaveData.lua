...
SystemSaveData.__InitDefaultMiscSave = function(self)
  -- function num : 0_4
...
SystemSaveData.SetAudioDataGlobalMute = function(self, value)
  -- function num : 0_8
...
SystemSaveData._InitDefaultDescSet = function(self, data)
  ...
  if (self.gameSet).multSet == nil or (table.count)((self.gameSet).multSet) < 1 then
    if not (self.gameSet).multSet then
      (self.gameSet).multSet = {}
...
SystemSaveData.GetDescribeSettingOld = function(self)
  -- function num : 0_22
  return (self.gameSet).describes
end

SystemSaveData.GetMultSettingIndex = function(self, eDescTypeId)
  -- function num : 0_23
  return ((self.gameSet).multSet)[eDescTypeId]
end

SystemSaveData.SetMultSettingIndex = function(self, eDescTypeId, index)
  -- function num : 0_24
...
SystemSaveData.GetIsTodayPlayedUltSkillAnimi = function(self, skillId)
  -- function num : 0_25
  return ((self.gameSet).isTodayPlayerUltSkillAnimi)[skillId] or false
end

SystemSaveData.SetIsTodayPlayedUltSkillAnimi = function(self, skillId, bool)
  -- function num : 0_26
...
SystemSaveData.CleanIsTodayPlayedUltSkillAnimi = function(self)
  -- function num : 0_27
...
SystemSaveData.GetActEntranceReadOneValue = function(self)
  -- function num : 0_28
  return (self.misc).actEntranceReadOne
end

SystemSaveData.SetActEntranceReadOneValue = function(self, value)
  -- function num : 0_29
  -- DECOMPILER ERROR at PC8: Confused about usage of register: R2 in 'UnsetPending'

  if not value then
    (self.misc).actEntranceReadOne = (self.misc).actEntranceReadOne == value or false
    self:SetPstDataDirty()
  end
end

SystemSaveData.GetGameSettingIsHaveReddot = function(self)
  -- function num : 0_30
  return (self.gameSet).singleReddot
end

SystemSaveData.SetGameSettingIsHaveReddot = function(self, value)
  -- function num : 0_31
  -- DECOMPILER ERROR at PC5: Confused about usage of register: R2 in 'UnsetPending'
