...
LuaGridBase.OnGridReachTimeLimit = function(self, role, isCorved)
  -- function num : 0_8
end

LuaGridBase.OnGridBeCorvered = function(self, role)
  -- function num : 0_9
end

LuaGridBase.OnGridUncorver = function(self, role)
  -- function num : 0_10
end
