...
bs_105702.config = {buffId = 105702, effectid = 105705, effectid_1 = 105704, actionId = 1002, action_speed = 1, actionId_start_time = 25, skilltime = 46}
bs_105702.ctor = function(self)
  -- function num : 0_0
end

bs_105702.InitSkill = function(self, isMidwaySkill)
  -- function num : 0_1 , upvalues : base
  (base.InitSkill)(self, isMidwaySkill)
end

bs_105702.PlaySkill = function(self, data)
...
bs_105702.OnAttackTrigger = function(self, data)
...
bs_105702.OnCasterDie = function(self)
