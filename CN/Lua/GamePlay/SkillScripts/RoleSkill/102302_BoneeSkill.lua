...
bs_102302.config = {effectId_Line = 102304, effectId_LineEnd = 102305, initHpKey = "102302_InitHp", action1 = 1002, buffId_willowpic = 102901, buffId_Defup = 102301, actionId = 1002, action_speed = 1, skill_time = 15, start_time = 14, selectId = 24, selectRange = 10, audioId1 = 239, audioId2 = 240}
