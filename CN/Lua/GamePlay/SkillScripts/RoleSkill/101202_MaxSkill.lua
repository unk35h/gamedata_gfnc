...
bs_101202.config = {effectId_loop = 101207, effectId_line = 101208, effectId_weapon = 101210, effectId_start = 101206, effectId_swim = 101215, buffId_66 = 3006, actionId = 1002, action_speed = 1, skill_time = 25, start_time = 20, 
HurtConfig = {hit_formula = 0, basehurt_formula = 3010, crit_formula = 0, crithur_ratio = 0, returndamage_formula = 0}
}
bs_101202.ctor = function(self)
  -- function num : 0_0
end

bs_101202.InitSkill = function(self, isMidwaySkill)
  -- function num : 0_1 , upvalues : base
  (base.InitSkill)(self, isMidwaySkill)
end

bs_101202.PlaySkill = function(self, data)
...
bs_101202.OnActionCallBack = function(self, target, grid)
...
bs_101202.RealPlaySkill = function(self, ballSkillData, skillEmission)
...
bs_101202.PlaySkillEnd = function(self, ballSkillData, skillEmission)
  -- function num : 0_5
  self:KillEffectBall(ballSkillData.effectBall)
...
bs_101202.KillEffectBall = function(self, effectBall)
  -- function num : 0_6
...
bs_101202.OnCollision = function(self, ballSkillData, collider, index, entity)
...
bs_101202.OnRemoveArrive = function(self, ballSkillData, collider, entity)
...
bs_101202.OnEmissionArrive = function(self, skillEmission)
...
bs_101202.OnCasterDie = function(self)
