...
local bs_101604 = class("bs_101604", LuaSkillBase)
local base = LuaSkillBase
bs_101604.config = {buffId_color = 101601, effectId_big = 101603, buffId_speed = 101603}
bs_101604.ctor = function(self)
  -- function num : 0_0
end

bs_101604.InitSkill = function(self, isMidwaySkill)
  -- function num : 0_1 , upvalues : base, _ENV
  (base.InitSkill)(self, isMidwaySkill)
  self:AddAfterHurtTrigger("bs_101604_3", 1, self.OnAfterHurt)
  self:AddBuffDieTrigger("bs_101604_5", 90, self.OnBuffDie, nil, nil, (self.config).buffId_color)
  self.effect = {}
  self:AddSelfTrigger(eSkillTriggerType.AfterPlaySkill, "bs_101604_4", 1, self.OnAfterPlaySkill)
end

bs_101604.OnAfterHurt = function(self, sender, target, skill, hurt, isMiss, isCrit, hurtType, isTriggerSet)
...
bs_101604.OnAfterPlaySkill = function(self, skill, role)
...
bs_101604.OnBuffDie = function(self, buff, target, removeType)
...
bs_101604.OnCollisionEnter = function(self, collider, index, entity)
...
bs_101604.OnCasterDie = function(self)
  -- function num : 0_6 , upvalues : base
  (base.OnCasterDie)(self)
end

bs_101604.LuaDispose = function(self)
