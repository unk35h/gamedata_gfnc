...
bs_101602.config = {buffId_Paint = 101601, buffId_170 = 170, superBuffId = 271, effectId = 101604, 
...
bs_101602.ctor = function(self)
  -- function num : 0_0
end

bs_101602.InitSkill = function(self, isMidwaySkill)
...
bs_101602.PlaySkill = function(self, data)
  -- function num : 0_2
...
bs_101602.realRlaySkill = function(self, realTargetRole)
...
bs_101602.OnAttackTrigger = function(self, target)
  -- function num : 0_4 , upvalues : _ENV
  LuaSkillCtrl:CallEffect(target, (self.config).effectId, self, self.SkillEventFunc)
end

bs_101602.CheckAndGetTargetRole = function(self)
...
bs_101602.AnalysisSelectRoles = function(self, realTargetRole, roles)
...
bs_101602.PhaseMove = function(self, realTargetRole)
...
bs_101602.SkillEventFunc = function(self, effect, eventId, target)
...
bs_101602.OnCasterDie = function(self)
