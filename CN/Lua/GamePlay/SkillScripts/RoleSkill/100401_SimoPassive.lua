...
bs_100401.config = {buffId_Crit = 100403, buffId_Hiding = 3004, buffId_Acc = 100401, buffId_Acc_time = 30, 
...
bs_100401.OnHurtResultEnd = function(self, skill, targetRole, hurtValue)
...
bs_100401.OnHurtResultStart = function(self, skill, context)
