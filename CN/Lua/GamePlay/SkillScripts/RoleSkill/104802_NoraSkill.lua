...
bs_104802.config = {buffId_debuff1 = 104806, buffId_debuff2 = 104805, buffId_debuff3 = 104807, buffId_stunEnemy = 104809, effectId_debuff1 = 104809, effectId_debuff2 = 104810, effectId_debuff3 = 104811, effectId_stunStart = 104820, buffId_170 = 170, buffId_stun = 66, selectId = 104801, selectrange = 10, start_time = 12, actionId = 1008, action_speed = 1, audioId_start = 104810, audioId_stop = 104814, effectId_Trail = 104808, effectId_skillStart = 104807, 
HurtConfig = {hit_formula = 0, basehurt_formula = 3000, crit_formula = 0, hurt_type = -1}
}
bs_104802.ctor = function(self)
  -- function num : 0_0
end

bs_104802.InitSkill = function(self, isMidwaySkill)
...
bs_104802.PlaySkill = function(self, data)
...
bs_104802.OnAttackTrigger = function(self)
...
bs_104802.AttackEnemy = function(self, target)
...
bs_104802.SkillEventFunc = function(self, effect, eventId, target)
...
bs_104802.AddBuffAndHurt = function(self, buffTarget)
...
bs_104802.CheckMiss = function(self, target)
...
bs_104802.OnBreakSkill = function(self, role)
...
bs_104802.OnCasterDie = function(self)
...
bs_104802.OnDispose = function(self)
