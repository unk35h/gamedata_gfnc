...
bs_101901.PlaySkill = function(self)
  -- function num : 0_3 , upvalues : _ENV, SyncAttrList
...
bs_101901.AccTimer = function(self)
  -- function num : 0_5
  if (self.config).weaponLv >= 1 then
...
bs_101901.OnSyncAttrFromHost = function(self)
  -- function num : 0_6 , upvalues : _ENV, SyncAttrList
