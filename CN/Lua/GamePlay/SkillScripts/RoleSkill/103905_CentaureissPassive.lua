...
bs_103905.config = {buffId_back = 151, buffId_dizzy = 66, effectId_high = 103904, audioId1 = 103901, 
...
, HurtConfig = 2, effectId_hit = 103907, buff_resistance = 103903}
bs_103905.ctor = function(self)
  -- function num : 0_0
end

bs_103905.InitSkill = function(self, isMidwaySkill)
...
bs_103905.OnAfterHurt = function(self, sender, target, skill, hurt, isMiss, isCrit, hurtType, isTriggerSet)
...
bs_103905.OnAfterAddBuff = function(self, buff, target)
...
bs_103905.OnCasterDie = function(self)
