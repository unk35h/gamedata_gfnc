...
bs_100402.config = {effectId_trail = 100403, effectId_trail_skin = 100407, 
...
bs_100402.RealPlaySkill = function(self, targetRole)
  ...
  LuaSkillCtrl:StartTimer(self, 3, function()
    -- function num : 0_4_0 , upvalues : _ENV, self, targetRole
    if LuaSkillCtrl:GetCasterSkinId(self.caster) == 0 or LuaSkillCtrl:GetCasterSkinId(self.caster) == 300401 or LuaSkillCtrl:GetCasterSkinId(self.caster) == 300402 then
