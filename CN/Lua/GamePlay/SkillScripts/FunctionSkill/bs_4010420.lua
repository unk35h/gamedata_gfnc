...
bs_4010420.ctor = function(self)
  -- function num : 0_0
end

bs_4010420.InitSkill = function(self, isMidwaySkill)
  -- function num : 0_1 , upvalues : base
  (base.InitSkill)(self, isMidwaySkill)
  self:AddAfterHurtTrigger("bs_4010420", 1, self.OnAfterHurt, self.caster, nil, nil, nil, nil, nil, nil, nil, false)
end

bs_4010420.OnAfterHurt = function(self, sender, target, skill, hurt, isMiss, isCrit, hurtType, isTriggerSet)
...
bs_4010420.OnCasterDie = function(self)
