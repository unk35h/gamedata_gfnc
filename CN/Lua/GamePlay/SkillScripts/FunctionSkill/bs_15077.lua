...
bs_15077.config = {featureType = eBuffFeatureType.Stun}
bs_15077.ctor = function(self)
  -- function num : 0_0
end

bs_15077.InitSkill = function(self, isMidwaySkill)
  -- function num : 0_1 , upvalues : base
  (base.InitSkill)(self, isMidwaySkill)
  self:AddSetHurtTrigger("bs_15077_2", 1, self.OnSetHurt, self.caster)
end

bs_15077.OnSetHurt = function(self, context)
...
bs_15077.OnCasterDie = function(self)
