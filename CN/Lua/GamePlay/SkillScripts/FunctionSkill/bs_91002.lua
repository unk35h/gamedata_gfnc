...
bs_91002.ctor = function(self)
  -- function num : 0_0
end

bs_91002.InitSkill = function(self, isMidwaySkill)
  -- function num : 0_1 , upvalues : base
  (base.InitSkill)(self, isMidwaySkill)
  self:AddAfterHurtTrigger("bs_91002_3", 1, self.OnAfterHurt, nil, self.caster)
end

bs_91002.OnAfterHurt = function(self, sender, target, skill, hurt, isMiss, isCrit, hurtType, isTriggerSet)
...
bs_91002.OnCasterDie = function(self)
