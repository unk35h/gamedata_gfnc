...
bs_4010407.ctor = function(self)
  -- function num : 0_0
end

bs_4010407.InitSkill = function(self, isMidwaySkill)
  -- function num : 0_1 , upvalues : base, _ENV
  (base.InitSkill)(self, isMidwaySkill)
  self:AddSelfTrigger(eSkillTriggerType.AfterBattleStart, "bs_4010407_1", 1, self.OnAfterBattleStart)
end

bs_4010407.OnAfterBattleStart = function(self)
...
bs_4010407.OnCasterDie = function(self)
