...
bs_4010413.config = {}
bs_4010413.ctor = function(self)
  -- function num : 0_0
end

bs_4010413.InitSkill = function(self, isMidwaySkill)
...
bs_4010413.OnAfterHurt = function(self, sender, target, skill, hurt, isMiss, isCrit, hurtType, isTriggerSet)
...
bs_4010413.OnCasterDie = function(self)
