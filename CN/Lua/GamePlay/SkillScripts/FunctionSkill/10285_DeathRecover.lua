...
bs_10285.config = {effectId = 10865, buffId_live = 3009, nanaka_buffId = 102603, 
...
bs_10285.OnSetDeadHurt = function(self, context)
  ...
  if context.target == self.caster and (context.target).hp <= context.hurt and ((self.caster).recordTable).time_limit_10285 > 0 and (context.target):GetBuffTier((self.config).nanaka_buffId) <= 0 then
    ...
    -- function num : 0_2_0 , upvalues : context, self, _ENV
