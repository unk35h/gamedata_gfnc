...
bs_10018.config = {effectId = 1047, buffId = 1140, buffTier = 1, conditionCheck = "$1>=max(GetSkillArg(1),50)/1000*@maxHp", damageFormula = "max(GetSkillArg(1),50)/1000*@maxHp", FormulaId = 1001801}
