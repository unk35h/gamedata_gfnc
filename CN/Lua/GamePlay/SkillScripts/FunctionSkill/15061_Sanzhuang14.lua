...
bs_15061.ctor = function(self)
  -- function num : 0_0
end

bs_15061.InitSkill = function(self, isMidwaySkill)
...
bs_15061.OnAfterHurt = function(self, sender, target, skill, hurt, isMiss, isCrit, hurtType, isTriggerSet)
...
bs_15061.OnCasterDie = function(self)
