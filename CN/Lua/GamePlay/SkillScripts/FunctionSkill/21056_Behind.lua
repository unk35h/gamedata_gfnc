...
bs_21056.InitSkill = function(self, isMidwaySkill)
  ...
  self:AddHurtResultEndTrigger("bs_21056_16", 1, self.OnHurtResultEnd, nil, nil, eBattleRoleBelong.player)
  self:AddHurtResultStartTrigger("bs_21056_17", 1, self.OnHurtResultStart, nil, nil, eBattleRoleBelong.player)
end

bs_21056.OnHurtResultStart = function(self, skill, context)
  -- function num : 0_2 , upvalues : _ENV
  if (skill.maker).belongNum == eBattleRoleBelong.player and (skill.maker).hp < (context.target).hp then
