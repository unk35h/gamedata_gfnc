...
, effectId_start = 100611, buffId_lz1 = 100601, selectId = 9, select_range = 10, start_time = 5, buffHurt = 3011, audioIdStart = 100606, audioIdMovie = 100607, audioIdEnd = 100608, movieEndRoleActionId = 1006}
...
bs_100603.PlaySkill = function(self, data, selectTargetCoord, selectRoles)
  ...
  if selectTargetCoord ~= nil then
    ...
    for i = 0, targetlist_enemy.Count - 1 do
      ...
      if target ~= nil and target.hp > 0 and target.belongNum ~= eBattleRoleBelong.player and not target:IsUnSelect(self.caster) then
