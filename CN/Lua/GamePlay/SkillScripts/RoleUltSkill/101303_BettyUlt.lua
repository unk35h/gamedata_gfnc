...
bs_101303.ctor = function(self)
  -- function num : 0_0
end

bs_101303.InitSkill = function(self, isMidwaySkill)
  -- function num : 0_1
end

bs_101303.PlaySkill = function(self, data, selectTargetCoord, selectRoles)
...
bs_101303.CallSkillExecute = function(self, selectRoles)
  -- function num : 0_3 , upvalues : _ENV
  self:GetSelectTargetAndExecute(selectRoles, BindCallback(self, self.CallSelectExecute))
end

bs_101303.CallSelectExecute = function(self, role)
...
bs_101303.PlayUltEffect = function(self)
...
bs_101303.OnUltRoleAction = function(self)
...
bs_101303.OnSkipUltView = function(self)
  -- function num : 0_7 , upvalues : base
  (base.OnSkipUltView)(self)
end

bs_101303.OnMovieFadeOut = function(self)
  -- function num : 0_8 , upvalues : base
  (base.OnMovieFadeOut)(self)
end

bs_101303.OnCasterDie = function(self)
