...
hurt_config = {hit_formula = 0, def_formula = 9996, basehurt_formula = 10028, minhurt_formula = 9994, crit_formula = 0, crithur_ratio = 0, correct_formula = 9989, hurt_type = -1}
}
