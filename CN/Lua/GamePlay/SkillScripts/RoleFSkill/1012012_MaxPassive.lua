...
bs_1012012.config = {effectId_loop = 101204, 
...
bs_1012012.ctor = function(self)
  -- function num : 0_0
end

bs_1012012.InitSkill = function(self, isMidwaySkill)
  -- function num : 0_1 , upvalues : base
  (base.InitSkill)(self, isMidwaySkill)
  self:AddAfterHurtTrigger("bs_1012012_2", 1, self.OnAfterHurt, self.caster)
end

bs_1012012.OnAfterHurt = function(self, sender, target, skill, hurt, isMiss, isCrit, hurtType, isTriggerSet)
...
bs_1012012.OnCasterDie = function(self)
