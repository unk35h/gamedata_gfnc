...
bs_1021022.config = {effectId_start = 10272, effectId_loop = 10271, buffId_dodge = 167, buffId_attackfast = 166, buffId_lockCd = 170, audioId1 = 76, skill_time = 999, start_time = 5, actionId_start = 1008, actionId_loop = 1007, actionId_end = 1009, action_speed = 1}
bs_1021022.ctor = function(self)
  -- function num : 0_0
end

bs_1021022.InitSkill = function(self, isMidwaySkill)
...
bs_1021022.OnAfterHurt = function(self, sender, target, skill, hurt, isMiss, isCrit, hurtType, isTriggerSet)
...
bs_1021022.PlaySkill = function(self, data)
...
bs_1021022.OnAttackTrigger = function(self)
...
bs_1021022.OnBreakSkill = function(self, role)
...
bs_1021022.BeforeEndBattle = function(self)
...
bs_1021022.OnCasterDie = function(self)
...
bs_1021022.LuaDispose = function(self)
