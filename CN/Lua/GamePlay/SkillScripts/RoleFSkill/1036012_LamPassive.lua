...
local bs_1036012 = class("bs_1036012", LuaSkillBase)
local base = LuaSkillBase
bs_1036012.config = {}
bs_1036012.ctor = function(self)
  -- function num : 0_0
end

bs_1036012.InitSkill = function(self, isMidwaySkill)
  -- function num : 0_1 , upvalues : base, _ENV
  (base.InitSkill)(self, isMidwaySkill)
  self.lastSpeedOfs = 0
  self:OnCasterAttributeChange()
  self:AddTrigger(eSkillTriggerType.OnSelfAttrChanged, "bs_1036012_attrObs", 1, self.OnCasterAttributeChange)
end

bs_1036012.OnCasterAttributeChange = function(self)
...
bs_1036012.OnCasterDie = function(self)
