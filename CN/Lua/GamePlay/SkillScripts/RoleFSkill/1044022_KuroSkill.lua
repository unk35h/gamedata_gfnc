...
bs_104402.config = {start_time = 8, end_time = 35, buffId_170 = 170, actionId = 1008, actionId_end = 1009, actionId_speed = 1, effectId_Trail = 104406, effectId_Trail_Big = 104408, effectId_skillStart = 104414, effectId_Big_open = 104417, configId_trail = 3}
