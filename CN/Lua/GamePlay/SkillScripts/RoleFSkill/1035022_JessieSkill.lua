...
bs_1035022.config = {selectId = 6, buffId_resist = 148, buffId_253 = 253, effectId_skill = 10198, actionId = 1002, audioId1 = 70, skill_time = 36, 
HealConfig = {baseheal_formula = 10088}
, 
HealConfig2 = {baseheal_formula = 10048}
, audioId2 = 71}
bs_1035022.InitSkill = function(self, isMidwaySkill)
  -- function num : 0_0 , upvalues : base, _ENV
  (base.InitSkill)(self, isMidwaySkill)
  self:AddTrigger(eSkillTriggerType.BuffDie, "bs_1035022_buffDie", 1, self.OnBuffDie)
end

bs_1035022.PlaySkill = function(self, data)
...
bs_1035022.ActionCallBack = function(self, targets)
...
bs_1035022.CheckCasterAliveAndRemoveTrigger = function(self)
...
bs_1035022.OnBuffDie = function(self, buff, target, removeType)
...
bs_1035022.OnCasterDie = function(self)
