...
bs_1001022.RealPlaySkill = function(self, sender, target, healId)
...
bs_1001022.SkillEventFunc = function(self, healId, effect, eventId, target)
...
bs_1001022.CallBack = function(self, targetRole, healId)
