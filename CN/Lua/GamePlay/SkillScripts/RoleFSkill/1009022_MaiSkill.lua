...
, effectIdTornado2 = 100906, effetcIdTornadoRadius = 100, skill_time = 28, start_time = 12, actionId = 1002, action_speed = 1, effectId_start = 100905, buffId_blind = 301201, effectId_hit = 100907}
bs_1009022.ctor = function(self)
  -- function num : 0_0
end

bs_1009022.InitSkill = function(self, isMidwaySkill)
...
bs_1009022.PlaySkill = function(self, data)
...
bs_1009022.OnAttackTrigger = function(self)
...
bs_1009022.OnEnter = function(self, collider, index, entity)
...
bs_1009022.OnExite = function(self, collider, entity)
  -- function num : 0_5
end

bs_1009022.OnCollisionStay = function(self, Collider, role)
...
bs_1009022.CallHurt = function(self, effect, target)
...
bs_1009022.OnCasterDie = function(self)
  -- function num : 0_8 , upvalues : base
  (base.OnCasterDie)(self)
end

bs_1009022.LuaDispose = function(self)
