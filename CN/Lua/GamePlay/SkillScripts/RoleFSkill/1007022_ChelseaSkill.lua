...
bs_1007022.config = {skill_time = 31, start_time = 15, actionId = 1002, action_speed = 1, 
...
, buffId_Back = 3007, buffId_Stun = 3006, effectId_hit = 100705, effectId_advance = 100704}
bs_1007022.ctor = function(self)
  -- function num : 0_0
end

bs_1007022.InitSkill = function(self, isMidwaySkill)
  -- function num : 0_1 , upvalues : base
  (base.InitSkill)(self, isMidwaySkill)
end

bs_1007022.PlaySkill = function(self, data)
...
bs_1007022.OnAttackTrigger = function(self, range)
...
bs_1007022.OnCasterDie = function(self)
