...
bs_1043022.config = {buff_RangeDown = 10430501, start_time = 15, actionId = 1002, action_speed = 1, 
...
bs_1043022.ctor = function(self)
  -- function num : 0_0
end

bs_1043022.InitSkill = function(self, isMidwaySkill)
  -- function num : 0_1 , upvalues : base
  (base.InitSkill)(self, isMidwaySkill)
  self.TargetCount = 0
end

bs_1043022.PlaySkill = function(self, data)
...
bs_1043022.OnAttackTrigger = function(self, selectTarget, selectTargetPos)
...
bs_1043022.OnColliderEnter = function(self, forwardDir, selectTargetPos, collider, index, entity)
  ...
  do
    ...
    do
      if entity.intensity > 0 and (self.arglist)[3] < entity.attackRange and LuaSkillCtrl:CheckReletionWithRoleBelong(entity, self.caster, eBelongReletionType.Enemy) and (entity.recordTable).Demiurge ~= true then
...
bs_1043022.OnCasterDie = function(self)
