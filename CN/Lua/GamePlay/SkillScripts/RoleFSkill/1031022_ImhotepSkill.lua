...
bs_1031022.config = {audioId1 = 103103, audioId2 = 103104, effectId_heal = 103104, effectId_trail = 103103, 
hurt_config = {hit_formula = 0, basehurt_formula = 3010}
, 
heal_config = {baseheal_formula = 3021}
}
bs_1031022.ctor = function(self)
  -- function num : 0_0
end

bs_1031022.InitSkill = function(self, isMidwaySkill)
  -- function num : 0_1 , upvalues : base
  (base.InitSkill)(self, isMidwaySkill)
end

bs_1031022.PlaySkill = function(self, data)
...
bs_1031022.OnAttackTrigger = function(self, target)
  -- function num : 0_3 , upvalues : _ENV
  LuaSkillCtrl:CallEffect(target, (self.config).effectId_trail, self, self.SkillEventFunc)
end

bs_1031022.SkillEventFunc = function(self, effect, eventId, target)
...
bs_1031022.SkillEventFunc_heal = function(self, effect, eventId, target)
...
bs_1031022.OnCasterDie = function(self)
