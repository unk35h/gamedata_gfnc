...
, actionId = 1002, action_speed = 1, skill_time = 15, start_time = 8, effectId_skill = 100608, effectId_light1 = 100609, effectId_light2 = 100610, effectId_lz = 100307, buffId_lz1 = 10060101, buffId_lz2 = 10030101, buffId_fire = 301101, radius = 50, spd = 15}
bs_1006022.ctor = function(self)
  -- function num : 0_0
end

bs_1006022.InitSkill = function(self, isMidwaySkill)
  -- function num : 0_1
...
bs_1006022.PlaySkill = function(self, data)
...
bs_1006022.OnAttackTrigger = function(self, target, data)
...
bs_1006022.OnCollision = function(self, collider, index, entity)
...
bs_1006022.OnEmissionArrive = function(self, skillEmission)
  -- function num : 0_5 , upvalues : _ENV
  LuaSkillCtrl:CallRestartEmit(self, skillEmission, (self.config).spd, self.caster, true, true)
end

bs_1006022.OnAfterAddBuff = function(self, buff, target)
...
bs_1006022.OnBeforBuffDispel = function(self, target, context)
...
bs_1006022.OnCasterDie = function(self)
