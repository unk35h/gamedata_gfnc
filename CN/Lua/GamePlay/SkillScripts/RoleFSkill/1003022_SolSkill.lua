...
bs_1003022.config = {buffId_lz1 = 10030101, buffId_lz2 = 10060101, buffId_fire = 301101, effectId_fire = 100304, effectId_lz = 100307, effectId_firehit = 100305, 
...
bs_1003022.ctor = function(self)
  -- function num : 0_0
end

bs_1003022.InitSkill = function(self, isMidwaySkill)
...
bs_1003022.PlaySkill = function(self, data)
...
bs_1003022.OnAttackTrigger = function(self, target)
...
bs_1003022.OnAfterAddBuff = function(self, buff, target)
...
bs_1003022.OnBeforBuffDispel = function(self, target, context)
...
bs_1003022.OnCasterDie = function(self)
