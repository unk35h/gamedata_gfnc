...
bs_1014012.config = {buffId_choocolate = 101402, effectId_passive = 101404, selectId_pass = 6, select_range = -1, 
heal_config = {baseheal_formula = 3021}
}
bs_1014012.ctor = function(self)
  -- function num : 0_0
end

bs_1014012.InitSkill = function(self, isMidwaySkill)
...
bs_1014012.OnAfterBattleStart = function(self)
...
bs_1014012.OnAfterPlaySkill = function(self, skill, role)
...
bs_1014012.OnCasterDie = function(self)
