...
bs_1040022.config = {buffId_170 = 170, skill_time = 53, start_time = 22, actionId = 1002, action_speed = 1.5, effectId_big = 104002, effectId_small = 104001, buffId_1 = 104004, buffId_2 = 104005, buffId_09 = 104009, selectId_player = 34, selectId_enemy = 33, 
...
bs_1040022.ctor = function(self)
  -- function num : 0_0
end

bs_1040022.InitSkill = function(self, isMidwaySkill)
...
bs_1040022.PlaySkill = function(self, data)
...
bs_1040022.OnAttackTrigger = function(self)
...
bs_1040022.SkillEventFunc = function(self, effect, eventId, target)
...
bs_1040022.OnBreakSkill = function(self, role)
...
bs_1040022.OnCasterDie = function(self)
