...
bs_1023022.config = {effectId_Line = 102304, effectId_LineEnd = 102305, initHpKey = "102302_InitHp", action1 = 1002, buffId_willowpic = 10290101, buffId_Defup = 10230101, actionId = 1002, action_speed = 1, skill_time = 15, start_time = 14, selectId = 24, selectRange = 10, audioId1 = 239, audioId2 = 240}
bs_1023022.ctor = function(self)
  -- function num : 0_0
end

bs_1023022.InitSkill = function(self, isMidwaySkill)
...
bs_1023022.PlaySkill = function(self, data)
...
bs_1023022.OnAttackTrigger = function(self, target)
  -- function num : 0_3 , upvalues : _ENV
  LuaSkillCtrl:CallEffectWithArg(target, (self.config).effectId_LineEnd, self, false, false, self.SkillEventFunc, target)
end

bs_1023022.SkillEventFunc = function(self, target_role, effect, eventId, target)
...
bs_1023022.OnCasterDie = function(self)
