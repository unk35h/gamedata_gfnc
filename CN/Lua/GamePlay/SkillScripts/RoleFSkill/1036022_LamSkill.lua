...
local bs_1036022 = class("bs_1036022", LuaSkillBase)
local base = LuaSkillBase
bs_1036022.config = {effectId1 = 10181, effectId2 = 10183, effectIdHit1 = 10182, effectIdHit2 = 10184, 
...
bs_1036022.ctor = function(self)
  -- function num : 0_0
end

bs_1036022.InitSkill = function(self, isMidwaySkill)
  -- function num : 0_1 , upvalues : base
  (base.InitSkill)(self, isMidwaySkill)
end

bs_1036022.PlaySkill = function(self, data)
...
bs_1036022.OnAttackTrigger = function(self, target, data)
...
bs_1036022.OnCallback = function(self, num, target, data)
...
bs_1036022.OnCasterDie = function(self)
