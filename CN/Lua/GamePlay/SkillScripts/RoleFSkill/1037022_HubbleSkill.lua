...
bs_1037022.config = {effectId_start = 10329, effectId_skill = 10330, effectId_ex_skill = 10801, selectId_1 = 15, selectRange_1 = 20, selectId_2 = 19, selectRange_2 = 20, 
...
bs_1037022.ctor = function(self)
  -- function num : 0_0
end

bs_1037022.InitSkill = function(self, isMidwaySkill)
...
bs_1037022.OnAfterHurt = function(self, sender, target, skill, hurt, isMiss, isCrit, hurtType, isTriggerSet)
  -- function num : 0_2 , upvalues : _ENV
  if sender == self.caster and target == self.mainTarget and not isMiss and isTriggerSet ~= true and target.belongNum ~= (self.caster).belongNum and hurt > 0 then
...
bs_1037022.PlaySkill = function(self, data)
...
bs_1037022.OnAttackTrigger = function(self, target)
...
bs_1037022.SkillEventFunc = function(self, effect, eventId, target)
...
bs_1037022.LuaDispose = function(self)
  -- function num : 0_6 , upvalues : base
  (base.LuaDispose)(self)
  self.mainTarget = nil
end

bs_1037022.OnCasterDie = function(self)
