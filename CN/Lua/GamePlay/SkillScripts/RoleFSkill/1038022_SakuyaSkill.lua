...
bs_1038022.config = {buffId_blood = 10380101, 
aoe_config = {effect_shape = 3, aoe_select_code = 4, aoe_range = 2}
, 
hurt_config = {hit_formula = 0, basehurt_formula = 3000, crit_formula = 0}
, effectId_skill = 10389, buffId_195 = 19501, skill_time = 20, start_time = 10, actionId = 1002, action_speed = 1.5, audioId1 = 293, audio_loop = 294}
bs_1038022.ctor = function(self)
  -- function num : 0_0
end

bs_1038022.InitSkill = function(self, isMidwaySkill)
  -- function num : 0_1 , upvalues : base
  (base.InitSkill)(self, isMidwaySkill)
  self.again = false
end

bs_1038022.PlaySkill = function(self, data)
...
bs_1038022.OnAttackTrigger = function(self)
...
bs_1038022.OnCasterDie = function(self)
