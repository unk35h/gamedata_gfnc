...
bs_1010022.config = {effectId_skill = 101003, actionId = 1002, buffId_66 = 10100201, 
...
bs_1010022.InitSkill = function(self, isMidwaySkill)
  -- function num : 0_0 , upvalues : base
  (base.InitSkill)(self, isMidwaySkill)
end

bs_1010022.PlaySkill = function(self, data)
...
bs_1010022.OnActionCallBack = function(self, target, roles, roles_net)
...
bs_1010022.OnEffectTrigger = function(self, roles, roles_net, effect, eventId, target)
...
bs_1010022.OnCasterDie = function(self)
