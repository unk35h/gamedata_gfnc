...
bs_1028022.config = {effectId_skill = 10707, buffId_228 = 102802, 
...
bs_1028022.ctor = function(self)
  -- function num : 0_0
end

bs_1028022.InitSkill = function(self, isMidwaySkill)
  -- function num : 0_1 , upvalues : base
  (base.InitSkill)(self, isMidwaySkill)
end

bs_1028022.PlaySkill = function(self, data)
...
bs_1028022.OnAttackTrigger = function(self, target)
  -- function num : 0_3 , upvalues : _ENV
  LuaSkillCtrl:CallEffect(target, (self.config).effectId_skill, self, self.SkillEventFunc)
end

bs_1028022.SkillEventFunc = function(self, effect, eventId, target)
...
bs_1028022.OnBuffExecute = function(self, buff, targetRole)
...
bs_1028022.OnCasterDie = function(self)
