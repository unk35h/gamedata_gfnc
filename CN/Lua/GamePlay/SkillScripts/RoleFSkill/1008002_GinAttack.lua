...
local base = bs_1
bs_1008002.config = {effectId_trail = 100801, buffIdBJ = 10080101, 
...
bs_1008002.config = setmetatable(bs_1008002.config, {__index = base.config})
bs_1008002.ctor = function(self)
  -- function num : 0_0
end

bs_1008002.InitSkill = function(self, isMidwaySkill)
  -- function num : 0_1 , upvalues : base
  (base.InitSkill)(self, isMidwaySkill)
end

bs_1008002.PlaySkill = function(self, passdata)
...
bs_1008002.FindEnemy = function(self, selectId, rangeOffset)
...
bs_1008002.OnAttackTrigger = function(self, target, data, atkSpeedRatio, atkActionId, atkTriggerFrame)
  -- function num : 0_4 , upvalues : _ENV, base
  if target.belongNum == (self.caster).belongNum and ((self.caster).recordTable).BJ == true then
    if (self.caster):GetBuffTier((self.config).buffIdBJ) > 0 then
      local influenceType = nil
...
bs_1008002.SkillEventFunc2 = function(self, effect, eventId, target)
...
bs_1008002.OnCasterDie = function(self)
