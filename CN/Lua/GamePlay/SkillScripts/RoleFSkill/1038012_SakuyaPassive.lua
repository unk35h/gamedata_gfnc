...
bs_1038012.ctor = function(self)
  -- function num : 0_0
end

bs_1038012.InitSkill = function(self, isMidwaySkill)
...
bs_1038012.OnAfterHurt = function(self, sender, target, skill, hurt, isMiss, isCrit, hurtType, isTriggerSet)
...
bs_1038012.OnCasterDie = function(self)
...
bs_1038012.LuaDispose = function(self)
