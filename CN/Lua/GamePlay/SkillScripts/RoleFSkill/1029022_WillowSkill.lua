...
local bs_1029022 = class("bs_1029022", LuaSkillBase)
local base = LuaSkillBase
bs_1029022.config = {effectId_start = 102903, effectId_grid = 102904, effectId_hit = 102905, buffId_115 = 3012, actionId = 1002, skill_time = 25, start_time = 17, skill_speed = 1, 
hurtConfig = {hit_formula = 0, basehurt_formula = 10077, crit_formula = 0, crithur_ratio = 0}
, audioId1 = 102904}
bs_1029022.ctor = function(self)
  -- function num : 0_0
end

bs_1029022.InitSkill = function(self, isMidwaySkill)
  -- function num : 0_1 , upvalues : base
  (base.InitSkill)(self, isMidwaySkill)
end

bs_1029022.PlaySkill = function(self, data)
...
bs_1029022.OnActionCallBack = function(self, target, roles, roles_2)
...
bs_1029022.OnCasterDie = function(self)
