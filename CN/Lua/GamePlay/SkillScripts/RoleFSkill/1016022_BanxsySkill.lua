...
bs_1016022.config = {buffId_Paint = 10160101, buffId_170 = 170, superBuffId = 27101, effectId = 101604, 
...
bs_1016022.ctor = function(self)
  -- function num : 0_0
end

bs_1016022.InitSkill = function(self, isMidwaySkill)
...
bs_1016022.PlaySkill = function(self, data)
  -- function num : 0_2
...
bs_1016022.realRlaySkill = function(self, realTargetRole)
...
bs_1016022.OnAttackTrigger = function(self, target)
  -- function num : 0_4 , upvalues : _ENV
  LuaSkillCtrl:CallEffect(target, (self.config).effectId, self, self.SkillEventFunc)
end

bs_1016022.CheckAndGetTargetRole = function(self)
...
bs_1016022.AnalysisSelectRoles = function(self, realTargetRole, roles)
...
bs_1016022.PhaseMove = function(self, realTargetRole)
...
bs_1016022.SkillEventFunc = function(self, effect, eventId, target)
...
bs_1016022.OnCasterDie = function(self)
