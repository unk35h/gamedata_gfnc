...
bs_1004022.config = {effectId_trail = 100403, 
hurt_config = {hit_formula = 0, basehurt_formula = 3000}
, skill_time = 27, actionId = 1002, selectId = 9, selectrange = 10}
bs_1004022.ctor = function(self)
  -- function num : 0_0
end

bs_1004022.InitSkill = function(self, isMidwaySkill)
  -- function num : 0_1
end

bs_1004022.PlaySkill = function(self, data)
...
bs_1004022.OnActionTrigger = function(self, targetList)
...
bs_1004022.RealPlaySkill = function(self, targetRole)
...
bs_1004022.SkillEventFunc = function(self, effect, eventId, target)
...
bs_1004022.OnCasterDie = function(self)
