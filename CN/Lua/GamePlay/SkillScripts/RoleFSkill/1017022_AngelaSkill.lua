...
local bs_1017022 = class("bs_1017022", LuaSkillBase)
local base = LuaSkillBase
bs_1017022.config = {actionId = 1008, actionId_loop = 1007, actionId_end = 1009, action_speed = 2, skill_time = 13, start_time = 12, end_time = 15, audioId1 = 101701, audioId2 = 101702, effectId_start = 101705, effectId_player = 101703, effectId_entiy = 101704}
bs_1017022.ctor = function(self)
  -- function num : 0_0
end

bs_1017022.InitSkill = function(self, isMidwaySkill)
...
bs_1017022.PlaySkill = function(self, data)
...
bs_1017022.SetBookActive = function(self, index)
  -- function num : 0_3
...
bs_1017022.SetBookDisActive = function(self, index)
  -- function num : 0_4
  local bookArray = ((self.caster).recordTable).books
  if bookArray == nil then
    return 
...
bs_1017022.OnAttackTrigger = function(self, target)
...
bs_1017022.End = function(self, target)
...
bs_1017022.OnSkillRemove = function(self)
  -- function num : 0_7 , upvalues : base
  (base.OnSkillRemove)(self)
end

bs_1017022.OnCasterDie = function(self)
  -- function num : 0_8 , upvalues : base
  (base.OnCasterDie)(self)
end

bs_1017022.LuaDispose = function(self)
