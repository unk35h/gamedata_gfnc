...
bs_1025022.config = {skill_time = 31, start_time = 17, actionId = 1002, action_speed = 1, audioId1 = 251, audioId_hit = 253, buffId_Hua = 10250201, buffId_CH = 10250101, buffId_170 = 170, 
...
, ex_hurttime = 3, buffId_tip = 10250301}
bs_1025022.ctor = function(self)
  -- function num : 0_0
end

bs_1025022.InitSkill = function(self, isMidwaySkill)
...
bs_1025022.PlaySkill = function(self, data)
...
bs_1025022.OnAttackTrigger = function(self, target)
...
bs_1025022.OnBuffDie = function(self, buff, target, removeType)
...
bs_1025022.OnCollision = function(self, target, collider, index, entity)
...
bs_1025022.OnBreakSkill = function(self, role)
...
bs_1025022.OnCasterDie = function(self)
  -- function num : 0_7 , upvalues : base
  (base.OnCasterDie)(self)
end

bs_1025022.LuaDispose = function(self)
