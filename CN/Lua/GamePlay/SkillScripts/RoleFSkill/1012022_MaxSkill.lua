...
local bs_1012022 = class("bs_1012022", LuaSkillBase)
local base = LuaSkillBase
bs_1012022.config = {effectId_loop = 101207, effectId_line = 101208, effectId_weapon = 101210, effectId_start = 101206, buffId_66 = 3006, actionId = 1002, action_speed = 1, skill_time = 25, start_time = 20, 
HurtConfig = {hit_formula = 0, basehurt_formula = 3010, crit_formula = 0, crithur_ratio = 0, returndamage_formula = 0}
}
bs_1012022.ctor = function(self)
  -- function num : 0_0
end

bs_1012022.InitSkill = function(self, isMidwaySkill)
  -- function num : 0_1 , upvalues : base
  (base.InitSkill)(self, isMidwaySkill)
end

bs_1012022.PlaySkill = function(self, data)
...
bs_1012022.OnActionCallBack = function(self, target, grid)
...
bs_1012022.RealPlaySkill = function(self, ballSkillData, skillEmission)
...
bs_1012022.PlaySkillEnd = function(self, ballSkillData, skillEmission)
  -- function num : 0_5
  self:KillEffectBall(ballSkillData.effectBall)
  skillEmission:EndAndDisposeEmission()
end

bs_1012022.KillEffectBall = function(self, effectBall)
  -- function num : 0_6
...
bs_1012022.OnCollision = function(self, ballSkillData, collider, index, entity)
...
bs_1012022.OnRemoveArrive = function(self, ballSkillData, collider, entity)
...
bs_1012022.OnEmissionArrive = function(self, skillEmission)
...
bs_1012022.OnCasterDie = function(self)
