...
bs_1031012.ctor = function(self)
  -- function num : 0_0
end

bs_1031012.InitSkill = function(self, isMidwaySkill)
  -- function num : 0_1 , upvalues : base
  (base.InitSkill)(self, isMidwaySkill)
  self:AddAfterHurtTrigger("bs_1031012_3", 1, self.OnAfterHurt, self.caster)
end

bs_1031012.OnAfterHurt = function(self, sender, target, skill, hurt, isMiss, isCrit, hurtType, isTriggerSet)
...
bs_1031012.SkillEventFunc = function(self, hurt, effect, eventId, target)
...
bs_1031012.OnCasterDie = function(self)
