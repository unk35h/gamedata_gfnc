...
bs_1019012.config = {monsterId = 10014, effectId1 = 10687, effectId2 = 10686, effectId3 = 10699, effectId_db = 10700, 
hurtConfig = {hit_formula = 0, basehurt_formula = 10081, crit_formula = 0, crithur_ratio = 0}
, buffId_229 = 22901, skill_time = 47, start_time = 27, actionId = 1002, action_speed = 1, audioId1 = 219, audioId2 = 220}
bs_1019012.ctor = function(self)
  -- function num : 0_0
end

bs_1019012.InitSkill = function(self, isMidwaySkill)
...
bs_1019012.OnAfterBattleStart = function(self)
...
bs_1019012.PlaySkill = function(self)
...
bs_1019012.OnAttackTrigger = function(self, grid, summoner, target)
...
bs_1019012.OnRoleDie = function(self, killer, role)
...
bs_1019012.OnCasterDie = function(self)
...
bs_1019012.LuaDispose = function(self)
