...
bs_10320222.config = {actionId = 1002, skill_time = 50, start_time = 5, skill_speed = 1, selectId_skill = 9, 
...
bs_10320222.ctor = function(self)
  -- function num : 0_0
end

bs_10320222.InitSkill = function(self, isMidwaySkill)
...
bs_10320222.PlaySkill = function(self, data)
...
bs_10320222.OnActionCallBack = function(self)
...
bs_10320222.OnEffectTrigger = function(self, time, effect, eventId, target)
...
bs_10320222.OnCollisionEnter = function(self, time, target, collider, index, entity)
...
bs_10320222.LuaDispose = function(self)
...
bs_10320222.OnCasterDie = function(self)
