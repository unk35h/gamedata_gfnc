...
bs_1005022.config = {buffId_Taunt = 300201, effectId_CF = 123, effectId_start = 100504, effectId_Hit1 = 100506, effectId_Hit2 = 100507, effectId_Hit3 = 100508, effectId_Hit4 = 100509, effectId_Hit5 = 100510, effectId_Hit6 = 100511, effectId_Hit7 = 100512, effectId_Hit8 = 100513, effectId_Hit9 = 100514, effectId_Hit10 = 100515, shieldFormula = 3021, buffId_Super = 300301, actionId_start = 1002, actionId_loop = 1007, action_speed = 1, skill_time = 15, start_time = 5, buffId_170 = 170}
bs_1005022.ctor = function(self)
  -- function num : 0_0
end

bs_1005022.InitSkill = function(self, isMidwaySkill)
...
bs_1005022.PlaySkill = function(self, data)
...
bs_1005022.OnAttackTrigger = function(self, time, duration)
...
bs_1005022.Onover = function(self)
...
bs_1005022.OnBreakShield = function(self, shieldType, sender, target)
  -- function num : 0_5
...
bs_1005022.OnBreakSkill = function(self, role)
...
bs_1005022.OnCasterDie = function(self)
  -- function num : 0_7 , upvalues : base
  (base.OnCasterDie)(self)
end

bs_1005022.LuaDispose = function(self)
