...
, effectId = 10103, damageEffectId = 10104, startAnimID = 1004, audioId1 = 20, skillId = 300001, commonAttackId = 505, select_id = 1001, select_range = 0, skill_time = 25, start_time = 10, skill_speed = 1, healCallBackDelay = 3}
...
bs_300001.LuaDispose = function(self)
