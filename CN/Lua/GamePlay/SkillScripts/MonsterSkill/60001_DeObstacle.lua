...
bs_60001.config = {buffId1 = 175, buffId2 = 1033, buffId3 = 198, effectId1 = 10505, effectId2 = 10506, effectId3 = 12014, effectId4 = 12015, audioId_end = 355}
...
bs_60001.OnCasterDie = function(self)
  ...
  if (self.caster).roleDataId == 1001 then
    ...
    if (self.caster).roleDataId == 1005 then
      ...
      if (self.caster).roleDataId == 1007 then
        LuaSkillCtrl:CallEffect(self.caster, (self.config).effectId3, self)
      else
        if (self.caster).roleDataId == 1009 then
