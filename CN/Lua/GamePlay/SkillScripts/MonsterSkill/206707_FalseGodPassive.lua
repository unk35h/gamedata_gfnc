...
bs_206707.config = {buffId_superArmor = 2067011, buffId_curse = 2067012, effectId_curse = 2067011, buffId_curseLabel1 = 2067013, buffId_curseLabel2 = 2067014, buffId_curseLabel3 = 2067015, timeDuration = 15}
bs_206707.ctor = function(self)
  -- function num : 0_0
end

bs_206707.InitSkill = function(self, isMidwaySkill)
...
bs_206707.OnAfterBattleStart = function(self)
...
bs_206707.CountDown = function(self)
...
bs_206707.OnAfterHurt = function(self, sender, target, skill, hurt, isMiss, isCrit, hurtType, isTriggerSet)
...
bs_206707.CurseLabel = function(self, target)
...
bs_206707.OnCasterDie = function(self)
  -- function num : 0_6
end
