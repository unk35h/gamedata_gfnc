...
local bs_999999 = class("bs_999999", LuaSkillBase)
local base = LuaSkillBase
bs_999999.config = {effectId = 10911, rootEffectId = 10113, startAnimId = 1002, buffID_1158 = 1158, 
...
bs_999999.ctor = function(self)
  -- function num : 0_0
end

bs_999999.InitSkill = function(self, isMidwaySkill)
  -- function num : 0_1 , upvalues : base, _ENV
  (base.InitSkill)(self, isMidwaySkill)
  self:AddTrigger(eSkillTriggerType.BeforeBattleEnd, "bs_999999", 1, self.BeforeEndBattle)
end

bs_999999.CallBack = function(self)
...
bs_999999.PlaySkill = function(self, data)
...
bs_999999.CallBack1 = function(self)
...
bs_999999.BeforeEndBattle = function(self)
  -- function num : 0_5
end

bs_999999.OnCasterDie = function(self)
...
bs_999999.OnBreakSkill = function(self, role)
...
bs_999999.LuaDispose = function(self)
