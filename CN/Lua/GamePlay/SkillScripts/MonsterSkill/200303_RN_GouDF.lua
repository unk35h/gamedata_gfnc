...
, buffId_1017 = 1017, buffTier = 1, startAnimID = 1002, effectId = 10095, effectPick = 2001301, effectLine = 2001302, hurtEffectId = 10096, audioId1 = 49, audioId2 = 50, passive_select_id = 9, passive_select_range = 0, skill_time = 28, skill_speed = 1, start_time = 16, emissionRadius = 40, emissionSpeed = 4}
    ...
    if ((self.caster).recordTable).life_num ~= nil then
      ...
      do
        ...
        if moveTarget ~= nil then
          ...
          LuaSkillCtrl:CallEffect(role, (self.config).effectPick, self)
