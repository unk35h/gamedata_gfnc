...
local bs_70034 = class("bs_70034", LuaSkillBase)
...
bs_70034.ctor = function(self)
  -- function num : 0_0
end

bs_70034.InitSkill = function(self, isMidwaySkill)
  -- function num : 0_1 , upvalues : base, _ENV
  (base.InitSkill)(self, isMidwaySkill)
  self.index = 1
  self:AddTrigger(eSkillTriggerType.AfterBattleStart, "bs_70034_1", 1, self.OnAfterBattleStart)
  LuaSkillCtrl:RegisterRoleHpCostEvent(self, self.caster, {900, 800, 700, 600, 500, 400, 300, 200, 100}, self.OnHpSubCost, false)
end

bs_70034.OnHpSubCost = function(self, curHp, TargetValue)
  -- function num : 0_2
...
bs_70034.OnAfterBattleStart = function(self)
  -- function num : 0_3
  self:OnSummon()
end

bs_70034.OnSummon = function(self)
...
bs_70034.OnCasterDie = function(self)
