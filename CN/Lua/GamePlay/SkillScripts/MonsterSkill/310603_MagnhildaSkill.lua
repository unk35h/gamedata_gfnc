...
local bs_310603 = class("bs_310603", LuaSkillBase)
local base = LuaSkillBase
bs_310603.config = {effectId_attack = 10490302, effectId_hit1 = 10490402, effectId_hit2 = 10490502, effectId_hit3 = 10490602, buffId_passive = 104901, buffId_skill = 104902, buffId_stun = 3006, shieldFormula = 3022, skill_time = 37, actionId = 1002, action_speed = 1, start_time = 6, start_time2 = 4, start_time3 = 7, hurtConfigId = 2}
bs_310603.ctor = function(self)
  -- function num : 0_0
end

bs_310603.InitSkill = function(self, isMidwaySkill)
  -- function num : 0_1 , upvalues : base, _ENV
  (base.InitSkill)(self, isMidwaySkill)
  self:AddTrigger(eSkillTriggerType.BeforeAddBuff, "bs_310603_7", 1, self.OnBeforeAddBuff)
end

bs_310603.PlaySkill = function(self, data)
...
bs_310603.OnAttackTrigger = function(self, target)
...
bs_310603.OnBeforeAddBuff = function(self, target, context)
...
bs_310603.OnCasterDie = function(self)
  -- function num : 0_5 , upvalues : base
  (base.OnCasterDie)(self)
end

bs_310603.LuaDispose = function(self)
