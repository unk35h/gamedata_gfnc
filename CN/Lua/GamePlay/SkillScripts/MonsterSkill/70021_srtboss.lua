...
bs_70021.config = {timeDuration = 15, effectId = 10937, buffFeature_ignoreDie = 6, buffFeature_Invinciable = 2, effectDelaytime = 30, effectTime = 55}
bs_70021.ctor = function(self)
  -- function num : 0_0
end

bs_70021.InitSkill = function(self, isMidwaySkill)
...
bs_70021.OnArriveAction = function(self)
...
bs_70021.OnCasterDie = function(self)
