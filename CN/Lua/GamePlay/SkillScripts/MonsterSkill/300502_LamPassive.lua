...
bs_300502.config = {}
bs_300502.ctor = function(self)
  -- function num : 0_0
end

bs_300502.InitSkill = function(self, isMidwaySkill)
...
bs_300502.OnCasterAttributeChange = function(self)
...
bs_300502.OnCasterDie = function(self)
