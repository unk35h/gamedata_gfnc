...
local base = bs_1
bs_704.config = {buffId_110 = 204203, buffId_111 = 204204, buffId_112 = 104008, effectId_trail = 204200, effectId_trail_ex = 204209, effectId_sign = 210201, select_id = 9, select_range2 = 20, 
...
bs_704.config = setmetatable(bs_704.config, {__index = base.config})
bs_704.ctor = function(self)
  -- function num : 0_0
end

bs_704.InitSkill = function(self, isMidwaySkill)
...
bs_704.OnAfterBattleStart = function(self)
  -- function num : 0_2 , upvalues : _ENV
  LuaSkillCtrl:CallEffect(self.caster, (self.config).effectId_sign, self)
end

bs_704.SkillEventFunc = function(self, configData, effect, eventId, target)
...
bs_704.CallBuff = function(self, target)
...
bs_704.OnBuffExecute = function(self, buff, targetRole)
...
bs_704.OnBuffExecute2 = function(self, buff, targetRole)
...
bs_704.OnCasterDie = function(self)
