...
bs_520.OnAttackTrigger = function(self, target, data, atkSpeedRatio, atkActionId)
  ...
  if (self.caster).attackRange == 1 then
    ...
    if LuaSkillCtrl:IsAbleAttackTarget(self.caster, target, (self.caster).attackRange, true) then
      ...
      do
        self:BreakSkill()
        if ((self.caster).recordTable)["20051_root4arg1"] ~= nil and LuaSkillCtrl:IsAbleAttackTarget(self.caster, target, (self.caster).attackRange, true) then
          ...
          if LuaSkillCtrl:IsAbleAttackTarget(self.caster, target, (self.caster).attackRange, true) and ((self.caster).recordTable)["20051_root4arg1"] == nil then
