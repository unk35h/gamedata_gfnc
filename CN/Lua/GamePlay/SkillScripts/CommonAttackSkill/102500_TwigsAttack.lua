...
local base = bs_1
bs_102500.config = {effectId_trail = 102503, effectId_P = 102506, effectId_hit2 = 102505, effectId_hit3 = 102513, effectId_new = 102507, effectId_new2 = 102515, 
HurtConfig = {basehurt_formula = 3000}
, ex_hurttime = 3, buffId_170 = 170, buffId_tip = 102503, audioId1 = 248, audioId2 = 249, audioId5 = 250, audioId_three = 251, audioId_three_hit = 253, buffId_CH = 102501}
    ...
    if self.isDoubleAttack then
      ...
      do
        do
          ...
          if ((self.caster).recordTable)["102501_weaponLv"] >= 3 then
            local extraTarget = self:CheckAndGetExtraEffectTarget(target)
...
bs_102500.CallColliderEmission2 = function(self, target, effect, eventId, target)
  ...
  if eventId == eBattleEffectEvent.Trigger then
    ...
    LuaSkillCtrl:CallCircledEmissionStraightly(self, self.caster, target, 15, 15, 10, collisionTrigger, nil, nil, nil, true, false)
  end
end
...
bs_102500.OnCollision2 = function(self, target, collider, index, entity)
