...
bs_1.SetAttackRole = function(self)
  -- function num : 0_2
...
bs_1.RealPlaySkill = function(self, target, data)
  ...
  if self.attackNum > 1 then
    ...
    -- function num : 0_4_1 , upvalues : _ENV, self, data
    ...
    do
      if data.audioId1 ~= nil then
        LuaSkillCtrl:StartTimer(self, data.time1, function()
    -- function num : 0_4_2 , upvalues : _ENV, self, data
    LuaSkillCtrl:PlayAuSource(self.caster, data.audioId1)
  end
)
      end
...
bs_1.ExecuteEffectAttack = function(self, data, atkActionId, target, effectId1, effectId2)
