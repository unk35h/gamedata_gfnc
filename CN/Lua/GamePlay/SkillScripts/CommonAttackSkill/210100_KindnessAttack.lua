...
local base = bs_1
bs_210100.config = {effectId_1 = 10440, effectId_2 = 10441, audioId1 = 314, audioId2 = 315, audioId3 = 360}
bs_210100.config = setmetatable(bs_210100.config, {__index = base.config})
bs_210100.ctor = function(self)
  -- function num : 0_0
end

bs_210100.InitSkill = function(self, isMidwaySkill)
  -- function num : 0_1 , upvalues : base
  (base.InitSkill)(self, isMidwaySkill)
end

bs_210100.RealPlaySkill = function(self, target, data)
...
bs_210100.OnCasterDie = function(self)
