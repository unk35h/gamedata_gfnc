...
local base = bs_1
bs_705.config = {action1 = 1001, action2 = 1004, action3 = 1020, effectId_ex = 208704, effectId_1 = 208701, effectId_2 = 208702, effectId_hitp = 208703, effectId_sign = 210201, 
HurtConfig = {hit_formula = 0, basehurt_formula = 3000, crit_formula = 0, crithur_ratio = 0}
}
bs_705.config = setmetatable(bs_705.config, {__index = base.config})
bs_705.ctor = function(self)
  -- function num : 0_0
end

bs_705.InitSkill = function(self, isMidwaySkill)
  -- function num : 0_1 , upvalues : base, _ENV
  (base.InitSkill)(self, isMidwaySkill)
  self:AddTrigger(eSkillTriggerType.AfterBattleStart, "bs_705", 1, self.OnAfterBattleStart)
end

bs_705.OnAfterBattleStart = function(self)
  -- function num : 0_2 , upvalues : _ENV
  LuaSkillCtrl:CallEffect(self.caster, (self.config).effectId_sign, self)
end

bs_705.RealPlaySkill = function(self, target, data)
...
bs_705.OnAttackTrigger = function(self, target, data, atkSpeedRatio, atkActionId, atkTriggerFrame, roll_attack)
  ...
  if roll_attack then
    ...
    -- function num : 0_4_0 , upvalues : _ENV, target, self, hurtjc
    LuaSkillCtrl:CallEffect(target, (self.config).effectId_hitp, self)
    local skillResult = LuaSkillCtrl:CallSkillResultNoEffect(self, target)
    LuaSkillCtrl:HurtResult(self, skillResult, (self.config).HurtConfig, {hurtjc})
    skillResult:EndResult()
    ...
    -- function num : 0_4_1 , upvalues : _ENV, target, self, hurtjc
    LuaSkillCtrl:CallEffect(target, (self.config).effectId_hitp, self)
    local skillResult = LuaSkillCtrl:CallSkillResultNoEffect(self, target)
    LuaSkillCtrl:HurtResult(self, skillResult, (self.config).HurtConfig, {hurtjc})
    skillResult:EndResult()
    ...
    -- function num : 0_4_2 , upvalues : _ENV, target, self, hurtjc
    LuaSkillCtrl:CallEffect(target, (self.config).effectId_hitp, self)
    local skillResult = LuaSkillCtrl:CallSkillResultNoEffect(self, target)
    LuaSkillCtrl:HurtResult(self, skillResult, (self.config).HurtConfig, {hurtjc})
    skillResult:EndResult()
...
bs_705.OnCasterDie = function(self)
