...
local base = bs_1
bs_210300.config = {effectId_trail = 210302, effectId_start1 = 210300, effectId_start2 = 210301, effectId_skill = 210305, 
aoe = {effect_shape = 3, aoe_select_code = 5, aoe_range = 1}
, 
hurt = {basehurt_formula = 10055}
, effectId_start1_skill = 210309, effectId_start2_skill = 210309, audioId1 = 369, audioId2 = 371}
bs_210300.config = setmetatable(bs_210300.config, {__index = base.config})
bs_210300.ctor = function(self)
  -- function num : 0_0
end

bs_210300.InitSkill = function(self, isMidwaySkill)
  -- function num : 0_1 , upvalues : base
  (base.InitSkill)(self, isMidwaySkill)
end

bs_210300.RealPlaySkill = function(self, target, data)
...
bs_210300.OnAttackTrigger = function(self, target, data, atkSpeedRatio, atkActionId)
  ...
  if ((self.caster).recordTable).attack == 2 then
    ...
    -- function num : 0_3_0 , upvalues : _ENV, target, data, self
    LuaSkillCtrl:CallEffectWithArg(target, data.effectId_skill, self, true, false, self.SkillEventFunc, data)
  end
)
        LuaSkillCtrl:StartTimer(self, 5, function()
    -- function num : 0_3_1 , upvalues : _ENV, target, data, self
    LuaSkillCtrl:CallEffectWithArg(target, data.effectId_skill, self, true, false, self.SkillEventFunc, data)
  end
)
      end
...
bs_210300.SkillEventFunc = function(self, configData, effect, eventId, target)
...
bs_210300.OnCasterDie = function(self)
