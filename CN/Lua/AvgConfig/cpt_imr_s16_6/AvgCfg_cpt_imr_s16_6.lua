...
local AvgCfg_cpt_imr_s16_6 = {
[1] = {
ppv = {
cg = {saturation = -70}
}
, bgColor = 2, content = 10, contentType = 3, speakerHeroId = 97, 
images = {
...
, 
[3] = {content = 30, contentType = 3, speakerHeroId = 97, 
imgTween = {
...
, 
[6] = {content = 60, contentType = 3, speakerHeroId = 97, 
imgTween = {
{imgId = 97, delay = 0, duration = 0.2, posId = 3, alpha = 1, isDark = false}
}
, 
...
, 
[8] = {content = 80, contentType = 3, speakerHeroId = 97, 
imgTween = {
{imgId = 97, delay = 0, duration = 0.2, posId = 3, alpha = 1, isDark = false}
}
, 
...
, 
[10] = {content = 100, contentType = 3, speakerHeroId = 13, speakerHeroPosId = 1, 
imgTween = {
{imgId = 97, delay = 0, duration = 0.6, posId = 4, alpha = 1, isDark = true}
, 
...
, 
[11] = {content = 110, contentType = 3, speakerHeroId = 97, speakerHeroPosId = 3, 
imgTween = {
...
, 
[14] = {content = 140, contentType = 3, speakerHeroId = 97, speakerHeroPosId = 3, 
imgTween = {
{imgId = 13, delay = 0, duration = 0.2, posId = 2, alpha = 1, isDark = true}
, 
{imgId = 97, delay = 0, duration = 0.2, posId = 4, alpha = 1, isDark = false}
...
, 
[16] = {content = 160, contentType = 3, speakerHeroId = 97, speakerHeroPosId = 3, contentShake = true, 
imgTween = {
{imgId = 13, delay = 0, duration = 0.2, posId = 2, alpha = 1, isDark = true}
, 
{imgId = 97, delay = 0, duration = 0.2, posId = 4, alpha = 1, isDark = false}
...
, 
[18] = {content = 180, contentType = 3, speakerHeroId = 97, speakerHeroPosId = 3, 
imgTween = {
{imgId = 13, delay = 0, duration = 0.2, posId = 2, alpha = 1, isDark = true}
, 
{imgId = 97, delay = 0, duration = 0.2, posId = 4, alpha = 1, isDark = false}
