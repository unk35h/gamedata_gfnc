...
[1] = {SkipScenario = 14, bgColor = 2, content = 10, contentType = 3, speakerHeroId = 1001, speakerHeroPosId = 2, storyAvgId = 2105, 
images = {
...
, 
[93] = {content = 930, contentType = 4, speakerName = 912, contentShake = true, 
audio = {
sfx = {cue = "Skill_Lam_Ex_Cast", sheet = "Chara_Lam"}
}
}
