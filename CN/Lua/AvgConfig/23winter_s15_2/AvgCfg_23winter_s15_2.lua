...
, 
{imgId = 2, imgType = 2, alpha = 0, order = 3, imgPath = "cpt00/cpt00_e_cg027_2", fullScreen = true}
, 
{imgId = 3, imgType = 2, alpha = 0, order = 4, imgPath = "cpt00/cpt00_e_cg027_3", fullScreen = true}
, 
{imgId = 4, imgType = 2, alpha = 0, imgPath = "cpt00/cpt00_e_cg027_5", imgPathBoy = "cpt00/cpt00_e_cg027_4", fullScreen = true}
, 
...
, 
[29] = {content = 290, contentType = 3, speakerHeroId = 26, contentShake = true, 
imgTween = {
{imgId = 4, delay = 0, duration = 0.6, alpha = 0}
, 
...
, 
{imgId = 26, delay = 1.2, duration = 0.2, posId = 3, alpha = 1, shake = true, isDark = false}
}
, 
heroFace = {
{imgId = 26, faceId = 10}
