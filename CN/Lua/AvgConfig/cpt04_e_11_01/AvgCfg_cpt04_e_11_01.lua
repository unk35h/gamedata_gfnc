...
[1] = {SkipScenario = 14, bgColor = 2, content = 10, contentType = 3, speakerHeroId = 30, speakerHeroPosId = 2, storyAvgId = 4111, contentShake = true, 
images = {
...
, 
{imgId = 8, imgType = 2, alpha = 0, imgPath = "cpt04/cpt04_e_bg001", fullScreen = true}
, 
{imgId = 4, imgType = 2, alpha = 0, imgPath = "cpt04/cpt04_e_cg002", fullScreen = true}
, 
...
, 
{imgId = 30, delay = 1.6, duration = 0.3, posId = 3, alpha = 1, shake = true, isDark = false}
}
, 
audio = {
...
, 
[8] = {content = 80, contentType = 3, speakerHeroId = 1001, speakerHeroPosId = 2, contentShake = true, 
imgTween = {
{imgId = 30, delay = 0, duration = 0.2, posId = 3, alpha = 0, isDark = false}
, 
...
imgTween = {
{imgId = 8, delay = 0, duration = 1, alpha = 0, isDark = false}
}
, 
audio = {
bgm = {stop = true}
...
, 
{imgId = 6, imgType = 2, alpha = 0, imgPath = "cpt04/cpt04_e_cg002_2", fullScreen = true}
, 
...
images = {
{imgId = 1, imgType = 2, alpha = 0, imgPath = "cpt04/cpt04_e_bg008", fullScreen = true, delete = true}
, 
{imgId = 5, imgType = 2, alpha = 0, imgPath = "cpt04/cpt04_e_bg001_3", fullScreen = true}
}
, 
imgTween = {
{imgId = 101, delay = 0, duration = 0.2, posId = 3, alpha = 0, isDark = true}
...
, 
{imgId = 5, delay = 1.2, duration = 0.3, shake = true}
}
, 
audio = {
sfx = {cue = "AVG_body_fall", sheet = "AVG"}
...
, 
{imgId = 6, delay = 0, duration = 0.3, alpha = 1}
}
, nextId = 63}
, 
...
, 
[57] = {content = 570, contentType = 4, speakerName = 12, contentShake = true}
, 
...
imgTween = {
{imgId = 6, delay = 0, duration = 2, alpha = 0}
}
, 
audio = {
bgm = {stop = true}
...
, 
[74] = {content = 740, contentType = 3, speakerHeroId = 28, speakerHeroPosId = 2, 
imgTween = {
{imgId = 8, delay = 0, duration = 0, alpha = 0, 
pos = {0, 0, 0}
, 
scale = {1, 1, 1}
}
...
, 
{imgId = 28, delay = 1, duration = 0.2, posId = 3, alpha = 1, isDark = false}
}
, 
audio = {
...
, 
{imgId = 6, imgType = 2, alpha = 0, imgPath = "cpt04/cpt04_e_cg002_2", fullScreen = true, delete = true}
}
, 
imgTween = {
{imgId = 28, delay = 0, duration = 0.3, posId = 3, alpha = 0, isDark = false}
, 
{imgId = 101, delay = 0, duration = 0, posId = 3, alpha = 0, isDark = false}
, 
{imgId = 101, delay = 0, duration = 0.2, posId = 3, alpha = 1, isDark = false}
...
, 
[76] = {content = 760, contentType = 3, speakerHeroId = 28, speakerHeroPosId = 3, 
imgTween = {
...
, 
[78] = {content = 780, contentType = 3, speakerHeroId = 28, speakerHeroPosId = 3, 
imgTween = {
...
, 
[79] = {content = 790, contentType = 3, speakerHeroId = 28, speakerHeroPosId = 3, 
heroFace = {
{imgId = 28, faceId = 0}
}
}
...
, 
[81] = {content = 810, contentType = 3, speakerHeroId = 28, speakerHeroPosId = 3, 
imgTween = {
{imgId = 101, delay = 0, duration = 0.2, posId = 2, alpha = 1, isDark = true}
, 
{imgId = 28, delay = 0, duration = 0.2, posId = 4, alpha = 1, isDark = false}
...
, 
[82] = {content = 820, contentType = 3, speakerHeroId = 28, speakerHeroPosId = 3, 
heroFace = {
{imgId = 28, faceId = 2}
}
}
...
, 
[87] = {content = 870, contentType = 3, speakerHeroId = 1005, speakerHeroPosId = 3, 
imgTween = {
{imgId = 105, delay = 0, duration = 0.2, posId = 4, alpha = 1, isDark = false}
, 
{imgId = 101, delay = 0, duration = 0.2, posId = 2, alpha = 1, isDark = true}
...
, 
[89] = {content = 890, contentType = 3, speakerHeroId = 1005, speakerHeroPosId = 3, contentShake = true, 
imgTween = {
{imgId = 105, delay = 0, duration = 0.2, posId = 4, alpha = 1, isDark = false}
, 
{imgId = 101, delay = 0, duration = 0.2, posId = 2, alpha = 1, isDark = true}
...
, 
[91] = {content = 910, contentType = 3, speakerHeroId = 1005, speakerHeroPosId = 3, contentShake = true, 
imgTween = {
{imgId = 105, delay = 0, duration = 0.2, posId = 4, alpha = 1, isDark = false}
, 
{imgId = 101, delay = 0, duration = 0.2, posId = 2, alpha = 1, isDark = true}
...
, 
[95] = {content = 950, contentType = 4, speakerName = 941, 
imgTween = {
{imgId = 101, delay = 0, duration = 0.2, posId = 3, alpha = 0, isDark = false}
, 
...
, 
{imgId = 41, delay = 0, duration = 0, posId = 3, alpha = 0, isDark = false}
, 
{imgId = 41, delay = 2, duration = 0.6, posId = 3, alpha = 1, isDark = true}
}
, 
audio = {
bgm = {stop = true}
...
, 
[96] = {content = 960, contentType = 3, speakerHeroId = 41, speakerHeroPosId = 2, 
imgTween = {
{imgId = 41, delay = 0, duration = 0.2, posId = 3, alpha = 1, isDark = false}
}
}
, 
[97] = {content = 970, contentType = 4, speakerName = 941, 
imgTween = {
{imgId = 41, delay = 0, duration = 0.2, posId = 3, alpha = 1, isDark = true}
}
}
, 
[98] = {content = 980, contentType = 3, speakerHeroId = 41, speakerHeroPosId = 2, 
imgTween = {
{imgId = 41, delay = 0, duration = 0.2, posId = 3, alpha = 1, isDark = false}
}
}
...
imgTween = {
{imgId = 41, delay = 0, duration = 0.2, posId = 3, alpha = 0, isDark = false}
, 
{imgId = 2, delay = 0, duration = 1, alpha = 0, isDark = true}
, 
{imgId = 8, delay = 1, duration = 1, alpha = 1, isDark = false}
, 
{imgId = 101, delay = 0, duration = 0, posId = 3, alpha = 0, isDark = false}
, 
...
, 
[100] = {content = 1000, contentType = 3, speakerHeroId = 28, speakerHeroPosId = 2, 
imgTween = {
{imgId = 101, delay = 0, duration = 0.2, posId = 3, alpha = 0, isDark = false}
, 
{imgId = 28, delay = 0, duration = 0, posId = 3, alpha = 0, isDark = false}
