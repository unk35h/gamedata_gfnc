...
[1] = {bgColor = 2, content = 10, contentType = 1, storyAvgId = 1100204, 
images = {
{imgId = 1, imgType = 2, alpha = 0, imgPath = "cpt00/cpt00_e_bg006", fullScreen = true}
, 
...
, 
[29] = {content = 290, contentType = 3, speakerHeroId = 52, speakerHeroPosId = 2, 
imgTween = {
{imgId = 26, delay = 0, duration = 0.2, posId = 3, alpha = 0, isDark = false}
, 
{imgId = 52, delay = 0, duration = 0, posId = 3, alpha = 0, isDark = false}
...
, 
[32] = {content = 320, contentType = 3, speakerHeroId = 52, speakerHeroPosId = 2, 
imgTween = {
{imgId = 52, delay = 0, duration = 0, posId = 3, alpha = 0, isDark = false}
, 
{imgId = 52, delay = 0, duration = 0.2, posId = 3, alpha = 1, isDark = false}
...
, 
[35] = {content = 350, contentType = 3, speakerHeroId = 52, speakerHeroPosId = 2, scrambleTypeWriter = true, 
imgTween = {
{imgId = 52, delay = 0, duration = 0, posId = 3, alpha = 0, isDark = false}
, 
{imgId = 52, delay = 0, duration = 0.2, posId = 3, alpha = 1, isDark = false}
