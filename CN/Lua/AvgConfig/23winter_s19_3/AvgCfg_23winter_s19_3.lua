...
[1] = {bgColor = 2, content = 10, contentType = 3, speakerHeroId = 1003, contentShake = true, 
images = {
...
, 
{imgId = 3, imgType = 2, alpha = 0, imgPath = "cpt00/cpt00_e_bg005_12", fullScreen = true}
, 
{imgId = 4, imgType = 2, alpha = 0, imgPath = "cpt05/cpt05_e_bg008", order = 5, fullScreen = true}
, 
...
, 
[9] = {content = 90, contentType = 3, speakerHeroId = 1002, contentShake = true, 
imgTween = {
...
, 
[14] = {content = 140, contentType = 3, speakerHeroId = 1002, speakerHeroPosId = 1, contentShake = true, 
imgTween = {
{imgId = 102, delay = 0, duration = 0.2, posId = 2, alpha = 1, isDark = false}
, 
{imgId = 103, delay = 0, duration = 0.2, posId = 4, alpha = 1, isDark = true}
...
, 
[16] = {content = 160, contentType = 3, speakerHeroId = 1002, speakerHeroPosId = 1, contentShake = true, 
imgTween = {
{imgId = 102, delay = 0, duration = 0.2, posId = 2, alpha = 1, isDark = false}
, 
{imgId = 103, delay = 0, duration = 0.2, posId = 4, alpha = 1, isDark = true}
...
, 
[18] = {content = 180, contentType = 3, speakerHeroId = 1003, contentShake = true, 
imgTween = {
{imgId = 103, delay = 0, duration = 0, posId = 3, alpha = 0, isDark = false}
, 
{imgId = 103, delay = 0, duration = 0.2, posId = 3, alpha = 1, shake = true, isDark = false}
...
, 
{imgId = 4, delay = 2, duration = 1, alpha = 1}
}
, 
effect = {
effect2 = {prefabName = "avg/FXP_Scene"}
}
, 
audio = {
...
, 
{imgId = 102, delay = 2, duration = 0.2, posId = 3, alpha = 1, shake = true, isDark = false}
}
, 
heroFace = {
{imgId = 102, faceId = 5}
...
, 
[26] = {content = 260, contentType = 3, speakerHeroId = 1002, contentShake = true, 
imgTween = {
{imgId = 102, delay = 0, duration = 0.2, posId = 3, alpha = 1, shake = true, isDark = false}
}
, 
...
imgTween = {
{imgId = 37, delay = 0, duration = 0.6, alpha = 0, isDark = false, 
scale = {1.5, 1.5, 1.5}
}
}
}
...
, 
effect = {
effect3 = {prefabName = "avg/FXP_AVG_Hit-knife", 
pos = {-250, 0, 0}
}
}
}
...
, 
{imgId = 37, delay = 0, duration = 0.3, posId = 3, alpha = 1, isDark = false}
}
, 
heroFace = {
{imgId = 37, faceId = 9}
