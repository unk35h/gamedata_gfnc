...
[1] = {SkipScenario = 16, bgColor = 2, content = 10, contentType = 2, storyAvgId = 5103, 
images = {
...
, 
[20] = {content = 200, contentType = 2, scrambleTypeWriter = true}
, 
...
, 
[34] = {content = 340, contentType = 3, speakerHeroId = 1001, speakerHeroPosId = 1, contentShake = true, 
imgTween = {
{imgId = 102, delay = 0, duration = 0.2, posId = 4, alpha = 1, isDark = true}
, 
{imgId = 101, delay = 0, duration = 0.2, posId = 2, alpha = 1, isDark = false}
...
, 
[35] = {content = 350, contentType = 3, speakerHeroId = 1002, speakerHeroPosId = 3, contentShake = true, 
imgTween = {
{imgId = 102, delay = 0, duration = 0.2, posId = 4, alpha = 1, isDark = false}
, 
{imgId = 101, delay = 0, duration = 0.2, posId = 2, alpha = 1, isDark = true}
...
, 
[37] = {content = 370, contentType = 3, speakerHeroId = 1002, speakerHeroPosId = 3, contentShake = true, 
heroFace = {
{imgId = 102, faceId = 6}
}
}
...
, 
[40] = {content = 400, contentType = 4, speakerName = 11, nextId = 42}
, 
...
, 
[48] = {content = 480, contentType = 3, speakerHeroId = 1001, speakerHeroPosId = 1, contentShake = true, 
imgTween = {
{imgId = 101, delay = 0, duration = 0.2, posId = 2, alpha = 1, isDark = false}
}
, 
...
, 
[64] = {content = 640, contentType = 3, speakerHeroId = 1001, speakerHeroPosId = 1, contentShake = true, 
imgTween = {
{imgId = 101, delay = 0, duration = 0, posId = 2, alpha = 0, isDark = false}
, 
{imgId = 101, delay = 0, duration = 0.2, posId = 2, alpha = 1, isDark = false}
...
, 
{imgId = 2, delay = 0.6, duration = 1.2, alpha = 1}
, 
{imgId = 4, delay = 0.6, duration = 1.2, alpha = 1, isDark = true}
}
}
, 
...
, content = 810, contentType = 3, speakerHeroId = 1003, speakerHeroPosId = 2, contentShake = true, 
imgTween = {
...
, 
[86] = {content = 860, contentType = 3, speakerHeroId = 1001, speakerHeroPosId = 1, contentShake = true, 
imgTween = {
{imgId = 103, delay = 0, duration = 0.2, posId = 4, alpha = 1, isDark = true}
, 
{imgId = 101, delay = 0, duration = 0.2, posId = 2, alpha = 1, isDark = false}
...
imgTween = {
{imgId = 2, delay = 0, duration = 0.6, alpha = 0.6, isDark = true}
}
, 
audio = {
sfx = {cue = "AVG_whitenoise", sheet = "AVG_gf"}
...
, 
[105] = {content = 1050, contentType = 3, speakerHeroId = 50, speakerHeroPosId = 2, 
imgTween = {
...
, 
[108] = {content = 1080, contentType = 3, speakerHeroId = 50, speakerHeroPosId = 2, 
imgTween = {
{imgId = 50, delay = 0, duration = 0.2, posId = 3, alpha = 1, isDark = false}
}
}
...
, content = 1100, contentType = 4, speakerName = 11, 
imgTween = {
...
[111] = {
images = {
{imgId = 50, imgType = 3, alpha = 0, imgPath = "odile_w_avg", delete = true}
, 
{imgId = 35, imgType = 3, alpha = 0, imgPath = "wisdom_w_avg"}
}
, content = 1110, contentType = 2, 
audio = {
...
, 
[114] = {content = 1140, contentType = 4, speakerName = 14, scrambleTypeWriter = true}
, 
...
, 
[116] = {content = 1160, contentType = 4, speakerName = 14, scrambleTypeWriter = true, 
imgTween = {
{imgId = 35, delay = 0, duration = 0.2, posId = 3, alpha = 1, isDark = true}
}
}
, 
[117] = {content = 1170, contentType = 3, speakerHeroId = 1, speakerHeroPosId = 2, 
imgTween = {
...
, 
[119] = {content = 1190, contentType = 3, speakerHeroId = 1, speakerHeroPosId = 2, scrambleTypeWriter = true, 
imgTween = {
{imgId = 35, delay = 0, duration = 0, posId = 3, alpha = 0, isDark = false}
, 
{imgId = 35, delay = 0, duration = 0.2, posId = 3, alpha = 1, isDark = false}
...
, 
[121] = {autoContinue = true, isEnd = true, 
imgTween = {
