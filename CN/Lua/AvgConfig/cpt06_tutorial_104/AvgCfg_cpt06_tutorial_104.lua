...
, 
{imgId = 47, duration = 0.6, posId = 3, alpha = 1}
}
, 
heroFace = {
{imgId = 47, faceId = 6}
...
, 
[2] = {content = 20, contentType = 3, speakerHeroId = 47, speakerHeroPosId = 2, contentShake = true, 
imgTween = {
...
, 
[3] = {content = 30, contentType = 3, speakerHeroId = 52, speakerHeroPosId = 2, 
images = {
{imgId = 52, imgType = 3, alpha = 0, imgPath = "love_avg"}
}
, 
imgTween = {
{imgId = 47, duration = 0.2, posId = 3, alpha = 0, shake = true}
, 
...
, 
[4] = {content = 40, contentType = 3, speakerHeroId = 52, speakerHeroPosId = 2, contentShake = true, 
heroFace = {
{imgId = 52, faceId = 2}
}
}
...
imgTween = {
{imgId = 52, duration = 0.2, posId = 3, alpha = 0}
}
}
, 
