...
, 
[8] = {content = 80, contentType = 3, speakerHeroId = 33, contentShake = true, 
heroFace = {
{imgId = 33, faceId = 0}
}
}
...
, 
[10] = {content = 100, contentType = 3, speakerHeroId = 33, contentShake = true, 
imgTween = {
{imgId = 18, delay = 0, duration = 0.2, posId = 3, alpha = 0, isDark = false}
, 
{imgId = 33, delay = 0, duration = 0.2, posId = 3, alpha = 1, isDark = false}
...
imgTween = {
{imgId = 33, delay = 0, duration = 3, posId = 3, dissolve = true, alpha = 0, isDark = false}
}
, 
audio = {
bgm = {stop = true}
...
, 
[12] = {content = 120, contentType = 4, speakerName = 13, scrambleTypeWriter = true, isEnd = true, 
imgTween = {
