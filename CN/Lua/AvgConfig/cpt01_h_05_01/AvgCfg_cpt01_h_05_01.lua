...
[1] = {SkipScenario = 14, bgColor = 2, content = 10, contentType = 1, storyAvgId = 1205, 
images = {
...
, 
audio = {
bgm = {stop = false, cue = "Mus_Story_Exiles", sheet = "Mus_Story_Exiles", fadeIn = 1, fadeOut = 1}
}
}
, 
...
, 
[35] = {content = 350, contentType = 2, isEnd = true}
, 
