...
[1] = {SkipScenario = 14, bgColor = 2, content = 10, contentType = 2, storyAvgId = 6122, 
images = {
{imgId = 1, imgType = 2, alpha = 0, imgPath = "summer/summer_e_bg001_3", fullScreen = true}
, 
{imgId = 2, imgType = 2, alpha = 0, imgPath = "summer/summer_e_cg004_3", fullScreen = true}
, 
{imgId = 3, imgType = 2, alpha = 0, order = 4, imgPath = "summer/summer_e_cg004_2", fullScreen = true}
, 
{imgId = 100, imgType = 2, alpha = 0, order = 5, imgPath = "summer/summer_e_cg004_4", fullScreen = true}
, 
{imgId = 10, imgType = 2, alpha = 0, order = 5, imgPath = "summer/summer_e_bg010", fullScreen = true}
, 
...
, 
imgTween = {
{imgId = 1, delay = 0, duration = 1, alpha = 1, shake = true, shakeIntensity = 2}
}
, 
audio = {
bgm = {stop = true}
...
, 
{imgId = 100, delay = 2, duration = 1, alpha = 1}
, 
{imgId = 2, delay = 0, duration = 0.3, shake = true, shakeIntensity = 2}
, 
{imgId = 10, delay = 0, duration = 1, alpha = 0.6}
, 
{imgId = 10, delay = 2, duration = 1, alpha = 0}
}
, 
audio = {
bgm = {stop = true}
...
, 
[16] = {bgColor = 2, content = 160, contentType = 2, 
imgTween = {
{imgId = 100, delay = 0, duration = 1, alpha = 0}
}
}
, 
...
, 
[19] = {bgColor = 2, content = 190, contentType = 3, speakerHeroId = 52, speakerHeroPosId = 2, 
imgTween = {
...
, 
[20] = {content = 200, contentType = 3, speakerHeroId = 34, speakerHeroPosId = 2, 
imgTween = {
...
{imgId = 1, delay = 0, duration = 1, alpha = 0}
, 
{imgId = 100, delay = 0, duration = 1, alpha = 1}
, 
...
imgTween = {
{imgId = 100, duration = 0.6, alpha = 0}
, 
{imgId = 10, duration = 0.6, alpha = 0}
, 
{imgId = 1, duration = 0.6, delay = 0.6, alpha = 1}
, 
{imgId = 102, delay = 0, duration = 0, posId = 3, alpha = 0, isDark = false}
, 
...
, 
[32] = {content = 320, contentType = 3, speakerHeroId = 34, speakerHeroPosId = 2, 
heroFace = {
{imgId = 34, faceId = 1}
}
}
...
, 
{imgId = 10, delay = 1, duration = 1, alpha = 0.5}
}
}
, 
...
, 
[43] = {content = 430, contentType = 3, speakerHeroId = 34, speakerHeroPosId = 2, 
heroFace = {
{imgId = 34, faceId = 1}
}
}
...
, 
[55] = {content = 550, contentType = 3, speakerHeroId = 1002, speakerHeroPosId = 2, contentShake = true, 
imgTween = {
{imgId = 34, delay = 0, duration = 0.2, posId = 3, alpha = 0, isDark = false}
, 
{imgId = 102, delay = 0, duration = 0, posId = 3, alpha = 0, isDark = false}
...
, 
[61] = {content = 610, contentType = 3, speakerHeroId = 34, speakerHeroPosId = 2, 
imgTween = {
{imgId = 103, delay = 0, duration = 0.2, posId = 3, alpha = 0, isDark = false}
, 
{imgId = 34, delay = 0, duration = 0, posId = 3, alpha = 0, isDark = false}
...
, 
[63] = {content = 630, contentType = 3, speakerHeroId = 1003, speakerHeroPosId = 2, contentShake = true, 
imgTween = {
{imgId = 34, delay = 0, duration = 0.2, posId = 3, alpha = 0, isDark = false}
, 
{imgId = 103, delay = 0, duration = 0, posId = 3, alpha = 0, isDark = false}
...
, 
[66] = {content = 660, contentType = 3, speakerHeroId = 34, speakerHeroPosId = 2, 
heroFace = {
{imgId = 34, faceId = 1}
}
}
