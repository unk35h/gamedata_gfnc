...
images = {
{imgId = 1, imgType = 2, alpha = 0, imgPath = "cpt00/cpt00_e_bg009_11", fullScreen = true}
, 
{imgId = 2, imgType = 2, alpha = 0, imgPath = "cpt00/cpt00_e_bg009_1", fullScreen = true, order = 3}
, 
...
imgTween = {
{imgId = 1, delay = 0, duration = 1.5, alpha = 1, isDark = true}
, 
{imgId = 1, delay = 1.5, duration = 1.5, alpha = 1, isDark = false}
, 
{imgId = 102, delay = 0, duration = 0, posId = 3, alpha = 0, isDark = true}
, 
{imgId = 102, delay = 3, duration = 0.6, posId = 3, alpha = 1, isDark = true}
}
, 
audio = {
...
, 
{content = 52, jumpAct = 9}
, 
{content = 53, jumpAct = 11}
}
}
, 
...
imgTween = {
{imgId = 2, delay = 0, duration = 1.5, alpha = 1}
}
}
, 
...
, 
[25] = {content = 250, contentType = 4, speakerName = 11, nextId = 29}
, 
...
, 
{imgId = 1, imgType = 2, alpha = 0, imgPath = "cpt00/cpt00_e_bg009_11", fullScreen = true, delete = true}
}
, 
imgTween = {
...
, 
[60] = {content = 600, contentType = 3, speakerHeroId = 72, speakerHeroPosId = 2, 
imgTween = {
...
, 
{content = 622, jumpAct = 65}
, 
{content = 623, jumpAct = 67}
}
}
, 
...
, 
[66] = {content = 660, contentType = 3, speakerHeroId = 1004, speakerHeroPosId = 2, nextId = 68}
, 
...
, 
[72] = {content = 720, contentType = 3, speakerHeroId = 1006, speakerHeroPosId = 3, 
imgTween = {
...
, 
[74] = {content = 740, contentType = 3, speakerHeroId = 1008, speakerHeroPosId = 3, 
imgTween = {
...
, 
[75] = {content = 750, contentType = 3, speakerHeroId = 1009, speakerHeroPosId = 1, 
imgTween = {
...
, 
[76] = {content = 760, contentType = 3, speakerHeroId = 1010, speakerHeroPosId = 3, 
imgTween = {
...
, 
[85] = {content = 850, contentType = 4, speakerName = 15, 
imgTween = {
