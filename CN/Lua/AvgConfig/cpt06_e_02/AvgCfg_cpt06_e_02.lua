...
[1] = {SkipScenario = 12, bgColor = 2, content = 10, contentType = 2, storyAvgId = 6102, 
images = {
{imgId = 1, imgType = 2, alpha = 0, order = 2, imgPath = "summer/summer_e_bg002_3", 
scale = {1.4, 1.4, 1.4}
, fullScreen = true}
, 
{imgId = 2, imgType = 2, alpha = 0, imgPath = "summer/summer_e_bg002_5", fullScreen = true}
, 
...
, 
{imgId = 3, imgType = 2, alpha = 0, order = 1, imgPath = "summer/summer_e_bg002_4", 
scale = {1.4, 1.4, 1.4}
, fullScreen = true}
, 
{imgId = 4, imgType = 2, alpha = 0, imgPath = "cpt00/cpt00_e_bg001", fullScreen = true, order = 2}
}
, 
imgTween = {
{imgId = 3, delay = 0, duration = 0.5, alpha = 1, isDark = true}
, 
{imgId = 3, delay = 0.5, duration = 2, alpha = 1, 
pos = {0, 100, 0}
, isDark = false}
, 
{imgId = 3, delay = 2, duration = 2, alpha = 1, 
pos = {0, 50, 0}
, isDark = false}
, 
{imgId = 1, delay = 0, duration = 0.5, alpha = 1, isDark = true}
, 
{imgId = 1, delay = 0.2, duration = 1, alpha = 0, isDark = true}
}
, 
audio = {
...
imgTween = {
{imgId = 3, delay = 0, duration = 0, alpha = 0, isDark = true}
, 
...
, 
[12] = {content = 120, contentType = 3, speakerHeroId = 1002, speakerHeroPosId = 1, contentShake = true, 
imgTween = {
...
, 
[26] = {content = 260, contentType = 3, speakerHeroId = 1002, speakerHeroPosId = 2, contentShake = true}
, 
...
imgTween = {
{imgId = 3, delay = 0, duration = 1.5, alpha = 0.2, 
pos = {0, 200, 0}
, isDark = true}
}
, 
...
, 
[32] = {content = 320, contentType = 4, speakerName = 31, contentShake = true}
, 
...
, 
imgTween = {
{imgId = 3, delay = 0, duration = 1.5, alpha = 0.5, 
pos = {0, 175, 0}
, isDark = true}
}
}
...
imgTween = {
{imgId = 3, delay = 0, duration = 3, 
pos = {0, -150, 0}
, alpha = 1}
, 
{imgId = 1, delay = 0, duration = 3, 
pos = {0, -180, 0}
, alpha = 1}
, 
{imgId = 1, delay = 3.5, duration = 0.5, 
pos = {0, -160, 0}
, alpha = 1}
}
}
...
, 
[43] = {content = 430, contentType = 3, speakerHeroId = 1002, speakerHeroPosId = 1, contentShake = true, 
imgTween = {
...
, 
[45] = {content = 450, contentType = 3, speakerHeroId = 1002, speakerHeroPosId = 1, contentShake = true, 
imgTween = {
{imgId = 103, delay = 0, duration = 0.2, posId = 4, alpha = 1, isDark = true}
, 
{imgId = 102, delay = 0, duration = 0.2, posId = 2, alpha = 1, isDark = false}
...
, 
[48] = {autoContinue = true, vedioPath = "avg/dls", 
imgTween = {
...
, 
[58] = {content = 580, contentType = 3, speakerHeroId = 1, speakerHeroPosId = 2, contentShake = true, 
imgTween = {
{imgId = 151, delay = 0, duration = 0, posId = 3, alpha = 0, isDark = false}
, 
...
, 
[77] = {content = 770, contentType = 3, speakerHeroId = 1, speakerHeroPosId = 2, 
imgTween = {
{imgId = 103, delay = 0, duration = 0.2, posId = 3, alpha = 0, isDark = false}
, 
{imgId = 151, delay = 0, duration = 0, posId = 3, alpha = 0, isDark = false}
...
, 
[84] = {content = 840, contentType = 3, speakerHeroId = 1002, speakerHeroPosId = 2, contentShake = true, 
imgTween = {
{imgId = 102, delay = 0, duration = 0, posId = 3, alpha = 0, isDark = false}
, 
{imgId = 102, delay = 0, duration = 0.2, posId = 3, alpha = 1, isDark = false}
...
, 
[114] = {content = 1140, contentType = 3, speakerHeroId = 1001, speakerHeroPosId = 2, 
heroFace = {
{imgId = 101, faceId = 9}
}
}
