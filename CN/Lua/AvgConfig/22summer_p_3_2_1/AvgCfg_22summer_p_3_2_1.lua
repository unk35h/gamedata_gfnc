...
, 
{imgId = 10, imgType = 2, alpha = 0, imgPath = "cpt05/cpt05_e_bg005", order = 6, fullScreen = true}
, 
{imgId = 11, imgType = 2, alpha = 0, imgPath = "cpt00/cpt00_e_cg015", order = 4, fullScreen = true}
, 
{imgId = 12, imgType = 2, alpha = 0, imgPath = "cpt00/cpt00_e_cg015_2", order = 5, fullScreen = true}
, 
...
, 
[3] = {content = 30, contentType = 3, speakerHeroId = 18, contentShake = true, 
images = {
...
, 
[7] = {content = 70, contentType = 3, speakerHeroId = 1003, speakerHeroPosId = 1, contentShake = true, 
images = {
{imgId = 18, imgType = 3, alpha = 0, imgPath = "hannah_avg", comm = true}
}
, 
...
, 
[22] = {content = 220, contentType = 4, speakerName = 12, scrambleTypeWriter = true, 
audio = {
sfx = {cue = "AVG_ElecSpace", sheet = "AVG_gf"}
}
, 
...
, 
[24] = {content = 240, contentType = 3, speakerHeroId = 18, contentShake = true, 
images = {
{imgId = 18, imgType = 3, alpha = 0, imgPath = "hannah_avg", comm = true}
}
, 
...
, 
[25] = {content = 250, contentType = 3, speakerHeroId = 18, contentShake = true, 
heroFace = {
{imgId = 18, faceId = 11}
}
}
...
, 
[29] = {content = 290, contentType = 4, speakerName = 282, contentShake = true, 
audio = {
bgm = {stop = true}
}
}
, 
[30] = {bgColor = 3, content = 300, contentType = 2, 
imgTween = {
{imgId = 12, delay = 0, duration = 1, alpha = 1}
, 
{imgId = 11, delay = 1, duration = 0, alpha = 0}
, 
{imgId = 12, delay = 1, duration = 1, alpha = 0}
}
, 
audio = {
sfx = {cue = "AVG_Explode", sheet = "AVG_gf"}
