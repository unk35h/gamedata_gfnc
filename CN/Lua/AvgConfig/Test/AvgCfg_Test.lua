...
, 
[-1] = {SkipScenario = 1, storyAvgId = 1, bgColor = 1, 
images = {
{imgId = 1, imgPath = "", imgPathBoy = "", imgType = 1, order = 0, fullScreen = true, posId = 1, 
pos = {0, 0, 0}
, 
rot = {0, 0, 0}
, 
scale = {1, 1, 1}
, alpha = 1, isDark = false, comm = true, ripple = true, delete = false}
}
, 
imgTween = {
