...
, 
images = {
{imgId = 101, imgType = 3, alpha = 0, imgPath = "simo_avg", 
rot = {0, 180, 0}
}
, 
{imgId = 102, imgType = 3, alpha = 0, imgPath = "simo_shadow_avg", 
rot = {0, 180, 0}
}
}
...
, 
{imgId = 102, delay = 0, duration = 0.6, posId = 4, alpha = 0.75, isDark = false}
}
}
, 
...
{imgId = 101, delay = 0, duration = 0.2, posId = 2, alpha = 1, isDark = true}
, 
{imgId = 102, delay = 0, duration = 0.2, posId = 4, alpha = 0.75, isDark = false}
}
}
, 
