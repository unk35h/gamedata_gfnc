...
[1] = {bgColor = 2, content = 10, contentType = 3, speakerHeroId = 33, 
images = {
...
, 
[3] = {content = 30, contentType = 3, speakerHeroId = 33, 
imgTween = {
...
, 
[4] = {content = 40, contentType = 3, speakerHeroId = 33, 
heroFace = {
{imgId = 33, faceId = 1}
}
}
, 
[5] = {content = 50, contentType = 3, speakerHeroId = 33, contentShake = true, 
heroFace = {
{imgId = 33, faceId = 4}
}
}
...
, 
[7] = {content = 70, contentType = 3, speakerHeroId = 33, contentShake = true, 
imgTween = {
...
, 
[10] = {content = 100, contentType = 3, speakerHeroId = 33, 
imgTween = {
{imgId = 33, delay = 0, duration = 0.2, posId = 3, alpha = 1, isDark = false}
}
, 
...
, 
[13] = {content = 130, contentType = 3, speakerHeroId = 33, 
imgTween = {
{imgId = 33, delay = 0, duration = 0.2, posId = 3, alpha = 1, shake = true, isDark = false}
, 
{imgId = 33, delay = 0.6, duration = 0.2, posId = 3, alpha = 1, shake = true, isDark = false}
...
, 
[14] = {content = 140, contentType = 3, speakerHeroId = 18, 
imgTween = {
{imgId = 33, delay = 0, duration = 0.2, posId = 3, alpha = 0, isDark = false}
, 
{imgId = 18, delay = 0, duration = 0.2, posId = 3, alpha = 1, isDark = false}
...
, 
audio = {
bgm = {stop = false, cue = "Mus_EV22Summer_Rossum", sheet = "Mus_EV22Summer_Rossum", fadeIn = 3, fadeOut = 1}
}
, 
heroFace = {
{imgId = 18, faceId = 5}
...
, 
[15] = {content = 150, contentType = 3, speakerHeroId = 18}
, 
...
, content = 170, contentType = 3, speakerHeroId = 18, 
imgTween = {
...
, content = 270, contentType = 3, speakerHeroId = 18, 
imgTween = {
{imgId = 1, delay = 0, duration = 0.6, alpha = 1}
, 
{imgId = 18, delay = 0, duration = 0, posId = 3, alpha = 0, isDark = false}
...
, 
[28] = {content = 280, contentType = 3, speakerHeroId = 33, 
imgTween = {
{imgId = 18, delay = 0, duration = 0.2, posId = 3, alpha = 0, isDark = false}
, 
{imgId = 33, delay = 0, duration = 0.2, posId = 3, alpha = 1, isDark = false}
...
, 
[30] = {content = 300, contentType = 3, speakerHeroId = 18, 
imgTween = {
...
, 
[33] = {content = 330, contentType = 3, speakerHeroId = 33, 
imgTween = {
{imgId = 33, delay = 0, duration = 0.2, posId = 3, alpha = 1, isDark = false}
}
}
, 
[34] = {content = 340, contentType = 3, speakerHeroId = 18, contentShake = true, 
imgTween = {
{imgId = 33, delay = 0, duration = 0.2, posId = 3, alpha = 0, isDark = false}
, 
{imgId = 18, delay = 0, duration = 0.2, posId = 3, alpha = 1, shake = true, isDark = false}
...
, 
[35] = {content = 350, contentType = 3, speakerHeroId = 33, contentShake = true, 
imgTween = {
{imgId = 18, delay = 0, duration = 0.2, posId = 3, alpha = 0, isDark = false}
, 
{imgId = 33, delay = 0, duration = 0.2, posId = 3, alpha = 1, shake = true, isDark = false}
...
, 
[37] = {content = 370, contentType = 3, speakerHeroId = 1003, contentShake = true, 
imgTween = {
