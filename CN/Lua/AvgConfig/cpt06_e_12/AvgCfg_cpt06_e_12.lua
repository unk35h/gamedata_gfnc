...
[1] = {SkipScenario = 14, bgColor = 2, content = 10, contentType = 3, speakerHeroId = 1003, speakerHeroPosId = 2, storyAvgId = 6117, 
images = {
...
, 
{imgId = 3, imgType = 2, alpha = 0, imgPath = "cpt03/cpt03_e_bg001_2", fullScreen = true}
, 
...
, 
[19] = {content = 190, contentType = 4, speakerName = 11, nextId = 21}
, 
...
, 
[29] = {content = 290, contentType = 3, speakerHeroId = 1001, speakerHeroPosId = 2, contentShake = true, 
heroFace = {
{imgId = 101, faceId = 8}
}
}
...
, 
[31] = {content = 310, contentType = 3, speakerHeroId = 1051, speakerHeroPosId = 2}
, 
...
, 
[35] = {content = 350, contentType = 3, speakerHeroId = 1001, speakerHeroPosId = 2, contentShake = true, 
imgTween = {
{imgId = 101, delay = 0, duration = 0.2, posId = 3, alpha = 1, isDark = false}
}
, 
...
, 
[48] = {content = 480, contentType = 3, speakerHeroId = 1003, speakerHeroPosId = 3, contentShake = true, 
imgTween = {
{imgId = 102, delay = 0, duration = 0.2, posId = 2, alpha = 1, isDark = true}
, 
{imgId = 103, delay = 0, duration = 0.2, posId = 4, alpha = 1, isDark = false}
...
, 
[50] = {content = 500, contentType = 3, speakerHeroId = 1003, speakerHeroPosId = 2, contentShake = true, 
imgTween = {
{imgId = 102, delay = 0, duration = 0.2, posId = 2, alpha = 0, isDark = true}
, 
...
, 
[52] = {content = 520, contentType = 4, speakerName = 13, contentShake = true, 
imgTween = {
{imgId = 3, delay = 0, duration = 1, alpha = 1}
, 
{imgId = 114, delay = 0, duration = 0, posId = 3, alpha = 0, isDark = false}
, 
{imgId = 114, delay = 1, duration = 0.2, posId = 3, alpha = 1, shake = true, isDark = false}
, 
...
imgTween = {
{imgId = 10, delay = 0, duration = 0.5, alpha = 0, isDark = false}
}
, 
audio = {
...
, 
[79] = {content = 790, contentType = 3, speakerHeroId = 1003, speakerHeroPosId = 2}
, 
[80] = {content = 800, contentType = 3, speakerHeroId = 1002, speakerHeroPosId = 1, 
images = {
{imgId = 102, imgType = 3, alpha = 0, imgPath = "anna_avg", comm = true, order = 10}
}
, 
imgTween = {
...
images = {
{imgId = 1, imgType = 2, alpha = 0, imgPath = "summer/summer_e_bg003", fullScreen = true, delete = true}
, 
{imgId = 2, imgType = 2, alpha = 0, imgPath = "cpt04/cpt04_e_bg002", fullScreen = true, delete = true}
, 
{imgId = 4, imgType = 2, alpha = 0, imgPath = "summer/summer_e_bg001_2", fullScreen = true}
, 
{imgId = 5, imgType = 2, alpha = 0, order = 6, imgPath = "summer/summer_e_bg002_5", fullScreen = true}
, 
...
, 
[109] = {content = 1090, contentType = 3, speakerHeroId = 1003, speakerHeroPosId = 3}
, 
