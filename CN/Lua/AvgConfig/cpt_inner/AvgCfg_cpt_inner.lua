...
images = {
{imgId = 28, imgType = 3, alpha = 0, imgPath = "neumann_avg", comm = true}
}
, 
imgTween = {
...
, 
{imgId = 28, delay = 0, duration = 0.6, posId = 4, alpha = 1, isDark = false}
}
, 
audio = {
...
, 
[23] = {content = 230, contentType = 3, speakerHeroId = 28, speakerHeroPosId = 3, 
imgTween = {
{imgId = 28, delay = 0, duration = 0.2, posId = 4, alpha = 1, isDark = false}
}
, 
...
, 
[24] = {content = 240, contentType = 3, speakerHeroId = 28, speakerHeroPosId = 3}
, 
[25] = {content = 250, contentType = 3, speakerHeroId = 28, speakerHeroPosId = 3}
, 
[25] = {autoContinue = true, isEnd = true, 
images = {
{imgId = 28, imgType = 3, alpha = 0, imgPath = "neumann_avg", delete = true}
}
, 
imgTween = {
