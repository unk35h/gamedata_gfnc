...
, 
{imgId = 2, imgType = 2, alpha = 0, imgPath = "cpt00/cpt00_e_cg027_5", imgPathBoy = "cpt00/cpt00_e_cg027_4", fullScreen = true}
, 
{imgId = 3, imgType = 2, alpha = 0, imgPath = "cpt00/cpt00_e_cg027", fullScreen = true}
, 
...
, 
[2] = {content = 20, contentType = 3, speakerHeroId = 26, 
imgTween = {
...
imgTween = {
{imgId = 26, delay = 0, duration = 0.6, posId = 3, alpha = 0, isDark = true}
}
}
, 
[5] = {content = 50, contentType = 3, speakerHeroId = 26, 
imgTween = {
...
, 
[8] = {content = 80, contentType = 3, speakerHeroId = 16, 
imgTween = {
