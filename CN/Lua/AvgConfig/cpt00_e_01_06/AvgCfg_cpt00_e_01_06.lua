...
[1] = {autoContinue = true, bgColor = 1, SkipScenario = 11, storyAvgId = 14}
, 
[2] = {content = 20, contentType = 3, speakerHeroId = 1005, speakerHeroPosId = 3, 
images = {
{imgId = 4, imgType = 5, alpha = 0, imgPath = "avg/cpt00_field", comm = true}
, 
...
, 
{imgId = 105, delay = 0, duration = 0, posId = 4, alpha = 1, isDark = true}
}
, 
heroFace = {
{imgId = 101, faceId = 4}
...
, 
[46] = {content = 460, contentType = 4, speakerName = 451}
, 
