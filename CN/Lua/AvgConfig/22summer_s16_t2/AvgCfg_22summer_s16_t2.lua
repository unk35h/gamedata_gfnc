...
[1] = {bgColor = 3, content = 10, contentType = 3, speakerHeroId = 18, contentShake = true, 
images = {
{imgId = 1, imgType = 2, alpha = 0, imgPath = "cpt01/cpt01_e_bg004_2", fullScreen = true}
, 
{imgId = 18, imgType = 3, alpha = 0, imgPath = "hannah_avg"}
, 
{imgId = 181, imgType = 3, alpha = 0, imgPath = "42lab_npc_01_avg"}
, 
...
, 
{imgId = 18, delay = 0, duration = 0.6, posId = 3, alpha = 1, shake = true, isDark = false}
}
, 
audio = {
...
, 
[2] = {content = 20, contentType = 3, speakerHeroId = 16, 
imgTween = {
...
, 
[3] = {content = 30, contentType = 3, speakerHeroId = 16}
, 
[4] = {content = 40, contentType = 3, speakerHeroId = 16}
, 
...
, 
[6] = {content = 60, contentType = 3, speakerHeroId = 18, 
imgTween = {
...
, 
[8] = {content = 80, contentType = 3, speakerHeroId = 18, contentShake = true, 
imgTween = {
{imgId = 181, delay = 0, duration = 0, posId = 3, alpha = 1, isDark = false}
, 
{imgId = 181, delay = 0, duration = 0.2, posId = 3, alpha = 1, isDark = false, shake = true, shakeIntensity = 4}
}
, 
heroFace = {
{imgId = 181, faceId = 8}
