...
, SkipScenario = 22, bgColor = 2, content = 10, contentType = 2, storyAvgId = 5112, 
images = {
...
, 
{imgId = 5, imgType = 2, alpha = 0, imgPath = "cpt05/cpt05_e_bg008", fullScreen = true}
, 
...
, isEnd = true}
, 
[101] = {content = 11, contentType = 4, speakerName = 19, 
imgTween = {
{imgId = 4, delay = 0, duration = 1, alpha = 1}
}
}
, 
[102] = {content = 12, contentType = 4, speakerName = 19}
, 
[103] = {
effect = {
effect1 = {prefabName = "avg/FXP_Scene"}
}
, content = 13, contentType = 2, 
imgTween = {
{imgId = 5, delay = 0, duration = 2, alpha = 0.5}
}
}
, 
[104] = {content = 14, contentType = 2, 
imgTween = {
