...
[1] = {SkipScenario = 15, bgColor = 2, content = 10, contentType = 1, storyAvgId = 4110, 
images = {
...
, 
{imgId = 3, imgType = 2, alpha = 0, imgPath = "cpt04/cpt04_e_bg008_2", fullScreen = true}
, 
...
, 
[2] = {content = 20, contentType = 4, speakerName = 13, scrambleTypeWriter = true, 
imgTween = {
{imgId = 29, delay = 0, duration = 0, posId = 3, alpha = 0, isDark = false}
}
, 
audio = {
bgm = {stop = false, cue = "Mus_Story_Sad", sheet = "Mus_Story_Sad", fadeIn = 3, fadeOut = 2}
}
}
, 
[3] = {content = 30, contentType = 4, speakerName = 13, scrambleTypeWriter = true}
, 
...
, 
{imgId = 41, delay = 2, duration = 0.6, posId = 3, alpha = 1, isDark = false}
}
, 
audio = {
bgm = {stop = true}
...
, 
[19] = {content = 190, contentType = 4, speakerName = 13, scrambleTypeWriter = true, 
imgTween = {
{imgId = 101, delay = 0, duration = 0.2, posId = 3, alpha = 1, isDark = true}
}
}
, 
[20] = {content = 200, contentType = 4, speakerName = 13, scrambleTypeWriter = true}
, 
...
, 
[23] = {content = 230, contentType = 4, speakerName = 13, scrambleTypeWriter = true, 
imgTween = {
{imgId = 101, delay = 0, duration = 0.2, posId = 3, alpha = 1, isDark = true}
}
}
, 
[24] = {content = 240, contentType = 4, speakerName = 13, scrambleTypeWriter = true}
, 
...
, 
[28] = {content = 280, contentType = 4, speakerName = 13, scrambleTypeWriter = true, 
imgTween = {
{imgId = 101, delay = 0, duration = 0.2, posId = 3, alpha = 1, isDark = true}
}
}
, 
[29] = {content = 290, contentType = 4, speakerName = 13, scrambleTypeWriter = true}
, 
...
, 
[31] = {content = 310, contentType = 4, speakerName = 13, scrambleTypeWriter = true, 
imgTween = {
{imgId = 101, delay = 0, duration = 0.2, posId = 3, alpha = 1, isDark = true}
}
}
, 
[32] = {content = 320, contentType = 4, speakerName = 13, scrambleTypeWriter = true}
, 
...
, 
[36] = {content = 360, contentType = 4, speakerName = 13, scrambleTypeWriter = true}
, 
[37] = {content = 370, contentType = 2}
, 
[38] = {content = 380, contentType = 4, speakerName = 13, scrambleTypeWriter = true}
, 
[39] = {content = 390, contentType = 4, speakerName = 13, scrambleTypeWriter = true}
, 
[40] = {content = 400, contentType = 4, speakerName = 13, scrambleTypeWriter = true}
, 
...
, 
[43] = {content = 430, contentType = 4, speakerName = 13, scrambleTypeWriter = true, 
imgTween = {
{imgId = 101, delay = 0, duration = 0.2, posId = 3, alpha = 0, isDark = false}
}
}
...
, 
imgTween = {
{imgId = 1, delay = 0, duration = 0.5, alpha = 0.5}
}
, nextId = 101}
, 
...
[47] = {
images = {
{imgId = 3, imgType = 2, alpha = 0, imgPath = "cpt04/cpt04_e_bg008_2", fullScreen = true, delete = true}
, 
{imgId = 10, imgType = 2, alpha = 0, imgPath = "cpt04/cpt04_e_bg001_2", fullScreen = true}
}
...
images = {
{imgId = 1, imgType = 2, alpha = 0, imgPath = "cpt04/cpt04_e_bg007", fullScreen = true, delete = true}
, 
{imgId = 5, imgType = 2, alpha = 0, imgPath = "cpt04/cpt04_e_bg008", fullScreen = true}
}
, 
imgTween = {
...
, 
[57] = {content = 570, contentType = 3, speakerHeroId = 1001, speakerHeroPosId = 2, contentShake = true, 
imgTween = {
{imgId = 101, delay = 0, duration = 0, posId = 3, alpha = 0, isDark = false}
, 
{imgId = 101, delay = 0, duration = 0.2, posId = 3, alpha = 1, isDark = false}
...
, 
[101] = {content = 441, contentType = 4, speakerName = 13, scrambleTypeWriter = true}
, 
[102] = {content = 442, contentType = 4, speakerName = 13, scrambleTypeWriter = true}
, 
[103] = {content = 443, contentType = 4, speakerName = 14}
, 
[104] = {content = 444, contentType = 4, speakerName = 14}
, 
[105] = {content = 445, contentType = 4, speakerName = 13, scrambleTypeWriter = true}
, 
[106] = {content = 446, contentType = 4, speakerName = 14, nextId = 45}
}
