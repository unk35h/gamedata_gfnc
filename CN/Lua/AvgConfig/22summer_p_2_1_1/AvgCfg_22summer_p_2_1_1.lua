...
[1] = {SkipScenario = 14, storyAvgId = 1400101, bgColor = 2, content = 10, contentType = 1, 
images = {
...
imgTween = {
{imgId = 1, delay = 0, duration = 0.2, alpha = 1}
, 
...
, 
[28] = {content = 280, contentType = 3, speakerHeroId = 1002, 
heroFace = {
{imgId = 102, faceId = 11}
}
}
...
, 
{imgId = 10, delay = 1, duration = 0.6, alpha = 1}
}
}
, 
...
images = {
{imgId = 18, imgType = 3, alpha = 0, imgPath = "42lab_npc_01_avg", comm = true}
}
, 
imgTween = {
...
, 
[47] = {content = 470, contentType = 3, speakerHeroId = 18, speakerHeroPosId = 3, 
imgTween = {
{imgId = 18, delay = 0, duration = 0.2, posId = 4, alpha = 1, isDark = true}
, 
{imgId = 18, delay = 3, duration = 0.2, posId = 4, alpha = 0, isDark = true}
, 
...
, 
{imgId = 4, delay = 1.8, duration = 0.6, alpha = 0}
, 
{imgId = 5, delay = 2.4, duration = 0.6, alpha = 1}
, 
{imgId = 5, delay = 3, duration = 0.6, alpha = 0}
}
, 
audio = {
...
, 
[49] = {content = 490, contentType = 3, speakerHeroId = 1002, 
images = {
{imgId = 18, imgType = 3, alpha = 0, imgPath = "42lab_npc_01_avg", delete = true}
, 
{imgId = 3, imgType = 2, alpha = 0, imgPath = "cpt06/cpt06_e_ef001", fullScreen = true, delete = true}
, 
{imgId = 4, imgType = 2, alpha = 0, imgPath = "cpt06/cpt06_e_ef002", fullScreen = true, delete = true}
, 
{imgId = 5, imgType = 2, alpha = 0, imgPath = "cpt06/cpt06_e_ef003", fullScreen = true, delete = true}
}
, 
imgTween = {
...
, content = 510, contentType = 3, speakerHeroId = 1002, 
images = {
...
, 
[53] = {content = 530, contentType = 3, speakerHeroId = 1002, 
imgTween = {
{imgId = 102, delay = 0, duration = 0.2, posId = 3, alpha = 1, isDark = false}
}
, 
...
, 
[62] = {content = 620, contentType = 3, speakerHeroId = 1003, speakerHeroPosId = 1, 
imgTween = {
...
, 
[66] = {content = 660, contentType = 3, speakerHeroId = 1005, speakerHeroPosId = 3, contentShake = true, 
imgTween = {
...
, 
{imgId = 3, imgType = 2, alpha = 0, imgPath = "cpt05/cpt05_e_cg001", fullScreen = true}
, 
{imgId = 4, imgType = 2, alpha = 0, imgPath = "summer/summer_e_cg002", fullScreen = true}
, 
{imgId = 5, imgType = 2, alpha = 0, imgPath = "summer/summer_e_bg001_2", fullScreen = true}
, 
...
, 
{imgId = 5, delay = 0.6, duration = 0.6, alpha = 1, isDark = false}
, 
{imgId = 52, delay = 0, duration = 0, posId = 3, alpha = 0, isDark = true}
, 
{imgId = 52, delay = 1.2, duration = 0.2, posId = 3, alpha = 1, isDark = true}
}
, nextId = 302}
, 
[78] = {
...
, content = 780, contentType = 3, speakerHeroId = 1003, 
images = {
{imgId = 2, imgType = 2, alpha = 0, imgPath = "cpt05/cpt05_e_bg001_2", fullScreen = true, delete = true}
, 
{imgId = 3, imgType = 2, alpha = 0, imgPath = "cpt05/cpt05_e_cg001", fullScreen = true, delete = true}
, 
{imgId = 4, imgType = 2, alpha = 0, imgPath = "summer/summer_e_cg002", fullScreen = true, delete = true}
, 
{imgId = 5, imgType = 2, alpha = 0, imgPath = "summer/summer_e_bg001_2", fullScreen = true}
, 
{imgId = 52, imgType = 3, alpha = 0, imgPath = "love_avg"}
...
images = {
{imgId = 5, imgType = 2, alpha = 0, imgPath = "summer/summer_e_bg001_2", fullScreen = true, delete = true}
, 
{imgId = 52, imgType = 3, alpha = 0, imgPath = "love_avg", delete = true}
, 
{imgId = 6, imgType = 2, alpha = 0, imgPath = "cpt07/cpt07_e_cg003", fullScreen = true}
, 
{imgId = 7, imgType = 2, alpha = 0, imgPath = "cpt07/cpt07_e_cg003_2", order = 5, fullScreen = true}
}
, 
imgTween = {
...
images = {
{imgId = 6, imgType = 2, alpha = 0, imgPath = "cpt07/cpt07_e_cg003", fullScreen = true, delete = true}
, 
{imgId = 7, imgType = 2, alpha = 0, imgPath = "cpt07/cpt07_e_cg003_2", fullScreen = true, delete = true}
}
, 
heroFace = {
{imgId = 105, faceId = 2}
...
, 
[89] = {content = 890, contentType = 3, speakerHeroId = 1003, 
imgTween = {
{imgId = 103, delay = 0, duration = 0, posId = 3, alpha = 0, isDark = false}
, 
...
, 
[98] = {content = 980, contentType = 4, speakerName = 11, isEnd = true}
, 
...
, nextId = 45, autoContinue = true, 
images = {
{imgId = 2, imgType = 2, alpha = 0, imgPath = "cpt00/cpt00_e_bg018", fullScreen = true}
, 
{imgId = 3, imgType = 2, alpha = 0, order = 5, imgPath = "cpt06/cpt06_e_ef001", fullScreen = true}
, 
{imgId = 4, imgType = 2, alpha = 0, order = 5, imgPath = "cpt06/cpt06_e_ef002", fullScreen = true}
, 
{imgId = 5, imgType = 2, alpha = 0, order = 5, imgPath = "cpt06/cpt06_e_ef003", fullScreen = true}
}
, 
imgTween = {
{imgId = 2, delay = 0, duration = 0.6, alpha = 1}
