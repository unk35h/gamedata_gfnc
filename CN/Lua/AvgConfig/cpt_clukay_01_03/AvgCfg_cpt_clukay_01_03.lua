...
, 
{imgId = 2, imgType = 2, alpha = 0, imgPath = "cpt00/cpt00_e_cg016", fullScreen = true}
, 
...
{imgId = 166, delay = 0, duration = 0.2, posId = 3, alpha = 1, isDark = false}
, 
{imgId = 166, delay = 0.2, duration = 0.3, posId = 3, alpha = 1, isDark = true}
, 
{imgId = 166, delay = 0.5, duration = 0.3, posId = 3, alpha = 1, isDark = false}
}
, 
heroFace = {
{imgId = 166, faceId = 5}
...
, 
[30] = {content = 300, contentType = 3, speakerHeroId = 1066, speakerHeroPosId = 3, 
imgTween = {
...
, content = 340, contentType = 4, speakerName = 12, contentShake = true, 
imgTween = {
...
, 
[36] = {content = 360, contentType = 4, speakerName = 12, contentShake = true}
, 
...
, 
[41] = {content = 410, contentType = 4, speakerName = 12, nextId = 101}
, 
...
, 
[45] = {content = 450, contentType = 3, speakerHeroId = 1066, speakerHeroPosId = 3, 
imgTween = {
{imgId = 101, delay = 0, duration = 0.2, posId = 2, alpha = 1, isDark = true}
, 
{imgId = 166, delay = 0, duration = 0.2, posId = 4, alpha = 1, isDark = false}
...
, 
{imgId = 166, delay = 0.6, duration = 0.2, posId = 3, alpha = 1, isDark = true}
}
, nextId = 42}
}
