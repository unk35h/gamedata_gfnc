...
[1] = {bgColor = 2, content = 10, contentType = 1, scrambleTypeWriter = true, 
ppv = {
...
, SkipScenario = 12, 
images = {
{imgId = 1, imgType = 2, alpha = 0, imgPath = "cpt00/cpt00_e_cg027_5", imgPathBoy = "cpt00/cpt00_e_cg027_4", fullScreen = true}
, 
{imgId = 2, imgType = 2, alpha = 0, imgPath = "cpt00/cpt00_e_bg007_2", fullScreen = true, order = 5}
, 
...
images = {
{imgId = 102, imgType = 3, alpha = 0, imgPath = "croque_avg", comm = true}
}
, 
imgTween = {
...
, 
{imgId = 102, delay = 0, duration = 0, posId = 4, alpha = 0}
, 
...
imgTween = {
{imgId = 101, delay = 0, duration = 0.2, posId = 2, alpha = 1, isDark = false, shake = true, shakeIntensity = 3}
, 
...
images = {
{imgId = 102, imgType = 3, alpha = 0, imgPath = "croque_avg", delete = true}
}
, 
imgTween = {
{imgId = 101, delay = 0, duration = 0.6, posId = 3, alpha = 1, isDark = false}
, 
{imgId = 101, delay = 0.6, duration = 0.6, 
pos = {0, 100, 0}
, 
scale = {1.2, 1.2, 1.2}
, alpha = 0.8, isDark = false}
, 
{imgId = 101, delay = 1.2, duration = 0.6, posId = 3, 
scale = {1, 1, 1}
, alpha = 10.8, isDark = false}
}
, 
effect = {
effect2 = {prefabName = "avg/FXP_smook", layer = 2, 
pos = {0, -150, 0}
}
}
}
...
imgTween = {
{imgId = 101, delay = 0, duration = 2, posId = 3, alpha = 1, isDark = false, dissolve = true}
}
, 
branch = {
...
, 
[8] = {content = 80, contentType = 2, nextId = 10}
, 
...
, 
[11] = {bgColor = 3, autoContinue = true, isEnd = true, 
imgTween = {
