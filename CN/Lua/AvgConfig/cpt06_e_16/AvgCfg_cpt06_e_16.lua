...
[1] = {SkipScenario = 15, bgColor = 2, content = 10, contentType = 2, storyAvgId = 6121, 
images = {
{imgId = 1, imgType = 2, alpha = 0, imgPath = "summer/summer_e_bg001_2", fullScreen = true}
, 
{imgId = 2, imgType = 2, alpha = 0, imgPath = "summer/summer_e_bg001_4", fullScreen = true}
, 
{imgId = 3, imgType = 2, alpha = 0, order = 4, imgPath = "summer/summer_e_bg006", fullScreen = true}
, 
{imgId = 4, imgType = 2, alpha = 0, order = 5, imgPath = "summer/summer_e_cg002", fullScreen = true}
, 
...
, 
sfx = {cue = "AVG_Amb_Rain", sheet = "AVG_gf", audioId = 1}
}
}
, 
...
{imgId = 102, delay = 0, duration = 0, posId = 2, alpha = 0, isDark = true}
, 
{imgId = 102, delay = 1.3, duration = 0.2, posId = 2, alpha = 1, isDark = true}
}
, 
heroFace = {
{imgId = 103, faceId = 4}
...
, 
[8] = {content = 80, contentType = 3, speakerHeroId = 1003, speakerHeroPosId = 3, contentShake = true, 
imgTween = {
{imgId = 102, delay = 0, duration = 0.2, posId = 2, alpha = 1, isDark = true}
, 
{imgId = 103, delay = 0, duration = 0.2, posId = 4, alpha = 1, isDark = false}
...
, 
[11] = {content = 110, contentType = 3, speakerHeroId = 1002, speakerHeroPosId = 1, 
imgTween = {
{imgId = 102, delay = 0, duration = 0.2, posId = 2, alpha = 1, isDark = false}
, 
{imgId = 103, delay = 0, duration = 0.2, posId = 4, alpha = 1, isDark = true}
...
{imgId = 103, delay = 0, duration = 0.2, posId = 4, alpha = 0, isDark = true}
, 
{imgId = 1, delay = 0, duration = 1.2, shake = true, shakeIntensity = 3}
}
, 
audio = {
bgm = {stop = true}
...
, 
images = {
{imgId = 101, imgType = 3, alpha = 0, imgPath = "persicaria_avg", comm = false, delete = true}
}
, 
audio = {
...
, 
{imgId = 2, delay = 0, duration = 1.2, shake = true, shakeIntensity = 4}
}
, 
audio = {
...
, 
{imgId = 2, delay = 0, duration = 1, alpha = 0.6, isDark = true}
}
, 
images = {
{imgId = 101, imgType = 3, alpha = 0, imgPath = "persicaria_avg", comm = false, delete = true}
...
, 
audio = {
sfx = {cue = "AVG_Seawave", sheet = "AVG", audioId = 2}
}
}
, 
[31] = {content = 310, contentType = 3, speakerHeroId = 1051, speakerHeroPosId = 1, contentShake = true, 
imgTween = {
{imgId = 4, delay = 0, duration = 0.6, alpha = 0}
, 
...
, 
{imgId = 47, delay = 1.2, duration = 0.6, posId = 3, alpha = 1, isDark = true}
}
}
, 
...
, 
images = {
{imgId = 101, imgType = 3, alpha = 0, imgPath = "persicaria_avg", delete = true, comm = false}
}
, 
audio = {
stopAudioId = {1}
...
, 
[43] = {content = 430, contentType = 3, speakerHeroId = 47, speakerHeroPosId = 2}
, 
[44] = {content = 440, contentType = 3, speakerHeroId = 1001, speakerHeroPosId = 2, contentShake = true, 
imgTween = {
...
, 
{imgId = 47, delay = 0.6, duration = 0.6, posId = 3, alpha = 0, isDark = true}
}
}
, 
...
, 
[53] = {content = 530, contentType = 3, speakerHeroId = 1003, speakerHeroPosId = 3, contentShake = true, 
imgTween = {
{imgId = 103, delay = 0, duration = 0.2, posId = 4, alpha = 1, isDark = false}
, 
{imgId = 102, delay = 0, duration = 0.2, posId = 2, alpha = 1, isDark = true}
...
, 
[55] = {content = 550, contentType = 3, speakerHeroId = 1003, speakerHeroPosId = 2, contentShake = true, 
imgTween = {
{imgId = 103, delay = 0, duration = 0, posId = 3, alpha = 0, isDark = false}
, 
{imgId = 103, delay = 0, duration = 0.2, posId = 3, alpha = 1, isDark = false}
...
imgTween = {
{imgId = 102, delay = 0, duration = 0.3, shake = true}
}
}
, 
[63] = {
...
, 
[64] = {content = 640, contentType = 3, speakerHeroId = 1002, speakerHeroPosId = 2, contentShake = true, 
imgTween = {
{imgId = 102, delay = 0, duration = 0.2, posId = 3, alpha = 1, isDark = false}
}
, nextId = 67}
...
, 
{imgId = 102, delay = 0.6, duration = 0.6, posId = 2, alpha = 0, isDark = false}
}
, 
heroFace = {
{imgId = 102, faceId = 5}
...
[74] = {
images = {
{imgId = 3, imgType = 2, alpha = 0, order = 4, imgPath = "summer/summer_e_bg006", fullScreen = true, delete = true}
, 
{imgId = 4, imgType = 2, alpha = 0, order = 5, imgPath = "summer/summer_e_cg002", fullScreen = true, delete = true}
, 
{imgId = 3, imgType = 2, alpha = 0, order = 4, imgPath = "summer/summer_e_bg001_3", fullScreen = true}
, 
{imgId = 4, imgType = 2, alpha = 0, order = 4, imgPath = "summer/summer_e_cg004", fullScreen = true}
}
, content = 740, contentType = 3, speakerHeroId = 1003, speakerHeroPosId = 2, 
imgTween = {
{imgId = 102, delay = 0, duration = 0.2, posId = 3, alpha = 0, isDark = false}
, 
{imgId = 103, delay = 0, duration = 0, posId = 3, alpha = 0, isDark = false}
...
, 
[75] = {bgColor = 3, autoContinue = true, 
imgTween = {
{imgId = 103, delay = 0, duration = 0.2, posId = 3, alpha = 0, isDark = false}
}
, 
...
, 
{imgId = 3, delay = 0.5, duration = 1, alpha = 1, isDark = false}
}
, 
audio = {
...
audio = {
sfx = {cue = "Skill_Love_01", sheet = "Mon_Love"}
}
}
, 
[80] = {content = 800, contentType = 2}
, 
[81] = {bgColor = 2, content = 810, contentType = 2, 
imgTween = {
...
, 
[83] = {content = 830, contentType = 3, speakerHeroId = 1003, speakerHeroPosId = 3, contentShake = true, 
imgTween = {
{imgId = 103, delay = 0, duration = 0, posId = 4, alpha = 0, isDark = false}
, 
{imgId = 103, delay = 0, duration = 0.2, posId = 4, alpha = 1, isDark = false}
...
, 
[85] = {content = 850, contentType = 3, speakerHeroId = 52, speakerHeroPosId = 2, 
imgTween = {
{imgId = 102, delay = 0, duration = 0.2, posId = 2, alpha = 0, isDark = false}
, 
{imgId = 103, delay = 0, duration = 0.2, posId = 4, alpha = 0, isDark = true}
...
, 
[94] = {content = 940, contentType = 3, speakerHeroId = 47, speakerHeroPosId = 2, 
imgTween = {
{imgId = 103, delay = 0, duration = 0.2, posId = 4, alpha = 0, isDark = true}
, 
{imgId = 102, delay = 0, duration = 0.2, posId = 2, alpha = 0, isDark = false}
...
, 
[96] = {content = 960, contentType = 3, speakerHeroId = 52, speakerHeroPosId = 2, 
imgTween = {
{imgId = 102, delay = 0, duration = 0.2, posId = 3, alpha = 0, isDark = false}
, 
{imgId = 52, delay = 0, duration = 0, posId = 3, alpha = 0, isDark = false}
...
, 
[101] = {content = 1010, contentType = 4, speakerName = 14, 
imgTween = {
{imgId = 4, delay = 0, duration = 1, alpha = 0}
}
, isEnd = true}
, 
[301] = {content = 331, contentType = 3, speakerHeroId = 1002, speakerHeroPosId = 3, 
imgTween = {
{imgId = 103, delay = 0, duration = 0.2, posId = 4, alpha = 0, isDark = true}
, 
{imgId = 151, delay = 0, duration = 0.2, posId = 2, alpha = 1, isDark = true}
...
, 
images = {
{imgId = 151, imgType = 3, alpha = 0, imgPath = "delacey_avg", comm = false, delete = true}
}
, 
audio = {
bgm = {stop = true}
