...
[1] = {SkipScenario = 13, bgColor = 2, content = 10, contentType = 1, storyAvgId = 4203, 
images = {
{imgId = 1, imgType = 2, alpha = 0, imgPath = "cpt04/cpt04_e_bg001_2", fullScreen = true}
, 
{imgId = 2, imgType = 2, alpha = 0, imgPath = "cpt04/cpt04_e_bg007_2", fullScreen = true}
, 
...
, 
{imgId = 3, imgType = 2, alpha = 0, imgPath = "cpt04/cpt04_e_bg007", fullScreen = true}
}
, 
audio = {
bgm = {stop = true}
...
, 
[23] = {content = 230, contentType = 4, speakerName = 241}
, 
...
, 
[28] = {content = 280, contentType = 3, speakerHeroId = 14, speakerHeroPosId = 2}
, 
...
, 
[30] = {content = 300, contentType = 3, speakerHeroId = 14, speakerHeroPosId = 2, 
imgTween = {
{imgId = 28, delay = 0, duration = 0.2, posId = 3, alpha = 0, isDark = false}
, 
{imgId = 27, delay = 0, duration = 0, posId = 3, alpha = 0, isDark = false}
...
, 
[31] = {content = 310, contentType = 3, speakerHeroId = 14, speakerHeroPosId = 2}
, 
...
, 
[38] = {content = 380, contentType = 3, speakerHeroId = 28, speakerHeroPosId = 2, contentShake = true, 
imgTween = {
{imgId = 28, delay = 0, duration = 0, posId = 3, alpha = 0, isDark = false}
, 
{imgId = 28, delay = 0, duration = 0.2, posId = 3, alpha = 1, isDark = false}
...
, 
[46] = {content = 460, contentType = 3, speakerHeroId = 28, speakerHeroPosId = 2, contentShake = true, 
imgTween = {
{imgId = 28, delay = 0, duration = 0.2, posId = 3, alpha = 1, shake = true, isDark = false, shakeIntensity = 2}
}
, 
audio = {
...
{imgId = 28, delay = 0, duration = 0.2, posId = 3, alpha = 0, isDark = false}
, 
{imgId = 2, delay = 0, duration = 0.6, shake = true, shakeIntensity = 2}
}
, 
audio = {
...
, 
[50] = {content = 500, contentType = 3, speakerHeroId = 28, speakerHeroPosId = 2, 
heroFace = {
{imgId = 28, faceId = 3}
}
}
...
, 
[53] = {content = 530, contentType = 4, speakerName = 11, scrambleTypeWriter = true, 
imgTween = {
{imgId = 28, delay = 0, duration = 0.2, posId = 3, alpha = 0, isDark = false}
}
}
...
, 
[56] = {content = 560, contentType = 3, speakerHeroId = 28, speakerHeroPosId = 2, 
heroFace = {
{imgId = 28, faceId = 3}
}
}
...
, 
[58] = {content = 580, contentType = 4, speakerName = 11, scrambleTypeWriter = true}
, 
